...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета)
	...
	РасшифровкаКодовОшибок.Вставить(78, НСтр("ru = 'Не заполнен идентификатор строки в движениях документа ""Таможенная декларация на импорт"" или ""Заявление о ввозе товаров из ЕАЭС"".';
											|en = 'The line ID is not filled in the ""Customs import declaration"" or ""Applications for goods import from EAEU"" document register records.'", ОбщегоНазначения.КодОсновногоЯзыка()));
