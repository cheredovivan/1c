				...
				Иначе
					...
					Если РаспознаваниеДокументовТипы.ЭтоПоступлениеТоваровУслуг(ЭтотТипДокумента) 
						...
						Если РаспознаваниеДокументовТипы.ЭтоЗаказКлиента(ТипДокументаОснования) Тогда
							...
							Если ПараметрыЗаполнения.Свойство("РеквизитыШапки") И ПараметрыЗаполнения.РеквизитыШапки.Свойство(
									"Подразделение") Тогда
								ПараметрыЗаполнения.РеквизитыШапки.Подразделение 
									= РаспознаваниеДокументовСлужебныйКлиентСервер.ЗначениеРеквизитаДокумента(РаспознанныйОбъект,
									"Подразделение");
							КонецЕсли;
						Иначе
