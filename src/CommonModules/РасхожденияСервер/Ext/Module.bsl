...
Процедура ПроверкаВозможностиВнесенияИзлишкаВНакладную(Акт, ИмяРегистра, ОписаниеМетаданных, Отказ) Экспорт
	...
	ДействияСИзлишком.Добавить(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходование);
...
Процедура ЗаполнитьПоОснованиям(Форма, ВызыватьУправлениеДоступностью = Истина) Экспорт
	...
	Иначе
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(Форма.Объект.ТипОснованияАктаОРасхождении) Тогда
			...
			|	ВЫБОР
			|		КОГДА ОтгрузкаТоваровКлиентуТовары.ЗаказКлиента В (ЗНАЧЕНИЕ(Документ.ЗаказКлиента.пустаяСсылка),
			|			ЗНАЧЕНИЕ(Документ.ЗаявкаНаВозвратТоваровОтКлиента.пустаяСсылка), НЕОПРЕДЕЛЕНО)
			|			ТОГДА ОтгрузкаТоваровКлиентуТовары.Ссылка
			|		ИНАЧЕ ОтгрузкаТоваровКлиентуТовары.ЗаказКлиента
...
Функция СтрокаАктаСодержитДействияТребующиеОбработки(ТекСтрока, ТипАкта, ТипОперации = "")
	...
	Если ТипАкта = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки") Тогда
		...
		Если ТекСтрока.Действие = ПредопределенноеЗначение("Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ПустаяСсылка")
				...
				Или ТекСтрока.Действие = ПредопределенноеЗначение("Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УвеличитьПереходПраваСобственности")
				Или ТекСтрока.Действие = ПредопределенноеЗначение("Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УменьшитьПереходПраваСобственности")
				Или ТекСтрока.Действие = ПредопределенноеЗначение("Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходование")
				Или ТекСтрока.Действие = ПредопределенноеЗначение("Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходованиеВозврат")
				Или ТекСтрока.Действие = ПредопределенноеЗначение("Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписание")
				Или ТекСтрока.Действие = ПредопределенноеЗначение("Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписаниеДопоставка") Тогда
...
Функция СтруктураДействийПоТЧОснованияАкта(Основание) Экспорт
	...
	ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.ОтгрузкаТоваровКлиенту") Тогда
		...
		ДополнитьСтруктуруДействийПоТЧТоварыОтгрузкиТоваровКлиенту(СтруктураДействий, Основание);
...
Функция ТекстЗапросаТабличныеЧастиАктаОРасхожденияхПослеОтгрузкиИРеализации(АктОРасхождениях, Основание, СтруктураВозврата)
	...
	|						ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УменьшитьПереходПраваСобственности),
	|						ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УвеличитьПереходПраваСобственности),
	...
	|						ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходование),
