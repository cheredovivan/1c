...
Функция ПрименяетсяФедеральныйИнвестиционныйНалоговыйВычет(Организация, Период) Экспорт
	...
	Возврат НастройкиНалоговУчетныхПолитикПовтИсп.ПрименяетсяФедеральныйИнвестиционныйНалоговыйВычет(Организация, НаДату);
...
Функция ПрименяетсяРегиональныйИнвестиционныйНалоговыйВычет(Организация, Подразделение, Период) Экспорт
	...
	Возврат НастройкиНалоговУчетныхПолитикПовтИсп.ПрименяетсяРегиональныйИнвестиционныйНалоговыйВычет(Организация, Подразделение, НаДату);
...
Функция ПараметрыПримененияРегиональныхИНВ(Организация, Подразделение, Период) Экспорт
	...
	Возврат НастройкиНалоговУчетныхПолитикПовтИсп.ПараметрыПримененияРегиональныхИНВ(Организация, Подразделение, НаДату);
