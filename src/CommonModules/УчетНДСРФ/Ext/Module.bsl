...
Функция КорректируютсяЗаписиВЖурналеСФ() Экспорт
	...
	МассивВозврата.Добавить(Тип("ДокументСсылка.Бронирование"));
...
Функция РассчитатьНДСЗаписиКнигиПокупокПоАвансуПолученному(ПараметрыРасчета)
	...
	|	ИЗ
	|		НДСАвансыПолученныеСторноЗачетов КАК НДСАвансыПолученныеСторно) КАК НДСАвансыПолученныеЗачеты
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
...
Функция РассчитатьНДСЗаписиКнигиПродажПоАвансуВыданному(ПараметрыРасчета)
	...
	|		ИСТИНА
	|	ИЗ
	|		НДСАвансыВыданныеСторноЗачетов КАК НДСАвансыВыданныеСторно) КАК НДСАвансыВыданныеЗачеты
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		СчетаФактурыПолученныеАванс КАК СчетаФактурыПолученныеАванс
	|	ПО
