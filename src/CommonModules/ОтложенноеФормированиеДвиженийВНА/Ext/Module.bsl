...
Процедура ДобавитьЭтап(ТаблицаЭтапов,ТекущийРодитель) Экспорт
	...
	НоваяСтрока = ЗакрытиеМесяцаСервер.ДобавитьЭтапВТаблицу(ТаблицаЭтапов, ТекущийРодитель,
		Справочники.ОперацииЗакрытияМесяца.ФормированиеДвиженийПоВнеоборотнымАктивам,,,,
...
Процедура ЗарегистрироватьОшибки(ПараметрыВыполнения)
	...
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУвеличенияСтоимостиПР) КАК ОтражениеУвеличенияСтоимостиПР,
	...
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУменьшенияСтоимостиПР) КАК ОтражениеУменьшенияСтоимостиПР,
	...
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУвеличенияАмортизацииПР) КАК ОтражениеУвеличенияАмортизацииПР,
	...
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУменьшенияАмортизацииПР) КАК ОтражениеУменьшенияАмортизацииПР,
	...
	|					И ТаблицаВНА.ОтражениеУвеличенияСтоимости
	...
	|			КОГДА ТаблицаВНА.КорректировкаСтоимости
	|					И ТаблицаВНА.ОтражениеУвеличенияСтоимости
	|					И втКорректировкаСтоимости.СтоимостьПР < 0
	|				ТОГДА ИСТИНА 
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ КАК ОтражениеУвеличенияСтоимостиПР,
	|	
	|		ВЫБОР
	|			КОГДА ТаблицаВНА.КорректировкаСтоимости
	|					И ТаблицаВНА.ОтражениеУвеличенияСтоимости
	...
	|		ВЫБОР
	|			КОГДА ТаблицаВНА.КорректировкаСтоимости
	|					И ТаблицаВНА.ОтражениеУменьшенияСтоимости
	|					И втКорректировкаСтоимости.Стоимость > 0
	|				ТОГДА ИСТИНА 
	|			ИНАЧЕ ЛОЖЬ
	...
	|				ТОГДА ИСТИНА 
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ КАК ОтражениеУменьшенияСтоимостиПР,
	|
	|		ВЫБОР
	|			КОГДА ТаблицаВНА.КорректировкаСтоимости
	|					И ТаблицаВНА.ОтражениеУменьшенияСтоимости
	...
	|		ЛОЖЬ КАК ОтражениеУвеличенияАмортизацииПР,
	...
	|		ЛОЖЬ КАК ОтражениеУменьшенияАмортизацииПР,
	...
	|		ЛОЖЬ КАК ОтражениеУвеличенияСтоимостиПР,
	...
	|		ЛОЖЬ КАК ОтражениеУменьшенияСтоимостиПР,
	|		ЛОЖЬ КАК ОтражениеУменьшенияСтоимостиЦФ,
	|
	|		ВЫБОР
	|			КОГДА ТаблицаВНА.КорректировкаАмортизации
	|					И ТаблицаВНА.ОтражениеУвеличенияАмортизации
	...
	|			КОГДА ТаблицаВНА.КорректировкаАмортизации
	|					И ТаблицаВНА.ОтражениеУвеличенияАмортизации
	|					И втКорректировкаАмортизации.АмортизацияПР < 0
	|				ТОГДА ИСТИНА 
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ КАК ОтражениеУвеличенияАмортизацииПР,
	|	
	|		ВЫБОР
	|			КОГДА ТаблицаВНА.КорректировкаАмортизации
	|					И ТаблицаВНА.ОтражениеУвеличенияАмортизации
	...
	|		ВЫБОР
	|			КОГДА ТаблицаВНА.КорректировкаАмортизации
	|					И ТаблицаВНА.ОтражениеУменьшенияАмортизации
	|					И втКорректировкаАмортизации.Амортизация > 0
	|				ТОГДА ИСТИНА 
	|			ИНАЧЕ ЛОЖЬ
	...
	|				ТОГДА ИСТИНА 
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ КАК ОтражениеУменьшенияАмортизацииПР,
	|	
	|		ВЫБОР
	|			КОГДА ТаблицаВНА.КорректировкаАмортизации
	|					И ТаблицаВНА.ОтражениеУменьшенияАмортизации
	...
	|		ИЛИ МАКСИМУМ(ТаблицаВНА.ОтражениеУвеличенияСтоимостиПР)
	...
	|		ИЛИ МАКСИМУМ(ТаблицаВНА.ОтражениеУменьшенияСтоимостиПР)
	...
	|		ИЛИ МАКСИМУМ(ТаблицаВНА.ОтражениеУвеличенияАмортизацииПР)
	...
	|		ИЛИ МАКСИМУМ(ТаблицаВНА.ОтражениеУменьшенияАмортизацииПР)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ОтражениеУвеличенияСтоимостиПР Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение только увеличения стоимости, но для нематериального актива ""%1"" стоимость (ПР), указанная в документе, меньше фактической.';
										|en = 'In the document parameters, only the increase in cost is selected to be reflected, but for intangible asset ""%1"", the cost (PD) indicated in the document is less than the actual cost.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение только увеличения стоимости, но для основного средства ""%1"" стоимость (ПР), указанная в документе, меньше фактической.';
										|en = 'In the document parameters, only the increase in cost is selected to be reflected, but for fixed asset ""%1"", the cost (PD) indicated in the document is less than the actual cost.'");
			КонецЕсли;
		...
		ИначеЕсли Выборка.ОтражениеУменьшенияСтоимостиПР Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение только уменьшения стоимости, но для нематериального актива ""%1"" стоимость (ПР), указанная в документе, больше фактической.';
										|en = 'In the document parameters, only the decrease in cost is selected to be reflected, but for intangible asset ""%1"", the cost (PD) indicated in the document is more than the actual cost.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение только уменьшения стоимости, но для основного средства ""%1"" стоимость (ПР), указанная в документе, больше фактической.';
										|en = 'In the document parameters, only the decrease in cost is selected to be reflected, but for fixed asset ""%1"", the cost (PD) indicated in the document is more than the actual cost.'");
			КонецЕсли;
		...
		Если Выборка.ОтражениеУвеличенияАмортизацииПР Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение только увеличения амортизации, но для нематериального актива ""%1"" амортизация (ПР), указанная в документе, меньше фактической.';
										|en = 'In the document parameters, only the increase in depreciation is selected to be reflected, but for intangible asset ""%1"", the depreciation (PD) indicated in the document is less than the actual depreciation.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение только увеличения амортизации, но для основного средства ""%1"" амортизация (ПР), указанная в документе, меньше фактической.';
										|en = 'In the document parameters, only the increase in depreciation is selected to be reflected, but for fixed asset ""%1"", the depreciation (PD) indicated in the document is less than the actual depreciation.'");
			КонецЕсли;
		...
		ИначеЕсли Выборка.ОтражениеУменьшенияАмортизацииПР Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано только отражение уменьшения амортизации, но для нематериального актива ""%1"" амортизация (ПР), указанная в документе, больше фактической.';
										|en = 'In the document parameters, only the decrease in depreciation is selected to be reflected, but for intangible asset ""%1"", the depreciation (PD) indicated in the document is more than the actual depreciation.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано только отражение уменьшения амортизации, но для основного средства ""%1"" амортизация (ПР), указанная в документе, больше фактической.';
										|en = 'In the document parameters, only the decrease in depreciation is selected to be reflected, but for fixed asset ""%1"", the depreciation (PD) indicated in the document is more than the actual depreciation.'");
			КонецЕсли;
...
Функция МаксимальноеКоличествоЗаданий()
	...
	ЗначенияПараметров = Константы.НастройкиЗакрытияМесяца.СоздатьМенеджерЗначения().УстановленныеЗначенияПараметровОперации(
  							Справочники.ОперацииЗакрытияМесяца.ФормированиеДвиженийПоВнеоборотнымАктивам); // Число
