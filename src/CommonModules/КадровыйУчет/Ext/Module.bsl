	...
	Иначе
		...
		Если КадровыеДанные <> Неопределено
			...
			И (Не ЗначениеЗаполнено(КадровыеДанные.ДатаУвольнения)
				Или КадровыеДанные.ДатаУвольнения > НачалоМесяца(Месяц)) Тогда
			
			ДатаОкончания = КонецМесяца(Месяц);
			Если ЗначениеЗаполнено(КадровыеДанные.ДатаУвольнения) Тогда
				ДатаОкончания = Мин(КадровыеДанные.ДатаУвольнения, ДатаОкончания);
			КонецЕсли;
