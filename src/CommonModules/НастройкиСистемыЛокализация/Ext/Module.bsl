...
#Область БЗКР
	//++ НЕ УТКА
	НастройкиСистемы.ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		Метаданные.Константы.ИспользоватьКадровыйУчет.Имя, Истина,
...
Процедура ПриСозданииНаСервере_Продажи(Форма) Экспорт
	...
	Элементы.ПояснениеИспользованиеЭтаповОплатыВПродажах.Заголовок = НСтр(
		...
		|en = 'The setting determines possible payment planning options in sales orders, requests for goods return from customer, and material provider orders.'");
	//-- НЕ УТ
