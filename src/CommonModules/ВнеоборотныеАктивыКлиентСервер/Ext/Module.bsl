...
Функция ЗначенияСвойствЗависимыхРеквизитов_КорректировкаСтоимостиИАмортизацииОС(Объект, ВспомогательныеРеквизиты, ИзмененныеРеквизиты = "") Экспорт
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ОтражатьВУпрУчете")
		...
		ОбщегоНазначенияУТКлиентСервер.ДобавитьПараметрыРеквизитаОбъекта(
			...
			"Видимость", 
			КорректировкаПараметровРасчетаАмортизацииБУ И НЕ ВспомогательныеРеквизиты.ПрименяетсяФСБУ6 И НЕ ПоказатьПолеОтдельно, 
			ПараметрыРеквизитовОбъекта);
		...
		ОбщегоНазначенияУТКлиентСервер.ДобавитьПараметрыРеквизитаОбъекта(
			...
			"Видимость", 
			КорректировкаПараметровРасчетаАмортизацииБУ И НЕ ВспомогательныеРеквизиты.ПрименяетсяФСБУ6 И ПоказатьПолеОтдельно, 
			ПараметрыРеквизитовОбъекта);
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("КорректировкаСтоимости")
		...
		ЗначениеСвойства =
			(КорректировкаСтоимостиБУ ИЛИ КорректировкаСтоимостиУУ)
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("КорректировкаАмортизации")
		...
		ЗначениеСвойства =
			(КорректировкаАмортизацииБУ ИЛИ КорректировкаАмортизацииУУ)
