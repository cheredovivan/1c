...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Обработчик.Версия = "2.5.25.61";
		Обработчик.РежимВыполнения = "Оперативно";
		Обработчик.ОбщиеДанные = Истина;
		Обработчик.Процедура = "ИнтеграцияБЗК.ЗаполнитьКлассификаторЯзыковНародовМира";
		Обработчик.Идентификатор = Новый УникальныйИдентификатор("da23dc8d-1a58-432b-8046-33eac06f88bc");
		Обработчик.Комментарий = НСтр("ru = 'Заполнение классификатора ""Языки народов мира"".';
										|en = 'Fill in the classifier ""Languages of the world"" classifier.'");
	КонецЕсли;
	
КонецПроцедуры

Процедура ЗаполнитьКлассификаторЯзыковНародовМира() Экспорт
	Справочники.ЯзыкиНародовМира.ЗаполнитьСправочникПоКлассификатору(ОбщегоНазначения.РазделениеВключено());
КонецПроцедуры
