...
Процедура ДобавитьЭтап_ПереходНаНовыеРежимыРаботы(ТаблицаЭтапов, ТекущийРодитель) Экспорт
	...
	НоваяСтрока.МультиязычноеНаименование = "ru = 'Рекомендуется осуществить переход на новые режимы учета';
											|en = 'It is recommended to migrate to new accounting modes.'"; // @НСтр-1
