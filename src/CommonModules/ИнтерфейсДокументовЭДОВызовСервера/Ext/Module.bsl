...
Функция ЗагрузитьФормализованныйДокументПоДаннымФайлаXML(ПомещенныйФайл, ЭлектронныйДокумент, 
	...
	РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ЭлектронныйДокумент,
		"Организация, ИдентификаторОрганизации, ИдентификаторКонтрагента");
	ДанныеДокумента = Новый Структура("Ссылка, Организация", ЭлектронныйДокумент, РеквизитыДокумента.Организация);
	...
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения,
		"ИнтерфейсДокументовЭДО.ЗагрузитьФормализованныйДокументПоФайлуXMLВФоне", ДанныеДокумента, ОписаниеФайла,
