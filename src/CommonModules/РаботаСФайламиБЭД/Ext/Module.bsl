...
Функция БуферИмениИзСоответствия(БуферИмени, СоответствиеИменФайлов)
	...
	Для Каждого Кодировка Из ВозможныеКодировки Цикл
		...
		Если СтрНайти(ИмяФайлаВКодировке, "/") Тогда
			МассивПути = СтрРазделить(ИмяФайлаВКодировке, "/");
		ИначеЕсли СтрНайти(ИмяФайлаВКодировке, "\") Тогда
			МассивПути = СтрРазделить(ИмяФайлаВКодировке, "\");
		КонецЕсли;		
		Если ЗначениеЗаполнено(МассивПути) Тогда
			ИменаВКодировках.Добавить(МассивПути.Получить(МассивПути.Количество()-1));
		КонецЕсли;
	КонецЦикла;
