...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	//++ НЕ УТ
	|			КОГДА ТИПЗНАЧЕНИЯ(Таблица.ДокументПоступления) = ТИП(Документ.ЗаключениеДоговораАренды) 
	...
	//++ НЕ УТ
	|		ИЛИ СУММА(ТаблицаИзменений.СуммаИзменение) > 0 И ТИПЗНАЧЕНИЯ(ТаблицаИзменений.ДокументПоступления) = ТИП(Документ.ЗаключениеДоговораАренды)
	//-- НЕ УТ
	|	)
	|;
