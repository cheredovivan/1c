...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий =
		НСтр("ru = 'Заполнение реквизита ""Подразделение"" в регистре накопления ""Денежные средства (безналичные)"".';
			|en = 'Fill the ""Business unit"" attribute in the ""Bank account"" accumulation register.'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось заполнить реквизит ""Подразделение"" в регистре накопления ""Денежные средства (безналичные)"".';
								|en = 'Cannot fill the ""Business unit"" attribute in the ""Bank account"" accumulation register.'"));
