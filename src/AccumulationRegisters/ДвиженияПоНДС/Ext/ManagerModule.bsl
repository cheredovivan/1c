...
Функция ПараметрыОтраженияДвиженийВФинансовомУчете(МетаданныеРегистра = Неопределено, РегистрацияКОтражению = Ложь) Экспорт
	...
	ПараметрыОтражения.ПутьКДаннымДопНастройкаХозОперации = СтрЗаменить(
		...
		|					ИЛИ ПсевдонимИсточникаДанных.Регистратор ССЫЛКА Документ.Сторно
		|					И ВЫРАЗИТЬ(ПсевдонимИсточникаДанных.Регистратор КАК Документ.Сторно).СторнируемыйДокумент ССЫЛКА Документ.РеализацияУслугПрочихАктивов
		...
		|					ТОГДА ВЫБОР
		|						КОГДА ВЫРАЗИТЬ(ПсевдонимИсточникаДанных.Регистратор КАК Документ.КорректировкаРеализации).ДокументОснование ССЫЛКА Документ.РеализацияУслугПрочихАктивов
