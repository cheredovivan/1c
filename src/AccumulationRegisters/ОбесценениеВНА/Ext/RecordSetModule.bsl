...
Процедура ПодготовитьДанныеДляРегистрацииЗаданийНеоперативнойОчереди()
	...
	Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") 
		...
		|	НачальныеЗаписи.ВнеоборотныйАктив КАК ВнеоборотныйАктив,
		|	НачальныеЗаписи.ОбесценениеУпр КАК ОбесценениеУпр
		|ПОМЕСТИТЬ ВТ_ОчередьЗаданийНачальныеЗаписи
		|ИЗ
		|	РегистрНакопления.ОбесценениеВНА КАК НачальныеЗаписи
		|ГДЕ
...
Процедура СоздатьЗаданияНеоперативнойОчередиПриЗаписи()
	...
	Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") 
		...
		|		Записи.ВнеоборотныйАктив КАК ВнеоборотныйАктив,
		|		-Записи.ОбесценениеУпр КАК ОбесценениеУпр
		|	ИЗ
		|		РегистрНакопления.ОбесценениеВНА КАК Записи
		|	ГДЕ
		...
		|	Таблица.ВнеоборотныйАктив
		|ИМЕЮЩИЕ
		|	СУММА(Таблица.ОбесценениеУпр) <> 0
		|;
