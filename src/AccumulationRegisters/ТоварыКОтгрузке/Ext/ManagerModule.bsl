...
Процедура ПриОпределенииДоступныхВидовОповещенийПользователей(ОписаниеВидовОповещений) Экспорт
	...
	НовыйВидОповещений.Наименование = НСтр("ru = 'Оформление отгрузки со склада';
											|en = 'Creation of shipment from the warehouse'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	НовыйВидОповещений.ШаблонТекстаОповещения = "ru = 'Оформлена отгрузка со склада [Склад] [ДатаОтгрузки]. [ИсточникОповещения]';
												|en = 'Shipment from the [Склад] warehouse dated [ДатаОтгрузки] is created. [ИсточникОповещения]'"; // @NStr-1
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет движения по регистру накопления ""Товары к отгрузке"" для документов ""Акт о расхождениях после приемки"".';
									|en = 'Updates register records in the ""Goods to ship"" accumulation register for the ""Receipt discrepancy reports"" documents.'");
