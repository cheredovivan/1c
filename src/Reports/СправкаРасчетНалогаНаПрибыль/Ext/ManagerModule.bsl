...
Функция ПолучитьВнешниеНаборыДанных(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
				   ...
				   |	NULL КАК ВариантНалогообложения,
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Группировка = НайтиПоИмени(КомпоновщикНастроек.Настройки.Структура, "Заголовки.РасчетНалогаНаПрибыль");
	Таблица = НайтиПоИмени(Группировка.Структура, "ТаблицаРасчетНалогаНаПрибыль");
	ГруппировкаСтрок = НайтиПоИмени(Таблица.Строки,"РасчетНалогаНаПрибыль");
	ГруппировкаСтрок.Использование = НЕ ИспользуетсяРаздельныйУчет;
	
	ГруппировкаСтрокРаздельныйУчет = НайтиПоИмени(Таблица.Строки,"РасчетНалогаНаПрибыльРаздельныйУчет");   
	ГруппировкаСтрокРаздельныйУчет.Использование = ИспользуетсяРаздельныйУчет;
...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	ИмяЗаголокаГруппировки = "РасчетНалогаНаПрибыль";
	
	ИспользуетсяРаздельныйУчет = РаздельныйУчетПоНалогуНаПрибыль.ИспользуетсяРаздельныйУчет(ПараметрыОтчета.Организация, ПараметрыОтчета.НачалоПериода);
	
	Если ИспользуетсяРаздельныйУчет Тогда
		ИмяЗаголокаГруппировки = "РасчетНалогаНаПрибыльРаздельныйУчет";
	КонецЕсли; 
	
	ЭлементТела = БухгалтерскиеОтчеты.ПодобратьЭлементыИзТелаМакета(
					МакетКомпоновки, ИмяЗаголокаГруппировки, ПараметрыПоиска);
