...
Процедура Проверить(Команда)
	...
	|от 26.09.2023 № ЕД-7-3/675@ (в редакции приказа
	|ФНС России от 12.09.2025 № ЕД-7-3/781@)	
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Раздел1" ИЛИ Ячейка.Раздел = "Раздел2" ИЛИ Ячейка.Раздел = "Раздел31" ИЛИ Ячейка.Раздел = "Раздел5" Тогда
	...
	ИначеЕсли Ячейка.Раздел = "Раздел32" ИЛИ Ячейка.Раздел = "Раздел33" ИЛИ Ячейка.Раздел = "Раздел34"
		ИЛИ Ячейка.Раздел = "Раздел41" ИЛИ Ячейка.Раздел = "Раздел42" Тогда
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Завершение отправки" 
		...
		Или ИмяСобытия = "Успешная отправка" Тогда
