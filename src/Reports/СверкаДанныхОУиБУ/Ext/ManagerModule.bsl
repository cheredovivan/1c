...
Функция ТекстЗапросаРасчетыСКонтрагентами()
	...
	|					ИЛИ Расчеты.ДокументРегистратор ССЫЛКА Документ.ВзаимозачетЗадолженности ИЛИ НЕ СторноВзаимозачета.Ссылка ЕСТЬ NULL
	...
	|			И УчетнаяПолитикаОрганизаций.ДолгосрочныеАктивыОбязательства
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.Сторно КАК СторноВзаимозачета
	|			ПО СторноВзаимозачета.Ссылка = Расчеты.ДокументРегистратор
	|				И СторноВзаимозачета.СторнируемыйДокумент ССЫЛКА Документ.ВзаимозачетЗадолженности
	|	ГДЕ
