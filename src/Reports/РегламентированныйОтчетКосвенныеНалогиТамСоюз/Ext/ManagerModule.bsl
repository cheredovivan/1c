...
Функция ДанныеРеглОтчета(ЭкземплярРеглОтчета) Экспорт
	...
	Если ЭкземплярРеглОтчета.ВыбраннаяФорма = "ФормаОтчета2023Кв3"
		...
		Если ДанныеРеглОтчета.Свойство("ДанныеМногоуровневыхРазделов") Тогда
			...
			Раздел2 = ДанныеРеглОтчета.ДанныеМногоуровневыхРазделов["Раздел2"].Строки[0];
			Для Каждого СтрокаРаздела2 Из Раздел2.ДанныеМногострочныхЧастей["П00002М1"].Строки Цикл
				
				Сумма = ТаблицаДанныхРеглОтчета.Добавить();
				Сумма.Период = ЭкземплярРеглОтчета.ДатаОкончания;
				Сумма.ОКАТО  = Раздел2.Данные["П000020001003"];
				Сумма.КБК    = СтрокаРаздела2.Данные["П00002М102000"];
				Сумма.Сумма  = СтрокаРаздела2.Данные["П00002М103000"];
