...
Функция СформироватьНовоеУведомление(РедакцияФормы, Данные) Экспорт
	...
	ИначеЕсли РедакцияФормы = "Форма2026_1" Тогда
...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "В соответствии с приказом ФНС России от 30.11.2022 № ЕД-7-8/1133@ в формате 5.04";
			...
			Для Каждого Стр Из Данные.ДанныеДопСтрокБД.МнгСтр1 Цикл 
				...
				Если ЗначениеЗаполнено(Стр.ИННФЛ) Тогда
					...
					Если ЗначениеЗаполнено(Стр.ИННЮЛ) Тогда 
						ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам(
							"ИНН организации не заполняется, если заполнене ИНН физлица", "ЗачетСумЕНС", "ИННЮЛ___" + Инд));
					КонецЕсли;
					Если ЗначениеЗаполнено(Стр.КППЮЛ) Тогда 
						ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам(
							"КПП организации не заполняется, если заполнене ИНН физлица", "ЗачетСумЕНС", "КППЮЛ___" + Инд));
					КонецЕсли;
