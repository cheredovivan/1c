...
Процедура ПриОткрытии(Отказ)
	...
	УстановитьПометкиКнопокДетализации();
...
Процедура ПоказатьЭтапы(Команда)
	...
	ДействияПриИзмененииПометкиДетализации();
	
КонецПроцедуры

&НаКлиенте
Процедура ПоказатьМатериалы(Команда)
	
	ПоказыватьМатериалы = Не ПоказыватьМатериалы;
...
&НаКлиенте
Процедура ПоказатьПеремещения(Команда)
	
	ПоказыватьПеремещения = Не ПоказыватьПеремещения;
...
&НаКлиенте
Процедура ДействияПриИзмененииПометкиДетализации()
...
&НаКлиенте
Процедура УстановитьПометкиКнопокДетализации()
	ЭтаФорма.Элементы.ПоказатьЭтапыДетализация		  .Пометка = ПоказыватьЭтапы;
	ЭтаФорма.Элементы.ПоказыватьМатериалыДетализация  .Пометка = ПоказыватьМатериалы;
	ЭтаФОрма.Элементы.ПоказыватьПеремещенияДетализация.Пометка = ПоказыватьПеремещения;
КонецПроцедуры
