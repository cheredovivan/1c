...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПоляТехпроцесс = РедакторПроизводственногоПроцесса.ПоляЗапросаПараметрыТехпроцессаЭтапа(
		"СостоянияЭтаповПроизводства.Этап");
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ТипТехнологическогоПроцесса", ПоляТехпроцесс["ТипТехнологическогоПроцесса"]);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ТехнологическийПроцесс", ПоляТехпроцесс["ТехнологическийПроцесс"]);
