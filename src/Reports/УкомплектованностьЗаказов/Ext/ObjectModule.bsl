...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Для каждого Элемент Из КомпоновщикНастроек.Настройки.Отбор.Элементы Цикл
		Если Элемент.Использование Тогда
			Если Элемент.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Этап")
				...
				Прервать;
			ИначеЕсли Элемент.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("КлючПартия") Тогда
				Элемент.Представление = НСтр("ru = 'Установлен отбор по партии';
											|en = 'Filter by lot is set'");
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
