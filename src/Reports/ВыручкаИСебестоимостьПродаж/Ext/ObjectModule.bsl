...
Функция ТекстЗапроса(ПоказыватьПродажи)
	...
	|	ВЫБОР
	|		КОГДА &ДанныеОтчета = 4
	|			ТОГДА СУММА(Таблица.СуммаАкцизаРегл)
	|		ИНАЧЕ
	|			СУММА(Таблица.СуммаАкцизаУпр)
	...
	//++ НЕ УТ
	|		// Акциз
	|		Продажи.СуммаАкцизаУпр КАК СуммаАкцизаУпр,
	|		Продажи.СуммаАкцизаРегл КАК СуммаАкцизаРегл,
	//-- НЕ УТ
	|		
	|		(ВЫБОР
	|			КОГДА Продажи.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.КомиссионныйТовар)
	...
	//++ НЕ УТ
	|	Продажи.СуммаАкциза КАК СуммаАкциза,
	//-- НЕ УТ
