...
Процедура Расчет(Форма)
	...
	Для НомСтр = 1 По 2 Цикл
		...
		КонецЦикла;
		Области["П001001000" + НомСтр + "09"].Значение
			= Области["П001001000" + НомСтр + "10"].Значение
			+ Области["П001001000" + НомСтр + "11"].Значение
			+ Области["П001001000" + НомСтр + "12"].Значение
			+ Области["П001001000" + НомСтр + "13"].Значение;
...
Процедура УстановитьЗащитуИЦветФонаОбластейАвторассчитываемыхПоказателей()
	...
	Для НомСтр = 1 По 2 Цикл
		...
		СтрокаИмя	 = "П001001000" + НомСтр + "09";
		Обл = мФормаОтчета.Области.Найти(СтрокаИмя);
