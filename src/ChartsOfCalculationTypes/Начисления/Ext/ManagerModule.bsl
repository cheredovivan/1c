...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий     = НСтр("ru = 'Изменение вида начисления для НУ начислений с категорией ""Компенсация неиспользованных дней часов отдыха""';
										|en = 'Changing the accrual item for TA accruals with the ""Compensation of unused leave days hours"" category'");
	...
	Обработчик.Комментарий     = НСтр("ru = 'Изменение признака учета в среднем заработке начислений с категорией ""Компенсация неиспользованных дней часов отдыха""';
										|en = 'Changing the accounting flag in average earnings of accruals with the ""Compensation of unused leave days hours"" category'");
