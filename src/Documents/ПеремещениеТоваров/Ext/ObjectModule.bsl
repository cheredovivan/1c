...
Процедура ЗаполнитьВидЗапасовПолучателя() Экспорт
	...
	|	ЗНАЧЕНИЕ(Справочник.СтруктураПредприятия.ПустаяСсылка) КАК ПодразделениеПроизводства,
	//-- НЕ УТ
...
Процедура КонтрольЗаполненияПодакцизныхВидовЗапасов(Отказ)
	...
	ТипСклада = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СкладПолучатель, "ТипСклада");
