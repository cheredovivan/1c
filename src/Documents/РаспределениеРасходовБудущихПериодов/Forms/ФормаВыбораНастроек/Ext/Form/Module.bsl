...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
	ПравилоНУ = Параметры.ПравилоРаспределенияРасходовНУ;
	ДокументНУ = Параметры.ДокументНУ;
	Элементы.ЛокализацияГруппаНалоговыйУчет.Видимость = 
		УчетРегл И Параметры.Свойство("НалоговыйУчет") И Параметры.НалоговыйУчет;
	Элементы.ГруппаСоздатьНалоговыйУчет.Видимость = НЕ ЗначениеЗаполнено(ДокументНУ);
	Элементы.ДокументНУ.Видимость = ЗначениеЗаполнено(ДокументНУ);
	//-- НЕ УТ
...
Процедура Создать(Команда)
	...
	//++ НЕ УТ
	Результат.Вставить("НалоговыйУчет", НалоговыйУчет);
	//-- НЕ УТ
	Закрыть(Результат);
КонецПроцедуры
...
Процедура УправлениеЭлементамиФормы()
	...
	//++ НЕ УТ
	Элементы.НалоговыйУчет.Доступность = НЕ ЗначениеЗаполнено(ПравилоРБП) ИЛИ ПравилоНУ = ПравилоРБП;
	Элементы.ПравилоНУ.Доступность = НЕ НалоговыйУчет;
	//-- НЕ УТ
