...
Процедура НастроитьФорму()
	...
	Иначе
		...
		Элементы.ТоварыПодобратьТоварыКСписаниюСХранения.Заголовок = НСтр("ru = 'Подобрать товары к списанию, принятые на ответственное хранение';
																			|en = 'Select available VMI to adjust'");
