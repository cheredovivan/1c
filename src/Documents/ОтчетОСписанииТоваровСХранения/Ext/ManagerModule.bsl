...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	//++ НЕ УТКА
	Документы.СписаниеОтгруженныхТоваров.ДобавитьКомандуСоздатьНаОснованииОтчетаОСписанииТоваровДавальца(КомандыСозданияНаОсновании);
	//-- НЕ УТКА
...
Функция ТекстЗапросаЗаполненияСтатусовУказанияСерий(ПараметрыУказанияСерий) Экспорт
	...
	//++ НЕ УТКА
	|									И ЕСТЬNULL(СпрДоговоры.ХозяйственнаяОперация, ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПустаяСсылка)) В(
	...
	|										ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПроизводствоУПереработчикаВСтранахЕАЭС2_5))
	//-- НЕ УТКА
	|								ТОГДА ВЫБОР
	|										КОГДА Товары.Серия <> ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|											ТОГДА 18
