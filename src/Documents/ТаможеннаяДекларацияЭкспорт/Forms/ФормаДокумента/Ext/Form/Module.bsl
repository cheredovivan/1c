...
Процедура КодОперацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыФормы.Вставить("СтруктураДляПоиска", Новый Структура("Код", Объект.УдалитьКодОперации));
...
Процедура ВыборКодаОперацииЗавершение(РезультатВыбора, ДопПараметры) Экспорт
	...
	Объект.УдалитьКодОперации = РезультатВыбора.Код;
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Элементы.КодОперации.Видимость = ЗначениеЗаполнено(Объект.УдалитьКодОперации);
	Элементы.КодОперации.Доступность = Ложь;
