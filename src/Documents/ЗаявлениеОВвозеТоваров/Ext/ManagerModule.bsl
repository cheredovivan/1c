...
Функция ОписаниеОперацийУчетаСебестоимости(Документ) Экспорт
	...
	|	0 										КАК СтоимостьЗабалансовая,
	|	0 										КАК СтоимостьЗабалансоваяРегл,
	|	ВЫРАЗИТЬ(&КоэффициентПересчетаВВалютуУпр * ТаблицаВидыЗапасов.СуммаАкциза КАК ЧИСЛО(31, 2)) КАК ДопРасходы,
	|	&КоэффициентПересчетаВВалютуУпр * ТаблицаВидыЗапасов.СуммаАкциза							КАК ДопРасходыБезНДС,
	|	ТаблицаВидыЗапасов.СуммаАкциза																КАК ДопРасходыРегл,
	|	ВЫРАЗИТЬ(&КоэффициентПересчетаВВалютуУпр * ТаблицаВидыЗапасов.СуммаАкциза КАК ЧИСЛО(31, 2)) КАК ДопРасходыУпр,
	|	0 										КАК ПостояннаяРазница,
	|	0 										КАК ВременнаяРазница,
	|	0										КАК КорСтоимость,
	|
