...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ИспользоватьАкцизы И Не ИспользоватьПодакцизныеТовары Тогда
		...
		ПараметрыКонтроля.ШаблонТекстаОшибки = НСтр("ru = 'Для организации ""%Организация%"" запрещен ввоз подакцизного товара ""%Номенклатура%"", указанного в строке %НомерСтроки% списка ""%ПредставлениеТабличнойЧасти%""';
													|en = 'For the ""%Организация%""company, import of the ""%Номенклатура%"" excisable goods specified in the %НомерСтроки% line of the ""%ПредставлениеТабличнойЧасти%"" list is prohibited'");
