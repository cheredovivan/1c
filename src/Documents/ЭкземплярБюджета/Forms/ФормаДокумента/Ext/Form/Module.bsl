...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.ВидБюджета) И Элементы.СтраницаБюджет.Видимость Тогда
		РежимРедактирования = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("ВидБюджета_" + XMLСтрока(Объект.ВидБюджета), "РежимРедактирования");
		Если ЗначениеЗаполнено(РежимРедактирования) Тогда
			Элементы.ПанельБюджет.ТекущаяСтраница = Элементы[РежимРедактирования];
		КонецЕсли;
	КонецЕсли;
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Элементы.СтраницаБюджет.Видимость Тогда
		РежимРедактирования = Элементы.ПанельБюджет.ТекущаяСтраница.Имя;
		ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ВидБюджета_" + XMLСтрока(Объект.ВидБюджета), "РежимРедактирования", РежимРедактирования);
	КонецЕсли;
...
Процедура ПриИзмененииСпособаРедактированияБюджета(ЗаполнитьБюджет = Истина)
	...
	Если ЗначениеЗаполнено(Объект.ВидБюджета)
		И (ОсновнойСпособВвода = Перечисления.СпособыРедактированияБюджета.ВСписке
		Или РежимРедактирования = "Список") И ДоступностьЭлементов Тогда
		Элементы.ПанельБюджет.ТекущаяСтраница = Элементы.Список;
	Иначе
		Элементы.ПанельБюджет.ТекущаяСтраница = Элементы.Таблица;
	КонецЕсли;
