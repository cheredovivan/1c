...
//    ДанныеЗаполнения - ДокументСсылка - документ-основание "Поступление денежных документов".
//
Процедура ЗаполнитьПоОснованию(Объект, ДанныеЗаполнения) Экспорт
	
	ТипОбъекта = ТипЗнч(Объект);
	Ссылка = ДанныеЗаполнения;
	...
	Для Каждого Колонка Из РезультатЗапроса.Колонки Цикл
		...
		Если Не ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ДанныеЗаполнения, Колонка.Имя) Тогда
