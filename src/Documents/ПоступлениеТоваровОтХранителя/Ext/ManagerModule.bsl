...
Функция ТекстЗапросаТаблицаДатыПоступленияТоваровОрганизаций(Запрос, ТекстыЗапроса, Регистры)
	...
	|	И ПоступленияТоваров.Номенклатура = ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры.Номенклатура
	|	И ПоступленияТоваров.Характеристика = ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры.Характеристика
	|	И ПоступленияТоваров.Серия = ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры.Серия
	|	И ПоступленияТоваров.Назначение = ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры.Назначение
