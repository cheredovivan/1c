	...
	Если Объект.НачислениеНДСПриОтгрузке Тогда
		...
		Если Модифицированность
			...
			ТекстВопроса = НСтр("ru = 'Данные модифицированы.
				...
				|Prepayment offset is available only after saving the data.
...
//++ НЕ УТ
	...
	Если Не ТекущаяСтрока.ОблагаетсяАкцизом Тогда
		ТекущаяСтрока.СуммаАкциза = 0;
		ТекущаяСтрока.СуммаАкцизаУвеличение = 0;
		ТекущаяСтрока.СуммаАкцизаУменьшение = 0;
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	//++ НЕ УТ
	ДобавляемыеЭлементы.Добавить(Элементы.ТоварыСуммаАкцизаУвеличение);
	ДобавляемыеЭлементы.Добавить(Элементы.ТоварыСуммаАкцизаУменьшение);
	//-- НЕ УТ
	...
	// Облагаться акцизом могут только подакцизные товары
	
	Элемент = УсловноеОформление.Элементы.Добавить();
	
	ДобавляемыеЭлементы = Новый Массив;
	ДобавляемыеЭлементы.Добавить(Элементы.ТоварыОблагаетсяАкцизом);
	...
	// Сумма акциза доступна только для облагаемых акцизом товаров
	
	Элемент = УсловноеОформление.Элементы.Добавить();
	
	ДобавляемыеЭлементы = Новый Массив;
	ДобавляемыеЭлементы.Добавить(Элементы.ТоварыСуммаАкциза);
	ДобавляемыеЭлементы.Добавить(Элементы.ТоварыСуммаАкцизаУвеличение);
	ДобавляемыеЭлементы.Добавить(Элементы.ТоварыСуммаАкцизаУменьшение);
	...
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.Товары.ОблагаетсяАкцизом");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Ложь;
