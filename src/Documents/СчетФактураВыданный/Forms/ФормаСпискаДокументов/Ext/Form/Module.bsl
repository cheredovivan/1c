...
Процедура ОформитьСчетФактуру(Команда)
	...
	Если ЕстьНачислениеНДСПриОтгрузке
		...
		ТекстСообщения = НСтр("ru = 'Документы, на основании которых регистрируется счет-фактура, предполагают начисление НДС в момент отгрузки товаров.
							...
							|en = 'The documents based on which the tax invoice is registered assume that VAT will be charged when shipping goods.
							|Register separate tax invoices for these documents.'");
