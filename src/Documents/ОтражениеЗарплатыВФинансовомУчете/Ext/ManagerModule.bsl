...
Функция ВидыОперацийНачисленияСФиксированнымОтражением() Экспорт
...
Функция ВидыОперацийУдержанияСОбязательнымФизлицом() Экспорт
	...
	Для Каждого Строка Из НачисленнаяЗарплатаИВзносы Цикл
		...
		Для Каждого Колонка Из МассивКолонок Цикл
			...
			Если Строка[Колонка] = 0 Тогда
				...
				КонецЦикла;
			Иначе
				РезультатРаспределения = ОбщегоНазначенияУТ.РаспределитьСуммуПропорциональноКоэффициентамРазныхЗнаков(Строка[Колонка], МассивКоэффициентов);
			КонецЕсли;
