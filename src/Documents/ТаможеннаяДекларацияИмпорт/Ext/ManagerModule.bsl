...
Функция ТекстЗапросаВтТоварыДляСоединенияАналитик(Запрос, ТекстыЗапроса)
	...
	//++ НЕ УТ
	|	ТЧТовары.ВидЗапасов.ОблагаетсяАкцизом КАК ВидЗапасовОблагаетсяАкцизом,
	//-- НЕ УТ
...
Функция ТекстЗапросаТаблицаТоварыОрганизаций(Запрос, ТекстыЗапроса, Регистры)
	...
	//++ НЕ УТ
	|		И ВидыЗапасовСкладские.ОблагаетсяАкцизом = ТоварыДокумента.ВидЗапасовОблагаетсяАкцизом
	//-- НЕ УТ
