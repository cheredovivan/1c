	...
	Если Не ИспользоватьПодакцизныеТовары Тогда
		...
		ПараметрыКонтроля.ШаблонТекстаОшибки =
			НСтр("ru = 'Для организации ""%Организация%"" запрещен импорт подакцизного товара ""%Номенклатура%"", указанного в строке %НомерСтроки% списка ""%ПредставлениеТабличнойЧасти%""';
				|en = 'For the ""%Организация%"" company, importing the ""%Номенклатура%"" excisable goods specified in line %НомерСтроки% of the ""%ПредставлениеТабличнойЧасти%"" list is prohibited'");
