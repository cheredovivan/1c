...
Функция ПредставлениеСпособаДоставки(СпособДоставки, Документ)
	...
	ИначеЕсли СпособДоставки = Перечисления.СпособыДоставки.ДоКлиента Тогда
		...
		Если ТипДокумента = Тип("ДокументСсылка.ПеремещениеТоваров")
			...
			Представление = НСтр("ru = 'Наша транспортная служба до получателя';
								|en = 'In-house carrier (delivery to recipient)'");
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ОтгрузкаТоваровСХранения") Тогда
			Представление = НСтр("ru = 'Наша транспортная служба до владельца';
								|en = 'In-house carrier (delivery to owner)'");
		//++ НЕ УТ
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ЗаказПереработчику2_5") Тогда
			Представление = НСтр("ru = 'Наша транспортная служба до переработчика';
								|en = 'In-house carrier (delivery to subcontractor)'");
		//++ Устарело_Переработка24
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ПередачаСырьяПереработчику")
			Или ТипДокумента = Тип("ДокументСсылка.ЗаказПереработчику") Тогда
			Представление = НСтр("ru = 'Наша транспортная служба до переработчика';
								|en = 'In-house carrier (delivery to subcontractor)'");
		//-- Устарело_Переработка24
		...
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ЗаказДавальца2_5") Тогда
			Представление = НСтр("ru = 'Наша транспортная служба до давальца';
								|en = 'In-house carrier (delivery to material provider)'");
		//++ Устарело_Переработка24
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ПередачаДавальцу")
			Или ТипДокумента = Тип("ДокументСсылка.ЗаказДавальца") Тогда
			Представление = НСтр("ru = 'Наша транспортная служба до давальца';
								|en = 'In-house carrier (delivery to material provider)'");
		//-- Устарело_Переработка24
	...
	ИначеЕсли СпособДоставки = Перечисления.СпособыДоставки.СиламиПеревозчикаДоПунктаПередачи Тогда
		Представление = НСтр("ru = 'Наша транспортная служба от перевозчика';
							|en = 'In-house carrier from shipping company'");
	ИначеЕсли СпособДоставки = Перечисления.СпособыДоставки.НашимиСиламиСАдресаОтправителя Тогда
		Представление = НСтр("ru = 'Наша транспортная служба от поставщика';
							|en = 'In-house carrier from vendor'");
