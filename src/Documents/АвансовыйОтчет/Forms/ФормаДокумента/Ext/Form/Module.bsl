...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Параметры.Свойство("НеЗаписыватьРедактируемыйДокументЗакупки", НеЗаписыватьРедактируемыйДокументЗакупки);
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.ДополнительныеСвойства.Вставить("НеЗаписыватьРедактируемыйДокументЗакупки",
	                                              НеЗаписыватьРедактируемыйДокументЗакупки);
...
Процедура ЦенаВключаетНДСПриИзмененииСервер(КэшированныеЗначения)
	...
	ПересчитываемыеСтроки =
		Объект.ПрочиеРасходы.НайтиСтроки(Новый Структура("ЭлектронныйБилет", Документы.Бронирование.ПустаяСсылка()));
