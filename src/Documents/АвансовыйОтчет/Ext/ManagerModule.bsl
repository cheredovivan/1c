...
Процедура УдалитьДобавитьДокументыЗакупки(Ссылка, ДокументыКИзменению, ДополнительныеСвойства, Отказ) Экспорт
	...
	НеЗаписыватьРедактируемыйДокументЗакупки =
		ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ДополнительныеСвойства,
	                                                   "НеЗаписыватьРедактируемыйДокументЗакупки",
	                                                   Ложь);
	
	Для каждого ДокументКИзменению Из ДокументыКИзменению Цикл
		
		Если НеЗаписыватьРедактируемыйДокументЗакупки
			 И ДокументКИзменению = РедактируемыйДокументЗакупки Тогда
			Продолжить;
		КонецЕсли;
