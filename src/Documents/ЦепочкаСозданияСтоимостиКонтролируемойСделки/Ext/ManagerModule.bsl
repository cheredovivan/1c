...
//		Организации - Массив из СправочникСсылка.Организации - организации, для которых формируются цепочки стоимости сделок.
	...
	Для Индекс = НомерСтроки По НомерМаксимальнойСтроки Цикл
		...
		Исключение
			...
			СообщенияПользователю.Добавить(
				...
				НомерПоПорядку, ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке())));
		КонецПопытки;
