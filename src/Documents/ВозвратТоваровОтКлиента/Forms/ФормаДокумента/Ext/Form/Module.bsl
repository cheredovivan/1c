...
Процедура ГруппаСтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	//++ НЕ УТ
	Если ТекущаяСтраница.Имя = "ГруппаДополнительно" И ТребуетсяОбновитьЗаголовокОблагаетсяАкцизом Тогда
...
Процедура ОбновитьИнформациюПоРеализациям(ОбновлятьДанные = Истина)
	...
	УстановитьПредставлениеСебестоимости();
	//++ НЕ УТ
	ИспользоватьПодакцизныеТовары = Документы.ВозвратТоваровОтКлиента.ИспользуютсяПодакцизныеТовары(Объект);
	//-- НЕ УТ
...
Процедура ВычислитьКоличествоПодакцизныхТоваровОтложенно()
	...
	ПараметрыРасчета.ПараметрыОтбора = Новый Структура("ДокументРеализации", Неопределено);
