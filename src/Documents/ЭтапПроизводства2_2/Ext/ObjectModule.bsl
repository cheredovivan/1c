...
Процедура ЗарегистрироватьОчисткуЗаданийКРасчетуГрафикаПроизводства()
	...
	ЕстьЗаданияКРасчетуГрафика = ?(ДинамическаяСтруктура,
		РегистрыСведений.ЗаданияКРасчетуСтруктурыЗаказаГрафикПроизводства.ЕстьЗадания(Ссылка),
		НЕ РегистрыСведений.ЗаданияКРасчетуГрафикаПроизводства.ГрафикЭтапаАктуален(Ссылка));
	...
	Если ЕстьЗаданияКРасчетуГрафика
		...
		ДобавитьОбработчикОбновленияСвязанныхДанных("ОчиститьЗаданияКРасчетуГрафикаПроизводства");
	КонецЕсли;
