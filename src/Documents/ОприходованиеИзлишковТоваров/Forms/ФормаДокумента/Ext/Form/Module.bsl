...
Процедура ГруппаСтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	//++ НЕ УТ
	Если ТекущаяСтраница.Имя = "ГруппаИнформация" И ТребуетсяОбновитьЗаголовокОблагаетсяАкцизом Тогда
...
Процедура ВычислитьКоличествоПодакцизныхТоваровОтложенно()
	...
	ДанныеРасчетаКоличестваПодакцизныхТоваров =
		УчетПодакцизныхТоваров.ЗапуститьРасчетКоличестваПодакцизныхТоваров(Объект);
