...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Иначе
		...
		ПараметрыКонтроля.ШаблонТекстаОшибки =
			НСтр("ru = 'Запрещено оприходование подакцизного товара ""%Номенклатура%"", указанного в строке %НомерСтроки% списка ""%ПредставлениеТабличнойЧасти%"" на розничный склад ""%Склад%""';
				|en = 'Cannot receive the ""%Номенклатура%"" excisable goods specified in line %НомерСтроки% of the ""%ПредставлениеТабличнойЧасти%"" list  in the ""%Склад%"" retail warehouse'");
