...
Процедура РазбитьСтрокуЗавершение(НоваяСтрока, ДополнительныеПараметры) Экспорт 
	...
	Если НоваяСтрока <> Неопределено Тогда
		...
		Если ДополнительныеПараметры.ВидРазбиения = "ФактическоеКоличество" Тогда
			...
			Если Объект.ТипОснованияАктаОРасхождении <> ПредопределенноеЗначение("Перечисление.ТипыОснованияАктаОРасхождении.ВозвратПоставщику") Тогда
...
Процедура УстановитьПредставлениеТоварыДействие()
	...
	// 1. ХО = Отгрузка товаров клиенту
	
	// Недостачи
	
	// 1.1. Вариант действий = ДопоставкаНеТребуется
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	ОтборЭлемента.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ХозяйственнаяОперация");
	ОтборЭлемента.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Перечисления.ХозяйственныеОперации.ОтгрузкаТоваровКлиенту;
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить отгрузку товаров клиенту';
																|en = 'Re-register goods shipment to customer'"));

	// 1.2. Вариант действий = ТребуетсяДопоставка
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить отгрузку товаров клиенту и допоставить';
																|en = 'Re-register goods shipment to customer and supply additionally'"));

	// 1.3. Вариант действий = ТребуетсяСписание
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	ОтборЭлемента.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.Товары.Действие");
	ОтборЭлемента.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписание;

	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Списать за наш счет';
																|en = 'Write off at our expense'"));

	// 1.4. Вариант действий = ТребуетсяСписаниеДопоставка
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Списать за наш счет и допоставить';
																|en = 'Write off at our expense and supply additionally'"));

	// 1.5. Вариант действий = НедостачаНеПризнана
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	ОтборЭлемента.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение =
		Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.НедостачаНеПризнана;

	Элемент.Оформление.УстановитьЗначениеПараметра("Текст",
		НСтр("ru = 'Не признавать и не учитывать расхождения в реализации';
			|en = 'Do not recognize and do not consider discrepancies in sale'"));

	// Излишки

	// 1.1. Вариант действий = ПокупкаПерепоставленного
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	// 1.2. Вариант действий = ВозвратПерепоставленного
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить отгрузку товаров клиенту и вернуть';
																|en = 'Re-register goods shipment to customer and return'"));

	// 1.3. Вариант действий = ТребуетсяОприходование
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Отнести на доходы';
																|en = 'Recognize as income'"));

	// 1.4. Вариант действий = ТребуетсяОприходованиеВозврат
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Отнести на доходы и вернуть';
																|en = 'Recognize as income and create Goods return'"));

	// 1.5. Вариант действий = ПерепоставленноеДарится
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	ОтборЭлемента.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение =
		Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ПерепоставленноеДарится;

	Элемент.Оформление.УстановитьЗначениеПараметра("Текст",
		НСтр("ru = 'Не признавать и не учитывать расхождения в реализации';
			|en = 'Do not recognize and do not consider discrepancies in sale'"));

	// 2. ХО = Переход права собственности
	
	// Недостачи

	// 2.1. Вариант действий = УменьшитьПереходПраваСобственности
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить переход права собственности';
																|en = 'Re-register transfer of title to goods'"));

	// 2.2. Вариант действий = ДопоставкаНеТребуется
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить все документы';
																|en = 'Re-register all documents'"));

	// 2.3. Вариант действий = ТребуетсяДопоставка и Способ отражения = ИсправлениеПервичныхДокументов
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.СпособОтраженияРасхождений");
	ОтборЭлемента.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение =
		Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ИсправлениеПервичныхДокументов;

	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить все документы и допоставить';
																|en = 'Re-register all documents and supply additionally'"));

	// 2.4. Вариант действий = ТребуетсяДопоставка и Способ отражения <> ИсправлениеПервичныхДокументов
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить переход права собственности и допоставить';
																|en = 'Re-register transfer of title to goods and supply additionally'"));

	// 2.5. Вариант действий = ТребуетсяСписание
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	// 2.6. Вариант действий = ТребуетсяСписаниеДопоставка
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	// 2.1. Вариант действий = УвеличитьПереходПраваСобственности
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	// 2.2. Вариант действий = ПокупкаПерепоставленного
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	// 2.3. Вариант действий = ВозвратПерепоставленного и Способ отражения = ИсправлениеПервичныхДокументов
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить все документы и вернуть';
																|en = 'Re-register all documents and return'"));

	// 2.4. Вариант действий = ВозвратПерепоставленного и Способ отражения <> ИсправлениеПервичныхДокументов
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Переоформить переход права собственности и вернуть';
																|en = 'Re-register transfer of title to goods and return'"));

	// 2.5. Вариант действий = ТребуетсяОприходование
	Элемент = УсловноеОформление.Элементы.Добавить();
	...
	// 2.6. Вариант действий = ТребуетсяОприходованиеВозврат
	Элемент = УсловноеОформление.Элементы.Добавить();
...
Процедура УправлениеРеквизитамиФормыВЗависимостиОтТипаОснования()
	...
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаДавальцу
		...
		Элементы.ТоварыЗаполнитьСтавкуНДС.Доступность = Ложь;
	...
	ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(Объект.ТипОснованияАктаОРасхождении) Тогда
		...
		Элементы.ТоварыЗаполнитьПоОснованиям.Заголовок = НСтр("ru = 'По отгрузке товаров клиенту';
																|en = 'By goods shipment to customer'");
		...
		Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПереходПраваСобственности Тогда
			Если СозданиеНовогоДокумента Тогда
				Заголовок = НСтр("ru = 'Акт о расхождениях после отгрузки товаров клиенту и перехода права собственности (создание)';
								|en = 'Sales dispute after goods shipment to customer and transfer of title to goods (create)'");
			Иначе
				ШаблонЗаголовка = НСтр("ru = 'Акт о расхождениях после отгрузки товаров клиенту и перехода права собственности %1 от %2';
										|en = 'The ""%1"" sales dispute after goods shipment to customer and transfer of title to goods dated %2'");
		...
		Иначе
			...
			Иначе
				ШаблонЗаголовка = НСтр("ru = 'Акт о расхождениях после реализации %1 от %2';
										|en = 'Customer invoice dispute %1 dated %2'");
				Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонЗаголовка,
					Объект.Номер,
					Объект.Дата);
				ОбщегоНазначенияУТКлиентСервер.ОбработкаПолученияПредставленияВходящегоДокумента(
	...
	ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(Объект.ТипОснованияАктаОРасхождении) Тогда
		...
		Если СозданиеНовогоДокумента Тогда
			Заголовок = НСтр("ru = 'Акт о расхождениях после отгрузки товаров клиенту и до перехода права собственности (создание)';
							|en = 'Sales dispute after goods shipment to customer and before transfer of title to goods (create)'");
		Иначе
			ШаблонЗаголовка = НСтр("ru = 'Акт о расхождениях после отгрузки товаров клиенту и до перехода права собственности %1 от %2';
									|en = 'The ""%1"" sales dispute after goods shipment to customer and before transfer of title to goods dated %2'");
			Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонЗаголовка,
				Объект.Номер,
				Объект.Дата);
			ОбщегоНазначенияУТКлиентСервер.ОбработкаПолученияПредставленияВходящегоДокумента(
		...
		Элементы.Договор.Подсказка = НСтр("ru = 'Договор, в рамках которого оформлена отгрузка товаров клиенту';
											|en = 'Contract under which the goods shipment to customer is registered'");
...
Функция ТребуетсяОчисткаДействияВТЧ()
	...
	Если СпособОтраженияРасхождений =
...
Процедура ЗадатьВопросОбОчисткеКолонкиДействие()
	...
	ТекстВопроса = НСтр("ru = 'Колонка ""Как отработать расхождение"" списка ""Товары"" будет очищена. Продолжить?';
						|en = 'The ""Discrepancy treatment"" column of the ""Goods"" list will be cleared. Continue?'");
