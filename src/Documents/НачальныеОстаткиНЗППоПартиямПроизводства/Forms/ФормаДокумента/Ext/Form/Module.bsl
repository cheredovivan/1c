...
Процедура ТрудозатратыВидРаботПриИзмененииНаСервере(Идентификатор)
	...
	ТекущиеДанные.НормативнаяРасценка	= Справочники.ВидыРаботСотрудников.ДействующаяРасценкаВидаРабот(ТекущиеДанные.ВидРабот, Объект.Дата,, Объект.Подразделение, Объект.Организация);
