...
Процедура ТекстЗапросаДанныеДокументаТаблицаВидыЗапасов(СписокЗапросов)
	...
	//++ НЕ УТ
	|	ТаблицаВидыЗапасов.ВидЗапасов.ОблагаетсяАкцизом КАК ВидЗапасовОблагаетсяАкцизом,
	|	ТаблицаВидыЗапасов.ВидЗапасов.ПодразделениеПроизводства КАК ВидЗапасовПодразделениеПроизводства,
	//-- НЕ УТ
...
Функция ТекстЗапросаВтТоварыОрганизаций(Запрос, ТекстыЗапроса, ДокументОбъект = Неопределено)  Экспорт
	...
	//++ НЕ УТ
	|			И ВидыЗапасовСкладские.ОблагаетсяАкцизом = ТаблицаТовары.ВидЗапасовОблагаетсяАкцизом
	//-- НЕ УТ
...
Функция ТекстЗапросаВтВидыЗапасовДляСоединенияАналитик(Запрос, ТекстыЗапроса, ДокументОбъект = Неопределено)
	...
	|	ТЧВидыЗапасов.ВидЗапасовГруппаПродукции КАК ВидЗапасовГруппаПродукции,
		//++ НЕ УТ
	|	ТЧВидыЗапасов.ВидЗапасовОблагаетсяАкцизом КАК ВидЗапасовОблагаетсяАкцизом,
	|	ТЧВидыЗапасов.ВидЗапасовПодразделениеПроизводства КАК ВидЗапасовПодразделениеПроизводства,
	//-- НЕ УТ
	...
	Если ДокументОбъект = Неопределено Тогда
		...
		//++ НЕ УТ
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ТЧВидыЗапасов.ВидЗапасовОблагаетсяАкцизом", "ТЧВидыЗапасов.ВидЗапасов.ОблагаетсяАкцизом");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ТЧВидыЗапасов.ВидЗапасовПодразделениеПроизводства", "ТЧВидыЗапасов.ВидЗапасов.ПодразделениеПроизводства");
		//-- НЕ УТ
