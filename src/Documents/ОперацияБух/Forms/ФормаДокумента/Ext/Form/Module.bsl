...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокТиповДокументовОснования.Добавить(Тип("ДокументСсылка.ПодтверждениеНулевойСтавкиНДС"));
...
Функция ВернутьСписокРегистровДляОтражения(ТаблицаРегистров, КорректировкаРегистровНДС)
	...
	ДвиженияПоАкцизам = Метаданные.РегистрыНакопления.ДвиженияПоАкцизам;
	СписокРегистровНДС.Добавить(ДвиженияПоАкцизам.Имя, ДвиженияПоАкцизам.Синоним, КорректировкаРегистровНДС);
