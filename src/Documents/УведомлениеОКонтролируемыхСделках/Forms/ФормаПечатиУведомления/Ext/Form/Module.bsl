...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Параметры.Уведомление имеет тип данных ДанныеФормыСтуктура
...
Функция ПакетЛистовДляПечати(Знач НомерНачало, Знач НомерКонец)
	...
	Возврат КонтролируемыеСделки.ПакетЛистовУведомленияДляПечати(ЛистыУведомления, СведенияОбУведомлении, НомерНачало, НомерКонец, УникальныйИдентификатор);
