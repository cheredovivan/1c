...
#КонецОбласти
	...
	ПроизводствоСервер.УстановитьУсловноеОформлениеПоляДоляСтоимостиОтмененныхСтрок(ЭтаФорма, "РедактированиеЭтапов", "ВыходныеИзделия", "РедактированиеЭтаповВыходныеИзделия");
...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов, ИмяТабличнойЧасти)
	...
	ПослеИзмененияСтрокТЧПрограммноНаСервере(ИмяТабличнойЧасти);
	РассчитатьИтоговыеПоказателиДокумента(ЭтотОбъект);
