...
// 
// Параметры:
//  ВсеЗаказы - Массив Из ДокументСсылка.ЗаказПереработчику
...
Функция ПараметрыВыполненияКомандУстановкиДействий(ВсеЗаказы, КодДействия) Экспорт
	...
	Результат.ПараметрыВстраивания = ДоступныеОстаткиПараметрыВстраивания(Неопределено, ДополнительныеПараметры);
