	...
	Пока ВыборкаПоОрганизациям.Следующий() Цикл
		...
		Исключение
			...
			ПараметрыРегистрации = ЗакрытиеМесяцаСервер.ИнициализироватьПараметрыРегистрацииПроблемыРасчета(
				Справочники.ОперацииЗакрытияМесяца.ФормированиеРезервовПодОбесценениеЗапасов,
				ВыборкаПоОрганизациям.Организация,
				Период);
...
Процедура ДобавитьЭтап_ФормированиеРезервовПодОбесценениеЗапасов(ТаблицаЭтапов, ТекущийРодитель) Экспорт
	...
	НоваяСтрока.МультиязычноеНаименование = "ru = 'Формирование резервов под обесценение запасов';
											|en = 'Generate provisions for impairment of inventory'"; // @НСтр-1
