...
Процедура ПроверитьНаличиеБазыРаспределения(Отказ)
	...
	|	ТипБазыРаспределения
	|ИЗ
	|	ВтНалогиВзносыОрганизации КАК Таблица
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|	ТрудозатратыНЗП.ФизическоеЛицо              КАК ФизическоеЛицо,
	|	СУММА(ТрудозатратыНЗП.НормативнаяСтоимость) КАК НормативнаяСтоимость,
	|	СУММА(ТрудозатратыНЗП.Длительность)         КАК Длительность
	...
	|	ТрудозатратыНЗП.ФизическоеЛицо
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Подразделение,
	|	ФизическоеЛицо
