...
Функция ДанныеТорговойТочки_2021(ПараметрыТорговойТочки)
	...
	АдресТорговойТочки = Новый Структура("Значение", ПараметрыТорговойТочки.ТорговаяТочка.КонтактнаяИнформация[0].Значение);
	...
	АдресВФорматеФИАС = УведомлениеОСпецрежимахНалогообложения.АдресВФорматеФИАС(АдресТорговойТочки.Значение);
