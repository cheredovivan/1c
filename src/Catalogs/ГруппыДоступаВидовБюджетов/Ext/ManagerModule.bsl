...
//			*ГруппаДоступа - СправочникСсылка.ГруппыДоступаВидовБюджетов - группа доступа объекта.
//			*Ссылка - СправочникСсылка - ссылка на справочник, к которому возможно ограничение доступа по группе доступа видов бюджетов.
//
//	Возвращаемое значение:
