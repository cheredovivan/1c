...
Процедура ВосстановитьПредопределенные_НаСервере()
	...
	Если НЕ ОбщегоНазначения.РазделениеВключено()
		И Метаданные.РегистрыСведений.Найти(ИмяТипаРегистраСведенийВидыДокументовГосОргановДляПоиска) <> Неопределено Тогда
		РегистрыСведений[
			ИмяТипаРегистраСведенийВидыДокументовГосОргановДляПоиска].ЗаполнитьВидыДокументовГосОргановДляПоиска(Истина);
	КонецЕсли;
