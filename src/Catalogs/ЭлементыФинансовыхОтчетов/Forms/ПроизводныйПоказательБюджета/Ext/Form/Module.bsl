...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого СтрокаОперанда Из ДанныеОбъекта.ОперандыФормулы Цикл
		...
		ИмяВспомогательныхДанных = Неопределено;
		Если ДанныеЭлемента.ВидЭлемента = Перечисления.ВидыЭлементовФинансовогоОтчета.СтатьяБюджетов Тогда
			РеквизитСтатьяБюджетов = ДанныеЭлемента.РеквизитыВидаЭлемента.Найти(
				ПланыВидовХарактеристик.РеквизитыЭлементовФинансовыхОтчетов.СтатьяБюджетов, "Реквизит");
			Если ТипЗнч(РеквизитСтатьяБюджетов.Значение) = Тип("СправочникСсылка.ПоказателиБюджетов") Тогда
				ИмяВспомогательныхДанных = "Целевой";
			КонецЕсли;
		КонецЕсли;
		НоваяСтрока.НестандартнаяКартинка = ФинансоваяОтчетностьПовтИсп.НестандартнаяКартинка(НоваяСтрока.ВидЭлемента,
			ИмяВспомогательныхДанных);
