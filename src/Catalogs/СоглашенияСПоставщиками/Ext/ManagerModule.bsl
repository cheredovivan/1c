...
Процедура ПриОпределенииДоступныхВидовОповещенийПользователей(ОписаниеВидовОповещений) Экспорт
	...
	НовыйВидОповещений.Наименование = НСтр("ru = 'Согласование соглашений об условиях закупок';
											|en = 'Terms of purchase approval'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	НовыйВидОповещений.ШаблонТекстаОповещения = "ru = 'Согласовать соглашение.';
												|en = 'Approve terms of sales.'"; // @NStr-1
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Согласовать соглашения об условиях закупок.';
														|en = 'Approve terms of purchase.'"; // @NStr-1
	
	НовыйВидОповещений = ОповещенияПользователейОСобытиях.ДобавитьОписаниеВидаОповещенийПользователей(ОписаниеВидовОповещений);
	НовыйВидОповещений.ГруппаВидаОповещений = ГруппаВидаОповещенийЗакупки;
	НовыйВидОповещений.Идентификатор = "96f98c9e-9183-4842-9518-64ff1af03391";
	НовыйВидОповещений.Наименование = НСтр("ru = 'Приближение даты окончания действия соглашений об условиях закупок';
											|en = 'Approach of terms of purchase expiration date'", ОбщегоНазначения.КодОсновногоЯзыка());
	НовыйВидОповещений.ТипОповещения = Перечисления.ТипыОповещенийПользователей.Неоперативное;
	...
	НовыйВидОповещений.ШаблонТекстаОповещения = "ru = 'Заканчивается срок действия соглашения [ДатаОкончанияДействия].';
												|en = 'The terms of sales are expiring on [ДатаОкончанияДействия].'"; // @NStr-1
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Заканчивается срок действия соглашений об условиях закупок.';
														|en = 'Terms of purchase are expiring.'"; // @NStr-1
	
	НовыйВидОповещений = ОповещенияПользователейОСобытиях.ДобавитьОписаниеВидаОповещенийПользователей(ОписаниеВидовОповещений);
	НовыйВидОповещений.ГруппаВидаОповещений = ГруппаВидаОповещенийЗакупки;
	НовыйВидОповещений.Идентификатор = "399811b6-c50d-4060-a2b0-5ae8c7fc16cd";
	НовыйВидОповещений.Наименование = НСтр("ru = 'Окончание срока действия соглашений об условиях закупок';
											|en = 'Terms of purchase expiration'", ОбщегоНазначения.КодОсновногоЯзыка());
	НовыйВидОповещений.ТипОповещения = Перечисления.ТипыОповещенийПользователей.Неоперативное;
	...
	НовыйВидОповещений.ШаблонТекстаОповещения = "ru = 'Закончился срок действия соглашения [ДатаОкончанияДействия].';
												|en = 'The terms of sales expired on [ДатаОкончанияДействия].'"; // @NStr-1
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Закончился срок действия соглашений об условиях закупок.';
														|en = 'Terms of purchase expired.'"; // @NStr-1
КонецПроцедуры
