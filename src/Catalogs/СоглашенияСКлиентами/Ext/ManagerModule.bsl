...
Процедура ПриОпределенииДоступныхВидовОповещенийПользователей(ОписаниеВидовОповещений) Экспорт
	...
	НовыйВидОповещений.Наименование = НСтр("ru = 'Согласование соглашений об условиях продаж';
											|en = 'Terms of sales approval'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Согласовать соглашения об условиях продаж.';
														|en = 'Approve terms of sales.'"; // @NStr-1
	
	НовыйВидОповещений = ОповещенияПользователейОСобытиях.ДобавитьОписаниеВидаОповещенийПользователей(ОписаниеВидовОповещений);
	НовыйВидОповещений.ГруппаВидаОповещений = ГруппаВидаОповещенийПродажи;
	НовыйВидОповещений.Идентификатор = "413b40aa-ec43-4c07-a73b-fcc1dafd25a2";
	НовыйВидОповещений.Наименование = НСтр("ru = 'Приближение даты окончания действия соглашений об условиях продаж';
											|en = 'Approach of terms of sales expiration date'", ОбщегоНазначения.КодОсновногоЯзыка());
	НовыйВидОповещений.ТипОповещения = Перечисления.ТипыОповещенийПользователей.Неоперативное;
	...
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Заканчивается срок действия соглашений об условиях продаж.';
														|en = 'Terms of sales are expiring.'"; // @NStr-1
	
	НовыйВидОповещений = ОповещенияПользователейОСобытиях.ДобавитьОписаниеВидаОповещенийПользователей(ОписаниеВидовОповещений);
	НовыйВидОповещений.ГруппаВидаОповещений = ГруппаВидаОповещенийПродажи;
	НовыйВидОповещений.Идентификатор = "ed019256-d7ca-4717-991f-62a6eef8f4f1";
	НовыйВидОповещений.Наименование = НСтр("ru = 'Окончание срока действия соглашений об условиях продаж';
											|en = 'Terms of sales expiration'", ОбщегоНазначения.КодОсновногоЯзыка());
	НовыйВидОповещений.ТипОповещения = Перечисления.ТипыОповещенийПользователей.Неоперативное;
	...
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Закончился срок действия соглашений об условиях продаж.';
														|en = 'Terms of sales expired.'"; // @NStr-1
