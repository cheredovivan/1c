...
Процедура ОбновитьЭлементыФормы(Команда)
	...
	Элементы.РедакцияФормы.Заголовок = РедакцияФормы;
...
Процедура ОбновитьРедакциюФормы(Настройка, РедакцияФормы)
	...
	РедакцияФормы = Реквизиты.ВерсияПравил;
	Если РедакцияФормы = "" Тогда
		...
		Если Реквизиты.РедакцияФормы <> "" Тогда
			
			АктуальныеПравила = ПоставляемыеПравила.Найти(Реквизиты.РедакцияФормы,"РедакцияФормы");
			
			РедакцияФормы = АктуальныеПравила.РедакцияФормыПодсказка;
