...
Функция НаименованиеВидаЗапасов(СправочникОбъект)
	...
	//++ НЕ УТ
	Если СправочникОбъект.ОблагаетсяАкцизом Тогда
		ЧастиНаименования.Добавить(НСтр("ru = 'Облагается акцизом по подразделению:';
										|en = 'It is subject to excise by business unit:'", КодОсновногоЯзыка)
									+ Символы.НПП + Строка(СправочникОбъект.ПодразделениеПроизводства));
	КонецЕсли;
	//-- НЕ УТ
