...
Функция СтруктураВидаЗапасов(Организация, ХозяйственнаяОперация = Неопределено, РеквизитыДокумента = Неопределено) Экспорт
	...
	Если РеквизитыДокумента <> Неопределено Тогда
		...
		Если СтруктураВидЗапасов.ТипЗапасов = Перечисления.ТипыЗапасов.Товар Тогда
			СтруктураВидЗапасов.ОблагаетсяАкцизом = РеквизитыДокумента.ОблагаетсяАкцизом;
			
			Если СтруктураВидЗапасов.ОблагаетсяАкцизом Тогда
				СтруктураВидЗапасов.ПодразделениеПроизводства = РеквизитыДокумента.ПодразделениеПроизводства;
			КонецЕсли;
		КонецЕсли;
		//-- НЕ УТ
...
// Получает признак обложения акцизом для вида запасов.
// 
// Параметры:
//  ВидЗапасов - СправочникСсылка.ВидыЗапасов - Вид запасов
// 
// Возвращаемое значение:
//  Булево - Истина, если облагается акцизом
Функция ОблагаетсяАкцизом(ВидЗапасов) Экспорт
	
	Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВидЗапасов, "ОблагаетсяАкцизом");
