...
Процедура НастроитьДоступностьЭлементов(Форма)
	...
	//++ НЕ УТ
	Форма.Элементы.ЦелевыеПараметрыКонтракта.Доступность =
		(Форма.Объект.ТипНаправленияДеятельности = ПредопределенноеЗначение("Перечисление.ТипыНаправленийДеятельности.КонтрактГОЗ"))
		И Не Форма.Элементы.ТипНаправленияДеятельностиКонтрактГОЗ.ТолькоПросмотр;
	Форма.Элементы.ЦелевыеПараметрыГосконтракта.Доступность = 
		(Форма.Объект.ТипНаправленияДеятельности = ПредопределенноеЗначение("Перечисление.ТипыНаправленийДеятельности.ГосударственныйКонтракт"))
		И Не Форма.Элементы.ТипНаправленияДеятельностиГосконтракт.ТолькоПросмотр;
	//-- Локализация
