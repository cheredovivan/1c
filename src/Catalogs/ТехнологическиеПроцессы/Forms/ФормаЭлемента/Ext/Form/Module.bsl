...
&НаКлиенте
Процедура ЗаменитьВЭтапах(Команда)
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ТехнологическийПроцесс", Объект.Ссылка);
...
Процедура НастроитьЭлементыФормы()
	...
	Элементы.ФормаЗаменитьВЭтапах.Доступность        = ЗначениеЗаполнено(Объект.Ссылка);
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("РассчитыватьКоэффициент")
...
Процедура ПриИзмененииРассчитыватьКоэффициентЧисло()
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "РассчитыватьКоэффициент");
...
Процедура ЗаполнитьЕстьАвтовыборНоменклатуры()
	...
	И УправлениеДаннымиОбИзделиях.ЕстьАвтовыборНоменклатурыВТаблице(Объект.МатериалыИУслуги);
