...
Функция ДанныеОперацииМаршрутнойКарты(Операция, КоличествоОпераций, КоэффициентМаршрутнойКарты, ДанныеПоНоменклатуре) Экспорт
	...
	РаспаковатьСоставНаборов(СтруктураДанных);
...
Процедура ОбработатьРасчетКоличестваПоФормулам(ПараметрыРасчетаПоФормулам, ДанныеМаршрутнойКарты, ИспользоватьДанныеМаршрутнойКарты = Истина)
	...
	УправлениеДаннымиОбИзделиях.ДобавитьТаблицуДляРасчетаПоФормулам(НаборДанных, ДанныеМаршрутнойКарты, "ВыходныеИзделия");
	УправлениеДаннымиОбИзделиях.ДобавитьТаблицуДляРасчетаПоФормулам(НаборДанных, ДанныеМаршрутнойКарты, "Материалы");
	УправлениеДаннымиОбИзделиях.ДобавитьТаблицуДляРасчетаПоФормулам(НаборДанных, ДанныеМаршрутнойКарты, "ВозвратныеОтходы");
	УправлениеДаннымиОбИзделиях.ДобавитьТаблицуДляРасчетаПоФормулам(НаборДанных, ДанныеМаршрутнойКарты, "Трудозатраты");
	...
	УправлениеДаннымиОбИзделиях.РассчитатьКоличествоВСтроках(ДанныеМаршрутнойКарты, "ВыходныеИзделия",  Истина, ДанныеДляРасчета);
	УправлениеДаннымиОбИзделиях.РассчитатьКоличествоВСтроках(ДанныеМаршрутнойКарты, "Материалы",        Истина, ДанныеДляРасчета);
	УправлениеДаннымиОбИзделиях.РассчитатьКоличествоВСтроках(ДанныеМаршрутнойКарты, "ВозвратныеОтходы", Истина, ДанныеДляРасчета);
	УправлениеДаннымиОбИзделиях.РассчитатьКоличествоВСтроках(ДанныеМаршрутнойКарты, "Трудозатраты",     Ложь,   ДанныеДляРасчета);
...
Процедура ДобавитьДанныеМаршрутнойКартыРекурсивно(МаршрутнаяКарта, КоличествоРезультата, Номенклатура, Характеристика, СтруктураСвязей, СтруктураДанных)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПараметризациюРесурсныхСпецификаций") Тогда
		...
		ПараметрыАвтовыбора = УправлениеДаннымиОбИзделиях.ПолучитьПараметрыАвтовыбора(МаршрутнаяКарта, ДанныеПоНоменклатуре);
	...
	РаспаковатьСоставНаборов(ДанныеМаршрутнойКарты);
...
Функция ТекстЗапросаОтборПоСвойствам()
	...
	Результат = УправлениеДаннымиОбИзделиях.ТекстЗапросаВТОтборПоСвойствамНастройки(Справочники.МаршрутныеКарты.ПустаяСсылка())
		+ ОбщегоНазначения.РазделительПакетаЗапросов()
		+ УправлениеДаннымиОбИзделиях.ТекстЗапросаВТОтборПоСвойствам("ВТОтборПоСвойствамНастройки");
	Возврат СтрЗаменить(Результат, "&Ссылка", "&МаршрутнаяКарта");
...
Функция ТекстЗапросаОперацииМаршрутнойКарты(УстановитьОтборПоОперации)
	...
	|	ТехнологическиеОперации.ПередаточнаяПартия КАК ПередаточнаяПартия,
...
Процедура РаспаковатьСоставНаборов(ДанныеМаршрутнойКарты)

	НаборДанных = Неопределено;
	Если НЕ ДанныеМаршрутнойКарты.Свойство("Материалы", НаборДанных) Тогда
		Возврат;
	КонецЕсли;
	
	ПараметрыПолученияСостава = УправлениеДаннымиОбИзделиях.ПараметрыПолученияСоставаНабораВПроизводстве();
	ЗаполнитьЗначенияСвойств(ПараметрыПолученияСостава, ДанныеМаршрутнойКарты);
	
	ПараметрыПолученияСостава.ИсточникиСостава.Добавить(Перечисления.ИсточникиСоставаНаборовВПроизводстве.ВариантыКомплектации);
