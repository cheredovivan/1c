...
Процедура ЗаполнитьЕстьАвтовыборНоменклатуры()
	...
	И (
		УправлениеДаннымиОбИзделиях.ЕстьАвтовыборНоменклатурыВТаблице(Объект.МатериалыИУслуги)
		ИЛИ УправлениеДаннымиОбИзделиях.ЕстьАвтовыборНоменклатурыВТаблице(Объект.ВозвратныеОтходы)
		ИЛИ УправлениеДаннымиОбИзделиях.ЕстьАвтовыборНоменклатурыВТаблице(Объект.ВыходныеИзделия)
	);
