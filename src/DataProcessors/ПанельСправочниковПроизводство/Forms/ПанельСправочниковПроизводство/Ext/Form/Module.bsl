...
&НаКлиенте
Процедура ОткрытьКлассификаторТехнологическихОпераций(Команда)
	
	//++ НЕ УТКА
	ОткрытьФорму("Справочник.КлассификаторТехнологическихОпераций.ФормаСписка", , ЭтотОбъект);
	//-- НЕ УТКА
...
&НаКлиенте
Процедура ОткрытьВидыТехнологическихОпераций(Команда)
	
	//++ НЕ УТКА
	ОткрытьФорму("Справочник.ВидыТехнологическихОпераций.Форма.ФормаСписка", , ЭтотОбъект);
	//-- НЕ УТКА
...
Процедура УправлениеЭлементами()
	...
	#Область НормативноСправочнаяИнформация
	
	Элементы.ОткрытьКлассификаторТехнологическихОпераций.Видимость = Истина
	//++ НЕ УТКА
		И ПравоДоступа("Просмотр", Метаданные.Справочники.КлассификаторТехнологическихОпераций)
		И ПолучитьФункциональнуюОпцию("ХранитьОперацииВРесурсныхСпецификациях")
	//-- НЕ УТКА
		И УправлениеПредприятием;
	
	Элементы.ОткрытьВидыТехнологическихОпераций.Видимость = Истина
	//++ НЕ УТКА
		И ПравоДоступа("Просмотр", Метаданные.Справочники.ВидыТехнологическихОпераций)
		И ПолучитьФункциональнуюОпцию("ИспользоватьВидыТехнологическихОпераций")
	//-- НЕ УТКА
		И УправлениеПредприятием;
