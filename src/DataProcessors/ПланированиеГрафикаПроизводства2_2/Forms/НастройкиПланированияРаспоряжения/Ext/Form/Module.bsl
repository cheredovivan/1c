...
Процедура УправлениеДоступностью(Форма)
	...
	Элементы.ОтменитьРучныеИзмененияГрафика.Доступность = Форма.ПолноеПерепланирование
		ИЛИ Форма.ДинамическаяСтруктура;
	Форма.ОтменитьРучныеИзмененияГрафика = ?(Элементы.ОтменитьРучныеИзмененияГрафика.Доступность,
		Форма.ОтменитьРучныеИзмененияГрафика, Ложь);
