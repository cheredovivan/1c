...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстПодсказкиПериод = НСтр("ru = 'Ограничивать установку цен периодом: цены устанавливаются на указанный период,
		...
		|en = 'Limit price setting to a period:  prices are set for the specified period.
		|Current prices will be returned after the end date'");
	...
	ТекстПодсказкиМероприятие = НСтр("ru = 'Маркетинговое мероприятие, в рамках которого устанавливаются цены';
									|en = 'Marketing activity within which prices are set'");
