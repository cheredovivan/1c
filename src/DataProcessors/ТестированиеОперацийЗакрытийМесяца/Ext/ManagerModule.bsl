	...
	Для Каждого СтрокаПериода Из ТаблицаПериодов Цикл
		...
		Для Каждого РазделРасчета Из ВыбранныеРазделы Цикл
			...
			Если РазделРасчета = "УСН" Тогда
				...
				ОперацииУСН.Добавить(Справочники.ОперацииЗакрытияМесяца.ПризнаниеРасходовПриУСН);
				ОперацииУСН.Добавить(Справочники.ОперацииЗакрытияМесяца.РасчетНалогаУСН);
				ОперацииУСН.Добавить(Справочники.ОперацииЗакрытияМесяца.СторноДоходовКУДиР);
