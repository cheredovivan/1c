...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_НаборКонстант" Тогда
		...
		Если РежимРаботы.ВнешниеРодительскиеКонстанты.Свойство(Источник)
		 ...
		 ИЛИ Источник = "ИспользоватьВнеоборотныеАктивы2_4"
		 ИЛИ Источник = "ИспользоватьВнутреннееПотребление" Тогда
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьВнутреннееПотребление"
		...
		Элементы.ИспользоватьСтатусыВнутреннихПотреблений.Доступность = ЗначениеКонстанты;
		Элементы.ГруппаКомментарийИспользоватьСтатусыВнутреннихПотреблений.Видимость = Не ЗначениеКонстанты;
