...
Процедура ПриЗагрузкеФайлаНастройки(ДанныеНастройки, ДанныеФайла, Обработан) Экспорт
	...
	Если ДанныеНастройки.Идентификатор = ИдентификаторМанифеста() Тогда
		Обработан = Истина;
	ИначеЕсли СтрНачинаетсяС(ДанныеНастройки.Идентификатор, "Panel_")
		Или СтрНачинаетсяС(ДанныеНастройки.Идентификатор, "AddSrc_") Тогда 
		Обработан = Истина;
	КонецЕсли;
...
Функция ИдентификаторМанифеста() Экспорт
	...
	Идентификатор = "Manifest_AnalyticsPanels_ARA_2_5";
	
	//++ НЕ УТКА
	
	Идентификатор = "Manifest_AnalyticsPanels_ERP_2_5";
...
Функция ПрочитатьФайлыНастроек(Идентификаторы) Экспорт
	...
	ПоставляемыеНастройкиСервер.ОбновитьПоставляемыеНастройки(Идентификаторы);
...
// ИнтернетПоддержкаПользователей
Процедура ДобавитьНастройки(Настройки)
	
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		ВызватьИсключение НСтр("ru = 'Добавление настроек при работе в модели сервиса не поддерживается.';
