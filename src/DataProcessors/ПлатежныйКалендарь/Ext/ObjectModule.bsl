...
Функция ОбластиПланирования() Экспорт
	...
	//++ НЕ УТ
	ЛизингВключать = (Аренда И ИспользуетсяУправлениеВНА
		Или Не Аренда И Не ИспользуетсяУправлениеВНА);
	//-- НЕ УТ
	...
	Если ЕстьОтборОбластей Тогда
		...
		//++ НЕ УТ
		Если Аренда Тогда
			ОбластиПланирования.Добавить(Перечисления.ОбластиПланированияПлатежей.Аренда);
		КонецЕсли;
		//-- НЕ УТ
	КонецЕсли;
