	...
	Если РезультатПроверкиПоДокументу.Статус = Перечисления.СтатусыОбработкиДокументовИСМП.НеВыполнялось
		...
		ИначеЕсли (РезультатПроверкиПоДокументу.СтатусОтправки = Перечисления.СтатусОтправкиГИСМТ.НеОтправлен
			...
			Если ПредварительнаяПроверкаВозможна Тогда
				...
				ПроверитьМОДУчастниковОбмена(ПараметрыОбработки);
...
Функция ЗапроситьСтатусыКодовМаркировки(ПараметрыОбработки)
	...
	ВидыВнутреннегоПеремещенияМеждуМОД = ОбщегоНазначенияИСМПКлиентСерверПовтИсп.ВидыПродукцииВнутреннегоПеремещенияМеждуМОД();
...
Процедура ВыполнитьОтдельныеПроверкиПродавцаИПокупателя(ПараметрыОбработки, ЭтоДокументПриобретения) Экспорт
	...
	Если Не ЭтоДокументПриобретения Тогда
		...
		Отказ = ПроверитьМОДУчастниковОбмена(ПараметрыОбработки);
...
Функция ПроверитьМОДУчастниковОбмена(ПараметрыОбработки) Экспорт
	
	ЗаполнитьДанныеАдресовДляПроверкиМОД(ПараметрыОбработки);
...
Функция НаличиеЗарегистрированногоМОДаОрганизации(ПараметрыОбработки)
	...
	Если РеквизитыДокумента.ОтправительИндивидуальныйПредприниматель
	...
	ИначеЕсли ПараметрыОбработки.РеквизитыДокумента.ОтправительИндивидуальныйПредприниматель Тогда
	...
	Если РеквизитыДокумента.ОтправительИндивидуальныйПредприниматель
		И Не ЗначениеЗаполнено(ДанныеДляПроверкиМОД.Продавец.КодФИАС) Тогда
...
Функция НаличиеЗарегистрированногоМОДаКонтрагента(ПараметрыОбработки)
	...
	Если РеквизитыДокумента.ПолучательИндивидуальныйПредприниматель
	...
	ИначеЕсли РеквизитыДокумента.ПолучательИндивидуальныйПредприниматель Тогда
...
Процедура ЗаполнитьДанныеАдресовДляПроверкиМОД(ПараметрыОбработки)
