...
Функция ВыгрузитьНаСервере()
	...
	Для Каждого ВидБюджета Из ВыбранныеВидыБюджета Цикл
		...
		ОбъектМД = Метаданные.Справочники.ПравилаРасчетаСвязанныхОстатковИОборотовБюджетов;
		ВыгрузкаЗагрузкаМоделейМеждународногоУчетаИБюджетирования.ДобавитьСтрокуВДанныеВыгрузки(ДанныеВыгрузки, ОбъектМД, ВидБюджета, ВыгружаемыеПоказателиБюджетов, "Приемник");
		...
		ОбъектМД = Метаданные.Справочники.ПравилаРасчетаСвязанныхОстатковИОборотовБюджетов;
		ВыгрузкаЗагрузкаМоделейМеждународногоУчетаИБюджетирования.ДобавитьСтрокуВДанныеВыгрузки(ДанныеВыгрузки, ОбъектМД, ВидБюджета, ВыгружаемыеСтатьиБюджетов, "Источник");
