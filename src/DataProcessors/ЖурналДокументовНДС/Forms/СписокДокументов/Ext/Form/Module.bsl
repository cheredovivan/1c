...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_СчетФактураВыданный"
		...
		ИЛИ ИмяСобытия = "Запись_Бронирование"
...
Функция ОписаниеОперацийИТиповДокументов()
	...
	Строка.ЗаголовокРабочегоМеста				= НСтр("ru = 'Электронные билеты, подтверждающие оплату сумм НДС';
														|en = 'Electronic tickets confirming payment of VAT amounts'");
	Строка.ТипДокумента 						= Тип("ДокументСсылка.Бронирование");
	Строка.ПолноеИмяДокумента					= Метаданные.Документы.Бронирование.ПолноеИмя();
	Строка.ИспользуютсяСтатусы					= Ложь;
	Строка.ДобавитьКнопкуСоздать				= Ложь;
