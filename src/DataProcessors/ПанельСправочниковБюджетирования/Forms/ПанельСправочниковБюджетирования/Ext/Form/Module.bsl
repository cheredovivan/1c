...
Процедура ОткрытьПравилаРасчетаОстатковИОборотов(Команда)
	...
	//++ НЕ УТ
	ОткрытьФорму("Справочник.ПравилаРасчетаСвязанныхОстатковИОборотовБюджетов.ФормаСписка");
	//-- НЕ УТ
	Возврат;
...
Процедура УправлениеЭлементами()
	...
	ПравоДоступаПравилаРасчетаОстатковИОборотовБюджетов      = ПравоДоступа("Просмотр", Метаданные.Справочники.ПравилаРасчетаСвязанныхОстатковИОборотовБюджетов);
	...
	Элементы.ОткрытьПравилаРасчетаОстатковИОборотов.Видимость     = ПравоДоступаПравилаРасчетаОстатковИОборотовБюджетов;
	...
	ЕстьДанныеДляОтображенияБюджетирование = ИспользоватьБюджетирование
		И (ПравоДоступаМоделиБюджетирования
			...
			Или ПравоДоступаПравилаРасчетаОстатковИОборотовБюджетов
