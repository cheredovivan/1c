...
Процедура СформироватьОтчет()
	...
	Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки") Тогда
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(ТипОснованияАктаОРасхождении) Тогда
			...
			ТекстЗапроса = ТекстЗапросаАктОРасхожденияхПослеОтгрузкиТоваровКлиенту();
...
Процедура ЗаполнитьТаблицыСозданныхДокументов(РезультатЗапроса, ТипОснованияАктаОРасхождении, СоответствиеНаборовДанных)
	...
	Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки") Тогда
		...
		Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
			...
			ОснованияСписанияТоваровОтгруженныхКлиенту.Загрузить(РезультатЗапроса[8].Выгрузить());
			РеализацииКорректировкиВернутьВПуть.Загрузить(РезультатЗапроса[9].Выгрузить());
			ОтгрузкиТоваровКлиентуПоПереходуПраваСобственности2_5.Загрузить(РезультатЗапроса[10].Выгрузить());
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(ТипОснованияАктаОРасхождении) Тогда
			ОтгрузкиТоваровКлиентуПоступленияТоваровОтКлиента.Загрузить(РезультатЗапроса[2].Выгрузить());
...
Функция ТекстЗапросаАктОРасхожденияхПослеРеализации()
	...
	|	И АктОРасхожденияхПослеОтгрузкиТовары.Действие В (
	|	                                      ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ДопоставкаНеТребуется),
	|	                                      ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписание)
	|		) 
...
&НаСервере
Функция ТекстЗапросаАктОРасхожденияхПослеОтгрузкиТоваровКлиенту()
	...
	|	Документ.ОснованиеАктаОРасхождениях КАК ОтгрузкаТоваровКлиенту
	|ИЗ
	|	Действия КАК Действия
...
Процедура ВывестиСтрокиДействийПоАктуПослеОтгрузки(СтрокаДействия, Макет, ТипОснованияАктаОРасхождении)
	...
	Если СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ИсправлениеПервичныхДокументов Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УменьшитьПереходПраваСобственности) <>
				Неопределено Тогда
			
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
			
				// Актуально для двухходовой продажи, ХО = Переход права собственности
				// +Выводим накладную, которую надо уменьшить. (КнопкаИзменений).
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				Если ЭтоПереходПраваСобственности Тогда
					...
					Описание.Вставить("ВариантДействия",
						Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного);
					Описание.Вставить("СпособОтражения",
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УвеличитьПереходПраваСобственности) <>
				Неопределено Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходование) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				Описание.Вставить("ИмяКоманды", "Изменить");
				Описание.Вставить("ВариантДействия",
					Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходование);
				Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходованиеВозврат) <>
				Неопределено Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписание) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				Описание.Вставить("ИмяКоманды", "Изменить");
				Описание.Вставить("ВариантДействия",
					Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписание);
				Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписаниеДопоставка) <>
				Неопределено Тогда
	...
	ИначеЕсли СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УменьшитьПереходПраваСобственности) <> Неопределено Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.УвеличитьПереходПраваСобственности) <> Неопределено Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного) <> Неопределено Тогда
			...
			ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(ТипОснованияАктаОРасхождении) Тогда
				...
				ВывестиИсправлениеОтгрузкаТоваровКлиенту(СтрокаДействия.Основание,
					Макет, Описание, ИспользоватьИсправлениеДокументов);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				Описание.Вставить("АктОРасхождениях", АктОРасхождениях);
				Описание.Вставить("ИмяКоманды", "Оформить");
				Описание.Вставить("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходование);
				Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				Описание.Вставить("АктОРасхождениях", АктОРасхождениях);
				Описание.Вставить("ИмяКоманды", "Оформить");
				Описание.Вставить("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяОприходованиеВозврат);
				Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				Описание.Вставить("АктОРасхождениях", АктОРасхождениях);
				Описание.Вставить("ИмяКоманды", "Оформить");
				Описание.Вставить("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписание);
				Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				Описание.Вставить("АктОРасхождениях", АктОРасхождениях);
				Описание.Вставить("ИмяКоманды", "Оформить");
				Описание.Вставить("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяСписаниеДопоставка);
				Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
...
Процедура ВывестиДокументПоступлениеТоваровОтКлиента(СтрокаДействия, Макет, Описание)
	...
	Если НеВыводитьВОтчет("ДокументПоступлениеТоваровОтКлиента", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	
	МассивОформленныхДокументов = Новый Массив;

	ОформленныеДокументы = ОтгрузкиТоваровКлиентуПоступленияТоваровОтКлиента.НайтиСтроки(
		Новый Структура("ОтгрузкаТоваровКлиенту", СтрокаДействия.Основание));
	
	Если ОформленныеДокументы.Количество() = 0 Тогда
		
		МассивОформленныхДокументов.Добавить(Документы.ПоступлениеТоваровОтКлиента.ПустаяСсылка());
	...
	ВывестиДокументКОформлению(
		"ДокументПоступлениеТоваровОтКлиента",
		2,
		Макет,
		МассивОформленныхДокументов,,,
		Описание);
	...
	Если Описание <> Неопределено Тогда
		...
		ИначеЕсли Описание.ИмяКоманды = "ОжидатьОформлениеПриобретения" Тогда
			...
			ТекстГиперссылки = НСтр("ru = 'Предварительно необходимо оформить приобретение.';
									|en = 'First register the purchase.'");
...
Функция ТекстШапки(ТипДокумента, Описание , ХозяйственнаяОперация = Неопределено)
	...
	ИначеЕсли ТипДокумента = "КорректировкаРеализацииВернутьВПуть" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Корректировка реализации"" для возврата ""в путь""';
							|en = 'The ""Sales adjustment"" document for return ""in transit""'");
	...
	ИначеЕсли ТипДокумента = "ИзменениеОтгрузкаТоваровКлиенту" Тогда 
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Отгрузка товаров клиенту""';
							|en = 'Record discrepancies in the ""Goods shipment to customer"" document'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровКлиенту" Тогда 
		ТекстШапки = НСтр("ru = 'Документ ""Отгрузка товаров клиенту (исправление)""';
							|en = 'The ""Goods shipment to customer (correction)"" document'");
	ИначеЕсли ТипДокумента = "ДопоставкаОтгрузкаТоваровКлиенту" Тогда 
		ТекстШапки = НСтр("ru = 'Документ ""Отгрузка товаров клиенту"" для отгрузки недопоставленного товара';
							|en = 'The ""Goods shipment to customer"" document to ship underdelivered goods'");
	ИначеЕсли ТипДокумента = "ОприходованиеИзлишковОтгруженныхТоваров" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Оприходование излишков отгруженных товаров"" для оприходования ""в путь""';
							|en = 'The ""Stock surplus of shipped goods"" document for receipt ""in transit""'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуБезДопоставки" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Списание товаров, отгруженных клиенту"" (списанные товары не отгружать) для списания ""из пути""';
							|en = 'The ""Write-off of goods shipped to customer"" document (do not ship written off goods) for write-off ""from transit""'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуИДопоставка" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Списание товаров, отгруженных клиенту"" (списанные товары отгрузить вновь) для списания ""из пути""';
							|en = 'The ""Write-off of goods shipped to customer"" document (ship written off goods again) for write-off ""from transit""'");
	...
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтХранителяДовозврат" Тогда
		...
		Если ХозяйственнаяОперацияАкта = Перечисления.ХозяйственныеОперации.ПоступлениеОтПереработчика2_5 Тогда
			ТекстШапки = СтрШаблон(НСтр("ru = 'Документ ""%1"" для поступления недопоставленного товара';
										|en = 'The ""%1"" document to receive undelivered goods'"), Обработчик.СинонимЗаказа());
		КонецЕсли;
		//-- НЕ УТ
	...
	ИначеЕсли ТипДокумента = "ДокументВозврата" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "ДокументПоступлениеТоваровОтКлиента" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Поступление товаров от клиента"" по перепоставленным товарам к возврату';
							|en = 'The ""Goods receipt from customer"" document for overdelivered goods to return'");
...
Функция ТекстЛегенды(ТипДокумента, ХозяйственнаяОперация = Неопределено)
	...
	Если ТипДокумента = "КорректировкаРеализации" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "КорректировкаРеализацииВернутьВПуть" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Корректировка реализации"" по излишкам, отмеченным к возврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Переоформить все документы и вернуть"" и ""Отнести на доходы и вернуть"".';
					|en = 'Register the ""Sales adjustment"" document for surplus marked for return by the customer. It is registered for discrepancy report lines with processing options: ""Re-register all documents and return"" and ""Recognize as income and return"".'");
	ИначеЕсли ТипДокумента = "КорректировкаПриобретения" Тогда
	...
	ИначеЕсли ТипДокумента = "ИсправлениеРеализации" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Реализация товаров и услуг"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"", ""Переоформить переход права собственности"", ""Переоформить все документы"", ""Переоформить все документы и вернуть"", ""Переоформить все документы и допоставить"".';
					|en = 'Correct the ""Customer invoice"" document by recording an actual quantity in it. Make the changes to discrepancy report lines with the ""Invoice the surplus and create Goods return"", ""Invoice the surplus"", ""Register and supply additionally"", ""Re-register transfer of title to goods"", ""Re-register all documents"", ""Re-register all documents and return"", and ""Re-register all documents and supply additionally"" tolling options.'");
	ИначеЕсли ТипДокумента = "ИзменениеОтгрузкаТоваровКлиенту" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Отгрузка товаров клиенту"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Переоформить отгрузку товаров клиенту и вернуть"", ""Переоформить отгрузку товаров клиенту"", ""Переоформить отгрузку товаров клиенту и допоставить"".';
					|en = 'Correct the ""Goods shipment to customer"" document by recording an actual quantity in it. Make the changes to discrepancy report lines with processing options: ""Re-register goods shipment to customer and return"", ""Re-register goods shipment to customer"", and ""Re-register goods shipment to customer and supply additionally"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровКлиенту" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Отгрузка товаров клиенту (исправление)"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Переоформить отгрузку товаров клиенту и вернуть"", ""Переоформить отгрузку товаров клиенту"", ""Переоформить отгрузку товаров клиенту и допоставить"".';
					|en = 'Register the ""Goods shipment to customer (correction)"" document by recording an actual quantity in it. Make the changes to discrepancy report lines with processing options: ""Re-register goods shipment to customer and return"", ""Re-register goods shipment to customer"", and ""Re-register goods shipment to customer and supply additionally"".'");
	ИначеЕсли ТипДокумента = "ДопоставкаОтгрузкаТоваровКлиенту" Тогда 
		Возврат НСтр("ru = 'Необходимо оформить документ ""Отгрузка товаров клиенту"" по недостачам, отмеченным к допоставке клиенту. Оформляется на строки акта о расхождениях с вариантом отработки ""Переоформить отгрузку товаров клиенту и допоставить"", ""Переоформить все документы и допоставить"".';
					|en = 'Register the ""Goods shipment to customer"" document for shortages marked for subsequent delivery to the customer. It is registered in discrepancy report lines with the ""Re-register goods shipment to customer and supply additionally"" and ""Re-register all documents and supply additionally"" processing option.'");
	ИначеЕсли ТипДокумента = "ОприходованиеИзлишковОтгруженныхТоваров" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Оприходование излишков отгруженных товаров"" по излишкам, отмеченным к оприходованию ""в путь"". Оформляется на строки акта о расхождениях с вариантом отработки ""Отнести на доходы"", ""Отнести на доходы и вернуть"".';
					|en = 'Register the ""Stock surplus of shipped goods"" document for surpluses marked to receive ""in transit"". It is registered in discrepancy report lines with the ""Recognize as income"" and ""Recognize as income and create Goods return"" processing option.'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуБезДопоставки" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Списание товаров, отгруженных клиенту"" по недостачам, отмеченным к списанию ""из пути"". Оформляется на строки акта о расхождениях с вариантом отработки ""Списать за наш счет"".';
					|en = 'Register the ""Write-off of goods shipped to customer"" document for shortages marked to be written off ""from transit"". It is registered in discrepancy report lines with the ""Write off at our expense"" processing option.'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуИДопоставка" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Списание товаров, отгруженных клиенту"" по недостачам, отмеченным к списанию ""из пути"". Оформляется на строки акта о расхождениях с вариантом отработки ""Списать за наш счет и допоставить"".';
					|en = 'Register the ""Write-off of goods shipped to customer"" document for shortages marked to be written off ""from transit"". It is registered in discrepancy report lines with the ""Write off at our expense and supply additionally"" processing option.'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровПоставщику" Тогда
	...
	ИначеЕсли ТипДокумента = "ДокументВозврата" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "ДокументПоступлениеТоваровОтКлиента" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Поступление товаров от клиента"" по излишкам, отмеченным к возврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Переоформить отгрузку товаров клиенту и вернуть"", ""Отнести на доходы и вернуть"".';
					|en = 'Register the ""Goods receipt from customer"" document for surplus marked for return by the customer. It is registered for discrepancy report lines with the ""Re-register goods shipment to customer and return"" and ""Recognize as income and create Goods return"" processing option.'");
	ИначеЕсли ТипДокумента = "ДокументВозвратаПередачи" Тогда
		Если ИспользоватьЗаявкиНаВозврат
		   //++ НЕ УТ
		   И ХозяйственнаяОперацияАкта <> Перечисления.ХозяйственныеОперации.ПередачаПереработчику2_5
