...
Функция ОписаниеПараметровОперации(Операция) Экспорт
	...
	//++ НЕ УТ
	ИначеЕсли Операция = Справочники.ОперацииЗакрытияМесяца.НачислениеАмортизацииОС Тогда
		
		ОписаниеПараметров = РасчетАмортизацииОС.ОписаниеПараметровОперацииЗакрытияМесяца();
		
	ИначеЕсли Операция = Справочники.ОперацииЗакрытияМесяца.НачислениеАмортизацииНМА Тогда
		
		ОписаниеПараметров = РасчетАмортизацииНМА.ОписаниеПараметровОперацииЗакрытияМесяца();
		
	ИначеЕсли Операция = Справочники.ОперацииЗакрытияМесяца.РасчетСтоимостиВнеоборотныхАктивов Тогда
		
		ОписаниеПараметров = РасчетСтоимостиВНА.ОписаниеПараметровОперацииЗакрытияМесяца();
		
	ИначеЕсли Операция = Справочники.ОперацииЗакрытияМесяца.ФормированиеДвиженийПоВнеоборотнымАктивам Тогда
	...
	ИначеЕсли Операция = Справочники.ОперацииЗакрытияМесяца.ЗакрытиеРасходовОтВыбытияОС Тогда
		...
		ОписаниеПараметров = ЗакрытиеРасходовОтВыбытияОС.ОписаниеПараметровОперацииЗакрытияМесяца();
...
Функция ОписаниеСинхронизируемыхПараметровОпераций() Экспорт
	...
	ОписаниеПараметров.Операции.Добавить(Справочники.ОперацииЗакрытияМесяца.НачислениеАмортизацииОС);
	ОписаниеПараметров.Операции.Добавить(Справочники.ОперацииЗакрытияМесяца.НачислениеАмортизацииНМА);
	//-- НЕ УТ
