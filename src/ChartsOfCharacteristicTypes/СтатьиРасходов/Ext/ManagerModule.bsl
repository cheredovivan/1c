...
Функция СписокДокументовДляСтатейРаспределяемыхНаПродажу()
	...
	СписокВозврата.Добавить(Метаданные.Документы.ЗаказДавальца,, ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоИзДавальческогоСырья"));
	//-- Устарело_Переработка24
	СписокВозврата.Добавить(Метаданные.Документы.ЗаказДавальца2_5,, ПолучитьФункциональнуюОпцию("ИспользоватьЗаказыДавальцев2_5"));
	//-- НЕ УТКА
