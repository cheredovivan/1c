...
Процедура СоздатьЗадания(МенеджерРегистра, ВидыЗаданий, НаборЗаписей, МенеджерВременныхТаблиц = Неопределено,
	...
	РеглУчетПроведениеСервер.ВернутьДокументыКОтражению(ТаблицаДокументовКОтражению);

КонецПроцедуры

// Таблица документов к отражению документов в регламентированном учете.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - Таблица документов к отражению в регламентированном учете:
// * Документ - ДокументСсылка - Документ к отражению
// * Организация - СправочникСсылка.Организации - Организация
// * ДатаОтражения - Дата - Дата отражения
//
Функция ТаблицаДокументовКОтражениюВРегламентированномУчете() Экспорт
