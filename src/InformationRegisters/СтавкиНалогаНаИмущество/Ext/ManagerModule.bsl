...
Функция ОписаниеДействующихПараметров(Организация, ДатаДействия = Неопределено, ДействующиеНастройки = Неопределено, Все = Ложь) Экспорт
	...
	Если ДействующиеНастройки.ОсвобождениеОтНалогообложения Или Все Тогда
	...
	Если ДействующиеНастройки.ОсвобождениеОтНалогообложенияДвижимогоИмущества Или Все Тогда
		СтрокаОписанияНастроек = СтрокаОписанияНастроек
			+ СтрШаблон(СтрокаШаблонБулево,
	...
	Если ДействующиеНастройки.УменьшениеСуммыНалогаВПроцентах Или Все Тогда
		СтрокаОписанияНастроек = СтрокаОписанияНастроек + СтрШаблон(СтрокаШаблон, 
