...
Функция ДанныеОперацииРасписания(КлючОперации, НомерПартии, РабочийЦентр) Экспорт
	...
	|	ПО Расписание.Этап = Техпроцесс.Этап
	|
	|ГДЕ
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,
		"&ПараметрыТехпроцесса",
		РедакторПроизводственногоПроцесса.ТекстЗапросаПараметрыТехпроцессаЭтапа("Расписание.Этап"));
...
Функция ОкружениеОперацииВРасписании(КлючОперации)
	...
	|	ТекущаяОперация.ПроизводственнаяОперация КАК ПроизводственнаяОперация,
	...
	|	ТекущаяОперация.Запланировано - ТекущаяОперация.ТребуетПовторения КАК Запланировано,
	...
	|	СледующиеОперации.ПроизводственнаяОперация КАК ПроизводственнаяОперация,
	...
	|	СледующиеОперации.Запланировано - СледующиеОперации.ТребуетПовторения КАК Запланировано,
	|	СледующиеОперации.ВремяЕдИзм КАК ВремяВыполненияЕдИзм
	|ПОМЕСТИТЬ ВТСледующиеОперации
	|ИЗ
	|	ВТОчередь КАК СледующиеОперации
	|ГДЕ
	|	СледующиеОперации.НомерОперации В
	|			(ВЫБРАТЬ
	...
	|	ПредыдущиеОперации.ПроизводственнаяОперация,
	...
	|	ПредыдущиеОперации.Запланировано - ПредыдущиеОперации.ТребуетПовторения,
	|	ПредыдущиеОперации.ВремяЕдИзм
	|ИЗ
	|	ВТОчередь КАК ПредыдущиеОперации
	|ГДЕ
	|	ПредыдущиеОперации.НомерСледующейОперации В
	|			(ВЫБРАТЬ
	...
	|	ТекущаяОперация.ПроизводственнаяОперация,
