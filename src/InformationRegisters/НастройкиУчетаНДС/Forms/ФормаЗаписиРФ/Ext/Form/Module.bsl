...
Процедура УстановитьСвойстваЭлементов(Форма)
	...
	Элементы.УчетНДСДлительногоЦиклаПроизводства.Доступность = НЕ ПрименяетсяЛьготноеНалогообложениеНДСнаУСН
		И Запись.РаздельныйУчетПостатейныхПроизводственныхЗатратПоНалогообложениюНДС;
	//-- НЕ УТ
