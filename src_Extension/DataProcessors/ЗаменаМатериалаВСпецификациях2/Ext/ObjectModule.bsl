Функция СведенияОВнешнейОбработке() Экспорт
	...
	РегистрационныеДанные.Вставить("Наименование", "Замена материала в спецификациях");
	...
	РегистрационныеДанные.Вставить("Информация", "Замена материала в спецификациях");
    ...
    строкаКоманды.Идентификатор = "ЗаменаМатериалаВСпецификациях1";
    строкаКоманды.Представление = "Замена материала в спецификациях";
