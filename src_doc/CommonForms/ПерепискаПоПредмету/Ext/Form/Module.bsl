...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ДокументИзменен" Тогда
		Если ДелопроизводствоКлиентСервер.ЭтоИсходящийДокумент(Параметр) 
		 Или ДелопроизводствоКлиентСервер.ЭтоВходящийДокумент(Параметр) Тогда 
			
			ПредметПереписки = СвязиОбъектов.ПолучитьСвязанныйОбъект(Параметр, "ПредметПереписки");
