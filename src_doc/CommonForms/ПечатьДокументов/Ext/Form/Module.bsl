...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;
	Элементы.КнопкаСохранитьВПрисоединенныеФайлы.Видимость = СохранениеВПрисоединенныеФайлы;
...
&НаКлиенте
Процедура ТекущаяПечатнаяФормаОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка, ДополнительныеПараметры)
	
	Если УправлениеПечатьюКлиентДокументооборот.ОбработанаРасшифровкаПечатнойФормы(
		ЭтотОбъект, Элемент, Расшифровка, СтандартнаяОбработка, ДополнительныеПараметры) Тогда
