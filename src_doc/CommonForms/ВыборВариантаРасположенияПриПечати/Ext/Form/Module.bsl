...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Параметры.Свойство("ЗаголовокФормы") И ЗначениеЗаполнено(Параметры.ЗаголовокФормы) Тогда
		Заголовок = Параметры.ЗаголовокФормы;
	Иначе
		Если ИспользоватьШтрихкоды Тогда
			Заголовок = НСтр("ru = 'Расположение штрихкода'");
		Иначе
			Заголовок = НСтр("ru = 'Расположение рег. номера'");
		КонецЕсли;	
	КонецЕсли;
	...
	Иначе 
		ПоГоризонтали = "MIN";
		ПоВертикали = "MIN";
		ПоложениеШтрихкода = Перечисления.МестаВставкиКартинки.ЛевыйВерхний;
	КонецЕсли;
