...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаСертификатовИПрограммПриСозданииНаСервере(ЭтотОбъект);
...
Процедура ПрограммыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ФормаСертификатовИПрограммПриВыбореПрограммы(
		ЭтотОбъект, Поле, СтандартнаяОбработка);
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаСертификатовИПрограммПриУстановкеУсловногоОформления(ЭтотОбъект);
...
Процедура ЗаполнитьПрограммыИНастройки(ОбновитьПовтИсп = Ложь)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаСертификатовИПрограммПриЗаполненииПрограммИНастроек(ЭтотОбъект);
...
Процедура СохранитьНастройки()
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ФормаСертификатовИПрограммПередСохранениемНастроек(
		ЭтотОбъект, СохраняемыеНастройки);
...
#Область ОбработчикиСобытийДО

&НаКлиенте
Процедура Подключаемый_ПриИзмененииДО(Элемент)
	
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьСобытиеПриИзменении(ЭтотОбъект, Элемент);
