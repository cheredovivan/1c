...
&НаКлиенте
Процедура АдминистраторИБАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
Функция ПодобратьПользователя(Текст)
	...
	Возврат ПользователиДокументооборот.СформироватьДанныеВыбора(Текст);
