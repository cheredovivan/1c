...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Элементы.РасширенныйПоиск.Заголовок = ?(Объект.РасширенныйПоиск,
		НСтр("ru = 'Скрыть расширенный поиск'"),
		НСтр("ru = 'Расширенный поиск'"));
	
	Элементы.ГруппаРасширенныйПоиск.Видимость = Объект.РасширенныйПоиск;
	Если ПараметрыСеанса.ЭтоМобильныйКлиент Тогда
		Элементы.ДекорацияВнизМК.Видимость = Объект.РасширенныйПоиск;
		Элементы.ДекорацияВверхМК.Видимость = Не Объект.РасширенныйПоиск;
	КонецЕсли;
...
Процедура НайтиНаКлиенте(Направление)
	...
	#Если МобильныйКлиент Тогда
		МК_КлиентСервер.АдаптироватьHtmlПодЭкранМобильногоПриНеобходимости(HTMLТекст);
	#КонецЕсли
...
Процедура HTMLТекстПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	...
	ИначеЕсли ЭлементHTML.id = "PrevSearch" Тогда
...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.РасширенныйПоиск.РастягиватьПоГоризонтали = Истина;
	Элементы.СтрокаПоиска.ПодсказкаВвода = НСтр("ru = 'Строка поиска'");
	Элементы.HTMLТекст.Ширина = 1;
	Элементы.HTMLТекст.РастягиватьПоГоризонтали = Истина;
	МК_КлиентСервер.АдаптироватьHtmlПодЭкранМобильногоПриНеобходимости(HTMLТекст);
	Элементы.ПоказаныРезультаты_С_По.РастягиватьПоГоризонтали = Истина;	
	Элементы.ДекорацияОтступВариантовПоискаСлов.Видимость = Ложь;
	Элементы.ИскатьСочетанияСлов.ВидПереключателя = ВидПереключателя.Переключатель;
	Элементы.ДекорацияОтступРасширенногоПоиска.Видимость = Ложь;
