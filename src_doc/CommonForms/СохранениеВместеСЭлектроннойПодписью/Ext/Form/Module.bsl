...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаСохраненияВместеСЭППриСозданииНаСервере(ЭтотОбъект);
...
Процедура СохранитьПодпись(Команда)
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ФормаСохраненияСЭППередСохранениемПодписей(ЭтотОбъект);
