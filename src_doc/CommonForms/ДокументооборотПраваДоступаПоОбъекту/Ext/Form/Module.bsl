...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СтраницаДескрипторы.Видимость = ЭтоПолноправныйПользователь;
	Если Не ЭтоПолноправныйПользователь Тогда
		Элементы.Страницы.ОтображениеСтраниц = ОтображениеСтраницФормы.Нет;
	КонецЕсли;
	
	ТипВсеПапки = Метаданные.ОпределяемыеТипы.Папки.Тип;
	Элементы.ПраваДоступаУправлениеПравами.Видимость = ТипВсеПапки.СодержитТип(ТипЗнч(ОбъектДоступа));
	
	Дескрипторы.Параметры.УстановитьЗначениеПараметра("ОбъектДоступа", ОбъектДоступа);
	СписокРабочаяГруппа.Параметры.УстановитьЗначениеПараметра("ОбъектДоступа", ОбъектДоступа);
...
Процедура ОбновитьСервер()
	...
	Если Элементы.СтраницаРабочаяГруппа.Видимость Тогда
		Элементы.СписокРабочаяГруппа.Обновить();
	КонецЕсли;
...
Процедура ЗаполнитьТаблицуПрав()
	...
	ТаблицаПрав = ДокументооборотПраваДоступа.ПолучитьТаблицуПравДляОтображенияВИнтерфейсе(
		ОбъектДоступа);
...
Процедура ПротоколРасчетаПравВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли ТекущиеДанные.Элемент = "Делегаты" Тогда
		...
		ОткрытьФорму("Справочник.ЗамещающиеИПомощники.ФормаСписка");
		
	ИначеЕсли ТекущиеДанные.Элемент = "ЛокальныеАдминистраторы" Тогда
...
&НаКлиенте
Процедура СписокРабочаяГруппаВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ПоказатьЗначение(, Элемент.ТекущиеДанные.Участник);
