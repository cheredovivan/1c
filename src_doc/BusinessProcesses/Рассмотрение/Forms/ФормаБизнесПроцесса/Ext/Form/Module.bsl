...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОбрабатывающийРезолюцию.Видимость = ЗначениеЗаполнено(Объект.ОбрабатывающийРезолюцию);
...
#Область СрокИсполненияПредставление
...
#Область СрокОбработкиРезультатовПредставление
...
Процедура СрокОбработкиРезультатовПредставлениеПриИзменении(Элемент)
	...
	ДопПараметры.Исполнитель = Объект.ОбрабатывающийРезолюцию;
...
Процедура СрокОбработкиРезультатовПредставлениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыВыбораСрока.Участник = Объект.ОбрабатывающийРезолюцию;
...
#Область ТрудозатратыУчастниковПроцесса
...
Процедура ОписаниеТрудозатратНажатие(Элемент, СтандартнаяОбработка)
	...
	ТрудозатратыПомощника = РаботаСБизнесПроцессамиКлиент.
		СтруктураСтрокиТрудозатратУчастникаПроцесса(
			НСтр("ru = 'Обрабатывающий резолюцию'"),
			"ТрудозатратыПланПомощника",
			Объект.ТрудозатратыПланПомощника,
			Объект.ОбрабатывающийРезолюцию);
	Настройки.Участники.Добавить(ТрудозатратыПомощника);
...
&НаКлиенте
Процедура ОбрабатывающийРезолюциюОбработкаВыбора(Элемент, ВыбранноеЗначение, ДополнительныеДанные, СтандартнаяОбработка)
	
	СотрудникиКлиент.СотрудникОбработкаВыбора(Объект, "ОбрабатывающийРезолюцию", ВыбранноеЗначение, СтандартнаяОбработка);
...
Процедура ЗаполнитьОписаниеТрудозатрат(Форма)
	...
	ПараметрыОписания.Вставить("ОбрабатывающийРезолюцию", Истина);
