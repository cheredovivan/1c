...
#Если МобильныйКлиент Тогда
	...
	МК_АдаптацияИнтерфейсаКлиент.ОформитьНадписьДляСкрытияТаблицы(
		Элементы.Исполнители, ЭтотОбъект.Объект.Исполнители, Элементы[ИмяДекорацияДляСкрытияТаблицыИсполнителей]);
#КонецЕсли
...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.Шаг.Ширина = 0;
	Элементы.Исполнитель.Ширина = 0;
	Элементы.ПорядокСогласования.Ширина = 0;
	Элементы.ИсполнителиСрокИсполненияПредставление.Ширина = 0;
	
	// Переместим команды ТЧ Исполнители
	Элементы.Переместить(Элементы.Подобрать,
		Элементы.Исполнители.КоманднаяПанель, Элементы.ИсполнителиКонтекстноеМеню);
	
	Элементы.Переместить(Элементы.ПереместитьВверх,
		Элементы.Исполнители.КоманднаяПанель, Элементы.ИсполнителиКонтекстноеМеню);
	
	Элементы.Переместить(Элементы.ПереместитьВниз,
		Элементы.Исполнители.КоманднаяПанель, Элементы.ИсполнителиКонтекстноеМеню);
	Элементы.ВывестиСписок.Видимость = Ложь;
	Элементы.ОбрабатывающийРезультат.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
