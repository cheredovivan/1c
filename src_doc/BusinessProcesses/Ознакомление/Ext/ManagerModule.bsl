...
Функция ИдентификаторыТекущихУчастниковПроцесса(Процесс) Экспорт
	...
	РеквизитыПроцессаСтрокой = "Исполнители";
...
Функция ВыборкаДанныхДействий(ТаблицаДействий) Экспорт
	...
	Запрос.Текст = 
		...
		|		ПО ТаблицаДействий.Действие = Ознакомление.Ссылка";
...
Функция ЛистОзнакомления(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Запрос.Текст =
		...
		|	ИсполнителиОзнакомления.РольИсполнителя КАК РольИсполнителя,
		|	Сотрудники.Должность.Представление КАК Должность
		|ИЗ
		|	ИсполнителиОзнакомления КАК ИсполнителиОзнакомления
		|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Сотрудники КАК Сотрудники
		|		ПО ИсполнителиОзнакомления.Исполнитель = Сотрудники.Ссылка
		|ИТОГИ ПО
		|	Ссылка";
