...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.Переместить(Элементы.Помещение, Элементы.МК_ПомещениеСотрудник);
	Элементы.Переместить(Элементы.Сотрудник, Элементы.МК_ПомещениеСотрудник);
	Элементы.Переместить(Элементы.ГруппаПериодСтрокой, Элементы.МК_Период);
	
	Элементы.Сотрудник.ЦветТекста = ЦветаСтиля.МК_ЦветАвтораИсполнителя;
	Элементы.Сотрудник.Шрифт = ШрифтыСтиля.МК_ШрифтАвтораИсполнителя;
