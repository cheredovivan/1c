...
Функция НоваяСтруктураСведенийОбАдресате()
	...
	СтруктураВозврата.Вставить("Адресат",
		ПредопределенноеЗначение("Справочник.АдресатыПочтовыхСообщений.ПустаяСсылка"));
	СтруктураВозврата.Вставить("ВидМаршрутизации",
		ПредопределенноеЗначение("Перечисление.ВидыМаршрутизацииПисем.Внешняя"));
