...
&НаСервере
Функция НовоеОбсуждение(Знач ПользовательИлиСотрудник)
	...
	Если ТипЗнч(ПользовательИлиСотрудник) = Тип("СправочникСсылка.Пользователи") Тогда
		ИдентификаторПользователяИнформационнойБазы = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
			ПользовательИлиСотрудник, "ИдентификаторПользователяИБ");
	ИначеЕсли ТипЗнч(ПользовательИлиСотрудник) = Тип("СправочникСсылка.Сотрудники") Тогда
		ПользовательСотрудника = Сотрудники.ПользовательСотрудника(ПользовательИлиСотрудник);
		ИдентификаторПользователяИнформационнойБазы = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
