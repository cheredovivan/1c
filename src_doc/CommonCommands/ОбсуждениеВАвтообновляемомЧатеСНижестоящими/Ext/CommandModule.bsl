...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Обсуждение = АвтообновляемоеОбсуждение(ПараметрКоманды);
...
&НаСервере
Функция АвтообновляемоеОбсуждение(Знач КонтейнерСсылка)
	...
	Обсуждение = ОбсужденияДокументооборот.НавигационнаяСсылкаОбсужденияПоКонтейнеру(КонтейнерСсылка, Истина);
	Возврат Обсуждение;
