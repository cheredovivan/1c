...
Процедура СохранитьПараметрыПодключенияСканера(ТипОС, ВыбранныеПараметры)
	...
	Если ТипОС = "Windows" Тогда
		...
		ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ТекущиеНастройкиСканераWindows",,Параметры);
		
	ИначеЕсли ТипОС = "Linux" Тогда
	
		ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ТекущиеНастройкиСканераLinux",,Параметры);
