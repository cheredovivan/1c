...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если ПравоДоступа("Чтение", Метаданные.Справочники.Мероприятия) Тогда 
		...
		НаборДанных.Запрос = 
			...
			|		КОГДА ТИПЗНАЧЕНИЯ(СправочникМероприятия.Председатель) = ТИП(Справочник.Сотрудники)
			|				И СправочникМероприятия.Председатель <> ЗНАЧЕНИЕ(Справочник.Сотрудники.ПустаяСсылка)
			|			ТОГДА СправочникМероприятия.Председатель
			...
			|		КОГДА ТИПЗНАЧЕНИЯ(СправочникМероприятия.Секретарь) = ТИП(Справочник.Сотрудники)
			|				И СправочникМероприятия.Секретарь <> ЗНАЧЕНИЕ(Справочник.Сотрудники.ПустаяСсылка)
			|			ТОГДА СправочникМероприятия.Секретарь
			...
			|		КОГДА ТИПЗНАЧЕНИЯ(СправочникМероприятия.Организатор) = ТИП(Справочник.Сотрудники)
			|				И СправочникМероприятия.Организатор <> ЗНАЧЕНИЕ(Справочник.Сотрудники.ПустаяСсылка)
			|			ТОГДА СправочникМероприятия.Организатор
			|		КОГДА ТИПЗНАЧЕНИЯ(СправочникМероприятия.Куратор) = ТИП(Справочник.Пользователи)
			|				И СправочникМероприятия.Куратор <> ЗНАЧЕНИЕ(Справочник.Пользователи.ПустаяСсылка)
			|			ТОГДА СправочникМероприятия.Куратор
			|		КОГДА ТИПЗНАЧЕНИЯ(СправочникМероприятия.Куратор) = ТИП(Справочник.Сотрудники)
			|				И СправочникМероприятия.Куратор <> ЗНАЧЕНИЕ(Справочник.Сотрудники.ПустаяСсылка)
			|			ТОГДА СправочникМероприятия.Куратор
