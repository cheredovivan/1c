...
Функция ДанныеШаблона(ТипПроцесса) Экспорт
	...
	ИначеЕсли ТипПроцесса = Подписание Тогда
		ДанныеШаблона.ИмяСправочника = "ШаблоныПодписания";
		ДанныеШаблона.Тип = Тип("СправочникСсылка.ШаблоныПодписания");
		ДанныеШаблона.ПустаяСсылка = Справочники.ШаблоныПодписания.ПустаяСсылка();
...
Функция ТочкиМаршрутаПоТипуПроцесса(ТипПроцесса, ПоУмолчанию) Экспорт
	...
	ИначеЕсли ТипПроцесса = Утверждение Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипПроцесса = Подписание Тогда
		ТочкиМаршрута.Добавить(БизнесПроцессы.Подписание.ТочкиМаршрута.Подписать);
		ТочкиМаршрута.Добавить(БизнесПроцессы.Подписание.ТочкиМаршрута.ОбеспечитьПодписание);
		Если Не ПоУмолчанию Тогда
			ТочкиМаршрута.Добавить(БизнесПроцессы.Подписание.ТочкиМаршрута.ОбработатьРезультат);
		КонецЕсли;
	КонецЕсли;
...
Функция ТипыПроцессовОбычные()
	...
	ТипыПроцессов.Добавить(Подписание);
