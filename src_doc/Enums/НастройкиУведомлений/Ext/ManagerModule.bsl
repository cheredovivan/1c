...
Функция ВидСобытия(Настройка) Экспорт
	...
	Если Настройка = ВыполнениеЗадачПоПочте Тогда
		ВидСобытия = Справочники.ВидыБизнесСобытий.НоваяЗадача;
...
Функция СтандартноеЗначениеНастройки(Настройка, ВидСобытия, СпособУведомления) Экспорт
	...
	Если Настройка = Подписка Тогда
		...
		Если СпособУведомления = Перечисления.СпособыУведомления.ПоПочте Тогда
			...
			Если ВидСобытия = Справочники.ВидыБизнесСобытий.НоваяЗадача
				...
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ОтменаБрони
				...
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.НоваяЗадача
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ОтменаЗадачи
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ОткладываниеЗадачи
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ПередачаЗадачОтИсполнителя
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.СнятиеЗадачИсполнителя
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ОтменаВыполненияЗадачи
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ИзменениеЗадачи
				Или ВидСобытия = Перечисления.СобытияУведомлений.СводкаПоЗадачам
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ОстановкаОбработки
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ЗамещающиеИПомощникиСоздание
				Или ВидСобытия = Перечисления.СобытияУведомлений.МероприятияИзменениеПриглашения
				Или ВидСобытия = Перечисления.СобытияУведомлений.МероприятияОтклоненоПриглашение
				Или ВидСобытия = Перечисления.СобытияУведомлений.МероприятияОтменаПриглашения
				Или ВидСобытия = Перечисления.СобытияУведомлений.МероприятияПриглашение
				Или ВидСобытия = Перечисления.СобытияУведомлений.МероприятияПринятоПриглашение
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ЗамещающиеИПомощникиИзменение
				Или ВидСобытия = Перечисления.СобытияУведомлений.ОзнакомлениеСПоложительнымРезультатомДействияОбработки
				Или ВидСобытия = Перечисления.СобытияУведомлений.ОбработкиНаПаузе
				...
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ОшибкаВДокументахПереданныхВАрхив Тогда
				Значение = Истина;
			Иначе
				Значение = Ложь;
			КонецЕсли;
		...
		ИначеЕсли СпособУведомления = Перечисления.СпособыУведомления.Окном Тогда
			...
			Если ВидСобытия = Справочники.ВидыБизнесСобытий.НоваяЗадача
				...
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ПринятиеДокументовВАрхив
				// Локализация
				Или ВидСобытия = Перечисления.СобытияУведомлений.ТаймлистПолучениеРасшифровкиАвтопротокола
				// Локализация Конец
				Или ВидСобытия = Справочники.ВидыБизнесСобытий.ОшибкаВДокументахПереданныхВАрхив Тогда
				Значение = Истина;
			Иначе
	...
	ИначеЕсли Настройка = СрокУведомления Тогда
		...
		Если ВидСобытия = Перечисления.СобытияУведомлений.ПодошелСрокКонтрольнойТочки Тогда
			Значение = 3;
	...
	ИначеЕсли Настройка = ЧастотаУведомления Тогда
		...
		Если ВидСобытия = Перечисления.СобытияУведомлений.ПодошелСрокДействияДокумента
			...
			Значение = 0;
		ИначеЕсли ВидСобытия = Перечисления.СобытияУведомлений.ПросроченаКонтрольнаяТочка
