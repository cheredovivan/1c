...
// Формирует новую структуру параметров учета времени.
// 
// Возвращаемое значение:
//  Структура:
...
//   * ОпцияИспользоватьУчетВремени - Булево
//   * ВидыРабот - СписокЗначений из СправочникСсылка.ВидыРабот
//   * СпособУказанияВремени - ПеречислениеСсылка.СпособыУказанияВремени
//   * ЭлементПереключитьХронометражПометка - Булево
// 
Функция НовыйПараметрыУчетаВремени() Экспорт
	
	ПараметрыУчетаВремени = Новый Структура;
	ПараметрыУчетаВремени.Вставить("ДатаНачалаХронометража", Дата(1, 1, 1));
	ПараметрыУчетаВремени.Вставить("ДатаКонцаХронометража", Дата(1, 1, 1));
	ПараметрыУчетаВремени.Вставить("ВключенХронометраж", Ложь);
	ПараметрыУчетаВремени.Вставить("ОпцияИспользоватьУчетВремени", Ложь);
	ПараметрыУчетаВремени.Вставить("ВидыРабот", Новый СписокЗначений);
	ПараметрыУчетаВремени.Вставить("СпособУказанияВремени",
		ПредопределенноеЗначение("Перечисление.СпособыУказанияВремени.ПустаяСсылка"));
	ПараметрыУчетаВремени.Вставить("ЭлементПереключитьХронометражПометка", Ложь);
