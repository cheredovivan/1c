...
Функция ПолучитьШаблоныДляАвтоЗапуска(ВидИнтерактивногоБизнесСобытия, ВидДокумента, Организация, Документ) Экспорт
	...
	Для Каждого Строка Из Таблица Цикл
		...
		Если ДокументооборотПраваДоступа.ПраваПользователяПоОбъекту(Строка.ШаблонБизнесПроцесса).Чтение Тогда
			// Проверим алгоритм проверки
			Если РаботаСАлгоритмамиПроверки.ПроверитьПрименимостьАлгоритмаПроверкиКОбъекту(Документ, Строка.Условие) Тогда
