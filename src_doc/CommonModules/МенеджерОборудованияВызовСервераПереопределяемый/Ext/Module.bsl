...
// Контроль фискализации безналичных платежей
// Параметры:
//  ФискализацииБезналичныхПлатежей - Булево - Информация о безналичных платежах в Фискальных документах
//  СтандартнаяОбработка - Булево - Выполнение стандартной обработки
//
Процедура КонтрольФискализацииБезналичныхПлатежей(ФискализацииБезналичныхПлатежей, СтандартнаяОбработка) Экспорт
