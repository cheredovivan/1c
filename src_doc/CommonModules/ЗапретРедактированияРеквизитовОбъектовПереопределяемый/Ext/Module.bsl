...
Процедура ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты) Экспорт
	...
	Объекты.Вставить(Метаданные.Справочники.Должности.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.ДолжностиКонтактныхЛиц.ПолноеИмя(), "");
	
	// Локализация
	Объекты.Вставить(Метаданные.Справочники.РазделыОбращений.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.ТематикиОбращений.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.ТемыОбращений.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.ВопросыОбращений.ПолноеИмя(), "");
	// Конец Локализация
