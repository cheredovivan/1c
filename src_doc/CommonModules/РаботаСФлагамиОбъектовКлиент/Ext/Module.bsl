...
//													     будет сопоставлено объекту
//													     для основго сотрудника тек. пользователя.
...
Функция УстановитьФлагиЗадачам(МассивЗадач, Флаг) Экспорт
	...
	Для Каждого Задача Из МассивЗадач Цикл
		...
		ИначеЕсли ТипЗнч(Задача) = Тип("ДокументСсылка.Задача")
			Или ТипЗнч(Задача) = Тип("ДокументСсылка.ДействиеЗадачи") Тогда
			ЗадачиИлиДействия.Добавить(Задача);
		КонецЕсли;
		
	КонецЦикла;
	
	Если МассивЗадачДляОбработки.Количество() = 0 И ЗадачиИлиДействия.Количество() = 0 Тогда
	...
	Если ЗадачиИлиДействия.Количество() > 0 Тогда
		РаботаСЗадачамиКлиент.УстановитьФлаг(ЗадачиИлиДействия, Флаг);
	КонецЕсли;
