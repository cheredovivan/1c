...
Процедура ПередНачаломРаботыСистемы5(Параметры) Экспорт
	...
	Если ПользователиДокументооборотВызовСервера.ТекущийПользовательНеУказан() Тогда
		
		// Если текущий пользователь <Не указан>, то перезагружаем программу,
		// чтобы интерактивная работа выполнялась под не служебным пользователем.
