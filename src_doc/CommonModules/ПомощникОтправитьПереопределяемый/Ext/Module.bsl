...
Процедура ПриЗаполненииДереваВариантовОтправки(Помощник, СтандартнаяОбработка) Экспорт
	...
	ПомощникОтправитьКОРП.ПриЗаполненииДереваВариантовОтправки(Помощник, СтандартнаяОбработка);
...
// Вызывается из ПомощникОтправить.ЗаполнитьДопустимыеТипыПредметовВПроцессах при
// заполнении допустимых типов предметов процесса.
//
// Параметры:
//  Помощник - Структура - см. ПомощникОтправить.Помощник();
//  СтандартнаяОбработка - Булево - при установке Ложь стандартное заполнение предметов
//                                  будет проигнорировано.
//
Процедура ПриЗаполненииДопустимыхТиповПредметовВПроцессах(Помощник, СтандартнаяОбработка) Экспорт
	
	СтандартнаяОбработка = Ложь;
	ПомощникОтправитьКОРП.ЗаполнитьДопустимыеТипыПредметовВПроцессах(Помощник);
...
//
// Параметры:
//  Представление - Строка - представление, которое необходимо заполнить.
