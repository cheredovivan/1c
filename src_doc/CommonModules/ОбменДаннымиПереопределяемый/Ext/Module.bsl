...
Процедура ПриПолученииДоступныхВерсийФормата(ВерсииФормата) Экспорт
	...
	ВерсииФормата.Вставить("1.8", МенеджерОбменаЧерезУниверсальныйФормат_1_8);
	ВерсииФормата.Вставить("1.16", МенеджерОбменаЧерезУниверсальныйФормат_1_16);
	ВерсииФормата.Вставить("1.17", МенеджерОбменаЧерезУниверсальныйФормат_1_17);
