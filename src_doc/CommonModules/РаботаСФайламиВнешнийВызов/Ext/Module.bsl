...
// Создает версию файла в БД (в уже существующем файле) на основе файла на диске (на сервере)
// 
// Параметры:
//  ФайлСсылка - СправочникСсылка.Файлы - файл, в котором создадим новую версию.
//
//  ПутьКФайлуНаДиске  - Строка - полный путь к файлу на диске, включающий имя и расширение файла.
//                       Файл должен находиться на сервере.
//
...
Функция СоздатьВерсиюФайла(
	...
	// новая версия
	ВерсияСсылка = РаботаСФайламиВызовСервера.СоздатьВерсиюИОбновитьВерсиюВФайле(
