...
// 
// Возвращаемое значение:
//  Массив из СправочникСсылка.Сотрудники - Ответственные за учет самочувствия сотрудников.
//
Функция ОтветственныеЗаУчетСамочувствияСотрудников() Экспорт
	
	ОтветственныеЗаУчетСамочувствияСотрудников = Новый Массив;
	Для Каждого Сотрудник Из Сотрудники.ВсеСотрудники() Цикл
	
		Если Не ЭтоОтветственныйЗаУчетСамочувствияСотрудников(Сотрудник) Тогда
			Продолжить;
		КонецЕсли;
		
		ОтветственныеЗаУчетСамочувствияСотрудников.Добавить(Сотрудник);
...
Функция СотрудникиПодлежащиеУчетуСамочувствия(ДатаУчета) Экспорт
	...
	// Исключим удаленных и недействующих сотрудников.
	РеквизитыСотрудников = ОбщегоНазначения.ЗначенияРеквизитовОбъектов(
		СотрудникиПодлежащиеУчетуСамочувствия, "ПометкаУдаления, Действует");
...
// Определяет, что сотрудник является ответственным за учет самочувствия сотрудников.
//
// Параметры:
...
//
Функция ЭтоОтветственныйЗаУчетСамочувствияСотрудников(Сотрудник) Экспорт
