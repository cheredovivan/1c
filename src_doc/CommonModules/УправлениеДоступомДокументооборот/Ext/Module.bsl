////////////////////////////////////////////////////////////////////////////////
// Управление доступом Документооборот (сервер)
//
////////////////////////////////////////////////////////////////////////////////
...
Процедура ЗаполнитьВозможныеПраваДляНастройкиПравОбъектов(ВозможныеПрава) Экспорт
	...
	ЗаполнитьВозможныеПраваДляПапокДокументовПредприятия(ВозможныеПрава);
...
//  ИдентификаторПрофиля - Строка - идентификатор профиля.
// 
Процедура УдалитьРольИзПолномочий(Знач Роль, ИдентификаторПрофиля) Экспорт 
...
Процедура ЗаполнитьВозможныеПраваДляПапокДокументовПредприятия(ВозможныеПрава)

	// Право "Чтение"
	Право = ВозможныеПрава.Добавить();
	Право.ВладелецПрав  = "Справочник.ПапкиДокументов";
	Право.Имя           = "ЧтениеПапокИДокументовПредприятия";
	Право.Синоним       = НСтр("ru = 'Чтение папок и документов предприятия'");
	Право.Сокращение    = НСтр("ru = 'Чтение'");
	
	// Право "Добавление"
	Право = ВозможныеПрава.Добавить();
	Право.ВладелецПрав  = "Справочник.ПапкиДокументов";
	Право.Имя           = "ДобавлениеПапокИДокументовПредприятия";
	Право.Синоним       = НСтр("ru = 'Добавление документов предприятия'");
	Право.Сокращение    = НСтр("ru = 'Добавление
	                                 |документов'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ИзменениеПапокИДокументовПредприятия");
	
	// Право "Изменение"
	Право = ВозможныеПрава.Добавить();
	Право.ВладелецПрав  = "Справочник.ПапкиДокументов";
	Право.Имя           = "ИзменениеПапокИДокументовПредприятия";
	Право.Синоним       = НСтр("ru = 'Изменение документов предприятия'");
	Право.Сокращение    = НСтр("ru = 'Изменение
	                                 |документов'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ЧтениеПапокИДокументовПредприятия");
	
	// Право "Изменение папок"
	Право = ВозможныеПрава.Добавить();
	Право.ВладелецПрав  = "Справочник.ПапкиДокументов";
	Право.Имя           = "ИзменениеПапокДокументовПредприятия";
	Право.Синоним       = НСтр("ru = 'Изменение папок документов предприятия'");
	Право.Сокращение    = НСтр("ru = 'Изменение
	                                 |папок'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ЧтениеПапокИДокументовПредприятия");
	...
	Право = ВозможныеПрава.Добавить();
	Право.ВладелецПрав  = "Справочник.ПапкиДокументов";
	Право.Имя           = "ПометкаУдаленияПапокИДокументовПредприятия";
	Право.Синоним       = НСтр("ru = 'Пометка удаления документов предприятия'");
	Право.Сокращение    = НСтр("ru = 'Пометка
	                                 |удаления'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ИзменениеПапокИДокументовПредприятия");
	...
	Право.ВладелецПрав  = "Справочник.ПапкиДокументов";
	Право.Имя           = "УправлениеПравами";
	Право.Синоним       = НСтр("ru = 'Управление правами папок документов предприятия'");
	Право.Сокращение    = НСтр("ru = 'Управление
	                                 |правами'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ЧтениеПапокИДокументовПредприятия");
