...
// Вызывается из СрокиИсполненияПроцессовКлиент.ИзменитьСрокПоПредставлениюВДеревеУчастников
// при изменении срока по представлению в дереве участников.
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма процесса или шаблона процесса
//  ЭлементУчастники - ТаблицаФормы - элемент управления древом участников.
//  СтандартнаяОбработка - Булево - в случае значения Истина обработка изменения срока
//                         будет осуществляться способом по умолчанию.
//
Процедура ПриИзмененииСрокаПоПредставлениюВДеревеУчастников(Форма, ЭлементУчастники,
	СтандартнаяОбработка) Экспорт
	
	СтандартнаяОбработка = Ложь;
	
	СрокиИсполненияПроцессовКлиентКОРП.ИзменитьСрокПоПредставлениюВДеревеУчастников(
		Форма, ЭлементУчастники);
	
КонецПроцедуры

// Вызывается из СрокиИсполненияПроцессовКлиент.ВыбратьСрокИсполненияДляСтрокиДереваУчастников при
// выборе срока для стр. дерева участинков.
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма процесса или шаблона процесса
//  ЭлементУчастники - ТаблицаФормы - элемент управления древом участников.
...
//                         будет осуществляться способом по умолчанию.
//
Процедура ПриВыбореСрокаИсполненияДляСтрокиДереваУчастников(
	Форма, ЭлементУчастники, УчастникиПроцесса, СтандартнаяОбработка) Экспорт
	
	СтандартнаяОбработка = Ложь;
	
	СрокиИсполненияПроцессовКлиентКОРП.ВыбратьСрокИсполненияДляСтрокиДереваУчастников(
		Форма, ЭлементУчастники, УчастникиПроцесса);
