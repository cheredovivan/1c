...
Функция ПолучитьПочтовогоАдресата(Адрес, Представление = Неопределено, Контакт = Неопределено) Экспорт
	
	Возврат ВстроеннаяПочтаСервер.ПолучитьПочтовогоАдресата(Адрес, Представление, , Контакт);
...
// Возвращает константу  КоличествоАдресатовДляОперативнойДоставкиПочты.
//
// Возвращаемое значение:
//  Строка - константа РасширенияФайловICalendar.
//
Функция ПолучитьРасширенияФайловICalendar() Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	Возврат Константы.РасширенияФайловICalendar.Получить();
	
КонецФункции	

// Вернет учетную запись по папке (может вернуть Неопределено)
Функция УчетнаяЗаписьДляПапки(Папка) Экспорт
	
	Возврат ВстроеннаяПочтаСервер.УчетнаяЗаписьДляПапки(Папка);
	
КонецФункции

// Возвращает константу  МаксимальноеЧислоПотоковДляПолучения.
//
// Возвращаемое значение:
//  Число - константа МаксимальноеЧислоПотоковДляПолучения.
//
Функция МаксимальноеЧислоПотоковДляПолучения() Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	Возврат Константы.МаксимальноеЧислоПотоковДляПолучения.Получить();
...
Функция ВстроеннаяПочтаИспользуется() Экспорт
	...
	Возврат ВстроеннаяПочтаСервер.ВстроеннаяПочтаИспользуется();	
	
КонецФункции	

// Возвращает константу ИспользоватьВнутреннююМаршрутизацию
//
// Возвращаемое значение:
//  Булево
//
Функция ИспользоватьВнутреннююМаршрутизацию() Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	Возврат Константы.ИспользоватьВнутреннююМаршрутизацию.Получить();
