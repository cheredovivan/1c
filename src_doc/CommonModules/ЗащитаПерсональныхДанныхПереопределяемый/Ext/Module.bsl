...
Процедура ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	ЭлеметСведений.ПоляДоступа = "Описание,СубъектыПерсональныхДанных.ФизическоеЛицо";
	...
	ЭлеметСведений.ПоляДоступа = "ФайлХранилище,СубъектыПерсональныхДанных.ФизическоеЛицо";
	ЭлеметСведений.ПоляРегистрации = "СубъектыПерсональныхДанных.ФизическоеЛицо";
	ЭлеметСведений.ОбластьДанных = "Файлы";
	
	ЭлеметСведений = ТаблицаСведений.Добавить();
	ЭлеметСведений.Объект = "Справочник.ДокументыПредприятия";
	ЭлеметСведений.ПоляДоступа = "Содержание,СубъектыПерсональныхДанных.ФизическоеЛицо";
	ЭлеметСведений.ПоляРегистрации = "СубъектыПерсональныхДанных.ФизическоеЛицо";
	ЭлеметСведений.ОбластьДанных = "ДокументыПредприятия";
...
Процедура ЗаполнитьОбластиПерсональныхДанных(КатегорииПерсональныхДанных) Экспорт
	...
	НоваяОбласть = КатегорииПерсональныхДанных.Добавить();
	НоваяОбласть.Имя = "ДокументыПредприятия";
	НоваяОбласть.Представление = НСтр("ru = 'Документы'");
...
Процедура ПередСкрытиемПерсональныхДанныхСубъектов(Субъекты, ТаблицаИсключений, ОтказОтСкрытия) Экспорт
	...
	ЗащитаПерсональныхДанныхДокументооборот.ПередСкрытиемПерсональныхДанныхСубъектов(Субъекты,
...
Процедура ПередУничтожениемПерсональныхДанных(Объект, Субъекты, ВыполнитьЗаписьОбъекта) Экспорт
	...
	ЗащитаПерсональныхДанныхДокументооборот.ПередУничтожениемПерсональныхДанных(
		Объект, Субъекты, ВыполнитьЗаписьОбъекта);
