...
// Устарела.
// См. Справочники.Организации.ИспользуетсяНесколькоОрганизаций
// 
// Возвращаемое значение:
//  Булево -
...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа.Представление = РедакцииКонфигурацииКлиентСервер.Организации();
...
Процедура ПроверитьЗначениеОпцииИспользоватьУчетПоОрганизациямПриЗаписи(Источник, Отказ) Экспорт
	...
	КолвоОрганизаций = Справочники.Организации.КоличествоОрганизаций();
	ИспользоватьНесколькоТекущееЗначение = ПолучитьФункциональнуюОпцию("ИспользоватьНесколькоОрганизаций");
	
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьУчетПоОрганизациям") И КолвоОрганизаций > 1 Тогда
		Константы.ИспользоватьУчетПоОрганизациям.Установить(Истина);
	КонецЕсли;
	
	Если Не ИспользоватьНесколькоТекущееЗначение И КолвоОрганизаций > 1 Тогда
		Константы.ИспользоватьНесколькоОрганизаций.Установить(Истина);
	КонецЕсли;
	
	Если ИспользоватьНесколькоТекущееЗначение И КолвоОрганизаций <= 1 Тогда
