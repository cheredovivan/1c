...
Процедура СформироватьИДобавитьПроизвольныйДокументВПакетПолучитьРеквизитыЗавершение(Результат, Параметры) Экспорт
	...
	СформироватьИДобавитьПроизвольныйДокументВПакет(Параметры.ДополнительныеПараметры, ПараметрыФормирования,
...
Процедура ДобавитьВПакетПослеОбработкиОшибокФормирования(Результат, Контекст) Экспорт
	...
	СформироватьИДобавитьПроизвольныйДокументВПакет(Контекст.ПараметрыДобавления, Контекст.ПараметрыФормирования,
		Контекст.ОписанияФайлов, Контекст.СообщенияДляПользователя);
...
//  СообщенияДляПользователя - Массив Из ФорматированнаяСтрока
//
Процедура СформироватьИДобавитьПроизвольныйДокументВПакет(ПараметрыДобавления, ПараметрыФормирования, ОписанияФайлов,
	СообщенияДляПользователя)
...
Процедура ДобавитьДокументВПакетПоСпособуДобавления(СпособДобавления, ДополнительныеПараметры)
	...
	ИначеЕсли СпособДобавления = СпособыДобавленияВПакет.ДобавитьВПакетДокументИнформационнойБазы Тогда
		...
		ОбменЭДОДокументооборотКлиент.ОткрытьФормуДобавленияВПакетДокументаИнформационнойБазы(ПараметрыФормы, Оповещение, СтандартнаяОбработка);
