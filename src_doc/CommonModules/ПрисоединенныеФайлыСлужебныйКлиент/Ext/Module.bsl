...
Процедура ПоместитьРедактируемыйФайлНаДискеВХранилищеРасширениеПредложено(Расширение1СПредприятияПодключено, ДополнительныеПараметры) Экспорт
...
Процедура ВыбратьФайлНаДискеИПоместитьВХранилищеРасширениеПредложено(Расширение1СПредприятияПодключено, ДополнительныеПараметры) Экспорт
...
Процедура ОткрытьКаталогСФайломРасширениеПредложено(Расширение1СПредприятияПодключено, ДополнительныеПараметры) Экспорт
...
Процедура ОповеститьОбИзмененииИУдалитьФайлВРабочемКаталогеРасширениеПредложено(Расширение1СПредприятияПодключено, ДополнительныеПараметры) Экспорт
...
Процедура ОткрытьФайлРасширениеПредложено(Расширение1СПредприятияПодключено, ДополнительныеПараметры) Экспорт
...
Процедура СохранитьФайлКакРасширениеПредложено(Расширение1СПредприятияПодключено, ДополнительныеПараметры) Экспорт
