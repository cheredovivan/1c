...
// Обрезает строку, если её длина превышает максимальное количество символов.
//
// Параметры:
//   Строка - Строка - Строка
//   ДлинаСтроки - Число - Длина, до которой необходимо сократить строку..
//
// Возвращаемое значение:
//   Строка - Если наименование длиннее максимального количества символов - функция
//     вернет сокращенное представление наименования с "..." на конце,
//     если нет - будет возвращено само наименование.
//
Функция Сократить(Наименование, ДлинаСтроки) Экспорт
	
	Возврат ?(СтрДлина(Наименование) > ДлинаСтроки,
		Лев(Наименование, (ДлинаСтроки - 3)) + "...",
		Наименование);
