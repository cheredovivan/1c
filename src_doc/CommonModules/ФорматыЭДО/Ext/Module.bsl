...
Функция СформироватьДокумент(Знач Формат, Знач Данные) Экспорт
	...
	Если Не ЗначениеЗаполнено(Результат.Ошибки) Тогда
...
Функция ЗагружаемыйФайлСоответствуетЗагруженномуФайлу(Организация, ЗагружаемыйФайл, ЗагруженныйФайл, ИмяФайла) Экспорт
