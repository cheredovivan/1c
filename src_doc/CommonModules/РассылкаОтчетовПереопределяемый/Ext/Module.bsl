...
Процедура ПереопределитьТаблицуТиповПолучателей(ТаблицаТипов, ДоступныеТипы) Экспорт
	...
	ДоступныеТипы = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Тип("СправочникСсылка.Сотрудники")); 
	
	ТаблицаТипов.Очистить();
	
	// Параметры справочников "Сотрудники" + "Рабочие группы".
	...
	// Параметры справочников "Сотрудники" + "Подразделения-контейнеры".
	НастройкиТипа = Новый Структура;
	НастройкиТипа.Вставить("ОсновнойТип",       Тип("СправочникСсылка.Сотрудники"));
	НастройкиТипа.Вставить("ДополнительныйТип", Тип("СправочникСсылка.ПодразделенияКонтейнеры"));
	РассылкаОтчетов.ДобавитьЭлементВТаблицуТиповПолучателей(ТаблицаТипов, ДоступныеТипы, НастройкиТипа);
...
Процедура ПередФормированиемСпискаПолучателейРассылки(ПараметрыПолучателей, Запрос, СтандартнаяОбработка, Результат) Экспорт
	...
	Запрос.Текст =
		...
		|	Сотрудники.Ссылка КАК Получатель,
		...
		|		ПО СотрудникиВКонтейнерах.Контейнер = ТаблицаПолучателей.Получатель
		|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Сотрудники КАК Сотрудники
		|		ПО Сотрудники.Ссылка = СотрудникиВКонтейнерах.Сотрудник
		|ГДЕ
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Сотрудники.КонтактнаяИнформация КАК Контакты
