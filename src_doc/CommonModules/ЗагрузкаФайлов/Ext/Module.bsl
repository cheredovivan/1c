	...
	Для Каждого ВыбранныйФайл Из ФайлыАргумент Цикл
		Попытка
			...
			Если ВыбранныйФайл.Существует() Тогда
				...
				ПараметрыСоздания.Вставить("ВыбранныйФайл", ВыбранныйФайл);
				ПараметрыСоздания.Вставить("Владелец", Владелец);
				ПараметрыСоздания.Вставить("ИдентификаторФормы", ИдентификаторФормы);
				ПараметрыСоздания.Вставить("Комментарий", Комментарий);
				ПараметрыСоздания.Вставить("ХранитьВерсии", ХранитьВерсии);
				ПараметрыСоздания.Вставить("ДобавленныеФайлы", ДобавленныеФайлы);
				ПараметрыСоздания.Вставить("АдресВременногоХранилищаФайла", АдресВременногоХранилищаФайла);
				ПараметрыСоздания.Вставить("АдресВременногоХранилищаТекста", АдресВременногоХранилищаТекста);
				ПараметрыСоздания.Вставить("Пользователь", Пользователь);
				// Локализация
				ПараметрыСоздания.Вставить("ПараметрыРаспознавания", ПараметрыРаспознавания);
				// Конец Локализация
				ПараметрыСоздания.Вставить("Категории", Категории);
				ПараметрыСоздания.Вставить("Кодировка");
				
				РаботаСФайламиКлиентСервер.СоздатьЭлементСправочникаФайлы(ПараметрыСоздания, МассивСтруктурВсехФайлов);
...
Функция ЕстьПравоДоступа(Пользователь, Папка) Экспорт
	...
	Возврат ДокументооборотПраваДоступа.ПраваПользователяПоОбъекту(Папка, Пользователь).Добавление;
