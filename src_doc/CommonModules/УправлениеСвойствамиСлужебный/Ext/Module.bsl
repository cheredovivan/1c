...
Процедура ДополнительныеРеквизитыОбработкаПроверкиЗаполнения(Источник, Отказ, ПроверяемыеРеквизиты) Экспорт
	...
	Если Не УправлениеСвойствамиДокументооборот.ОбъектПоддерживаетПроверкуУсловийДопСвойств(Источник) Тогда
		Возврат;
	КонецЕсли;
	...
	ДопРеквизитыОтбораДляУсловий = УправлениеСвойствамиДокументооборот.ДопРеквизитыОтбораДляУсловий(Источник);
...
Функция ЗначенияСвойств(ДополнительныеСвойстваОбъекта, Наборы, ВидСвойства) Экспорт
	...
	|	ДополнительныеРеквизитыИСведения.РасположениеИмя КАК РасположениеИмя,
