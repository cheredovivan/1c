...
Процедура ПриОпределенииСвойствНоменклатурыИнформационнойБазы(Знач НаборНоменклатуры, СвойстваНоменклатурИБ) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ПриОпределенииСвойствНоменклатурыИнформационнойБазы(
		НаборНоменклатуры, СвойстваНоменклатурИБ);
...
Процедура ПриОпределенииПредставленийСопоставленияНоменклатуры(Представления) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ПриОпределенииПредставленийСопоставленияНоменклатуры(
		Представления);
...
Процедура ПриОпределенииСтруктурыНоменклатурыИнформационнойБазы(СтруктураНоменклатуры) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ПриОпределенииСтруктурыНоменклатурыИнформационнойБазы(
...
Процедура ПроверитьИспользованиеХарактеристик(ХарактеристикиИспользуются) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ПроверитьИспользованиеХарактеристик(
...
Процедура ЗначениеНаименованияДанныхСопоставленияНоменклатурыБЭД(Знач СсылкаНаОбъект, ЗначениеНаименования) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ЗначениеНаименованияДанныхСопоставленияНоменклатурыБЭД(
		СсылкаНаОбъект, ЗначениеНаименования);
...
Процедура ЗначенияНаименованийДанныхСопоставленияНоменклатурыБЭД(Знач НаборСсылокНаОбъекты, СоответствиеЗначенийНаименований) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ЗначенияНаименованийДанныхСопоставленияНоменклатурыБЭД(
		НаборСсылокНаОбъекты, СоответствиеЗначенийНаименований);
...
Процедура ОпределитьНаименованиеТипаОбъектаСопоставленияНоменклатурыБЭД(Знач СсылкаНаОбъект, НаименованиеТипаОбъекта) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ОпределитьНаименованиеТипаОбъектаСопоставленияНоменклатурыБЭД(
		СсылкаНаОбъект, НаименованиеТипаОбъекта);
...
Процедура ТекстЗапросаПоискаВариантовСопоставленияУпаковкиНоменклатурыБЭД(ТекстЗапроса) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.
		ТекстЗапросаПоискаВариантовСопоставленияУпаковкиНоменклатурыБЭД(ТекстЗапроса);
...
Процедура ПриЗаполненииФормыНоменклатурыПоДаннымКонтрагента(Знач НоменклатураКонтрагента, Форма) Экспорт
	...
	СопоставлениеНоменклатурыКонтрагентовДокументооборот.ПриЗаполненииФормыНоменклатурыПоДаннымКонтрагента(
