...
Процедура ОтразитьДанныеЭлектронногоДокумента(ДанныеЭлектронногоДокумента, СпособОбработки, ОбъектыУчета = Неопределено, ДанныеРазбора = Неопределено) Экспорт
	...
	Попытка
		...
		ОбменЭДОДокументооборотПереопределяемый.ОтразитьДанныеЭлектронногоДокумента(
			ДанныеЭлектронногоДокумента, ДанныеРазбора, СпособОбработки, ОбъектыУчета, СтандартнаяОбработка);
