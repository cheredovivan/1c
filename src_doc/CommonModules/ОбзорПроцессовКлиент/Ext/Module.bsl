...
Процедура ПредставлениеHTMLПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка, Форма) Экспорт
	...
	ИначеЕсли ОбзорПроцессовКлиентЛокализация.ПредставлениеHTMLПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка, Форма) Тогда
...
Процедура ПредставлениеПроцессаHTMLПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка, Форма) Экспорт
	...
	ИначеЕсли СтрНачинаетсяС(СтрСсылка, "Подзадача") Тогда
		...
		СписокЗначений.Добавить("ПосмотретьПользователя", НСтр("ru='Посмотреть сотрудника'"),, 
	...
	Иначе
		...
		РаботаС_HTMLКлиент.ОткрытьСсылку(Элемент, ДанныеСобытия, СтандартнаяОбработка, Форма);
