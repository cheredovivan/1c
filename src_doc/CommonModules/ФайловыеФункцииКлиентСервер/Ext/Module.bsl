////////////////////////////////////////////////////////////////////////////////
// Файловые функции (клиент, сервер)
//
////////////////////////////////////////////////////////////////////////////////
...
Функция ПолучитьИндексПиктограммыФайла(Знач РасширениеФайлаТолькоТекст) Экспорт
	...
	ИначеЕсли ОбщегоНазначенияДокументооборотКлиентСервер.ЭтоАудиоКонтент(Расширение) Тогда
		Возврат 64;  // Аудио.
	...
	ИначеЕсли ОбщегоНазначенияДокументооборотКлиентСервер.ЭтоВидеоКонтент(Расширение) Тогда
		Возврат 78; // Видео.
...
// Возвращает расширения например bat - которые нельзя сразу запускать в  ДО (по сути текстовые)
//
// Возвращаемое значение:
//   Строка - список расширенией
//
Функция ИсполняемыеТекстовыеФайлы() Экспорт
	 
	ПоддерживаемыеТипы = "BAT CMD VBS JS REG";
	Возврат ПоддерживаемыеТипы;
	
КонецФункции	 	

// Возвращает расширения например exe - которые нельзя сразу запускать в  ДО (бинарные)
//
// Возвращаемое значение:
//   Строка - список расширенией
//
Функция ИсполняемыеБинарныеФайлы() Экспорт
	 
	ПоддерживаемыеТипы = "COM EXE BIN APK";
	Возврат ПоддерживаемыеТипы;
