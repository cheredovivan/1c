...
Процедура ПолучитьСоответствиеНаименованийОбъектовМДИРеквизитов(СоответствиеРеквизитовОбъекта) Экспорт
	...
	СоответствиеРеквизитовОбъекта.Вставить("ДокументыПредприятия.СуммаДокумента",   "Сумма");
	СоответствиеРеквизитовОбъекта.Вставить("ДокументыПредприятия.Дата",             "ДатаРегистрации");
...
Функция ПолучитьФизЛицоМЧД(СведенияФизЛица) Экспорт
	...
	Возврат МашиночитаемыеДоверенностиДокументооборот.ФизЛицоПоСведениям(СведенияФизЛица);
...
Процедура ПолучитьТипыОрганизацииПредставителяМЧД(Типы) Экспорт
	...
	МашиночитаемыеДоверенностиДокументооборот.ДополнитьТипыОрганизацийПредставителяМЧД(Типы);
...
Функция ПолучитьОрганизациюМЧД(СведенияЮрЛица) Экспорт
	...
	Возврат МашиночитаемыеДоверенностиДокументооборот.ЮрЛицоПредставительМЧД(СведенияЮрЛица);
