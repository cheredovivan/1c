...
Процедура ПриПодбореУчетногоДокумента(Знач Настройки, Знач ОповещениеОВыборе, СтандартнаяОбработка = Истина) Экспорт
	...
	Настройки.Свойство("ЭлектронныйДокумент", ЭлектронныйДокумент);
	
	Если Не ЗначениеЗаполнено(ЭлектронныйДокумент) Тогда
		ЭлектронныйДокумент = ОповещениеОВыборе.ДополнительныеПараметры.ЭлектронныйДокумент;
	КонецЕсли;
	
	ОтражениеВУчетеДОКлиент.ПодобратьДокументУчетаПоДокументуЭДО(ЭлектронныйДокумент, СтандартнаяОбработка);
...
//  ПараметрыОткрытияФормы - см. ОтражениеВУчетеЭДОКлиент.ОбщегоНазначенияБЭДКлиент.ОткрытьФормуБЭД.ПараметрыОткрытияФормы
...
Процедура ПриСозданииУчетногоДокумента(ЭлектронныйДокумент, СтандартнаяОбработка) Экспорт
	...
	СтандартнаяОбработка = Ложь;
	ОтражениеВУчетеДОКлиент.ПриСозданииУчетногоДокумента(ЭлектронныйДокумент, СтандартнаяОбработка);
