...
Процедура ПриЗагрузкеНовогоЭлектронногоДокумента(ЭлектронныйДокумент, ВидДокумента, СостояниеЭДО, ИсправленнаяВерсияДокумента, КонтекстДиагностики) Экспорт
	...
	ОбменЭДОДокументооборот.ПриЗагрузкеНовогоЭлектронногоДокумента(ЭлектронныйДокумент,
		ВидДокумента, СостояниеЭДО, ИсправленнаяВерсияДокумента, КонтекстДиагностики);
