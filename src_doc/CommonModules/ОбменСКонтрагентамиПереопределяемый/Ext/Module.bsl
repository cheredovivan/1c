...
Процедура ПодготовитьСтруктуруОбъектовКомандЭДО(СоставКомандЭДО) Экспорт
	...
	ОбменЭДОДокументооборот.ПодготовитьСтруктуруОбъектовКомандЭДО(СоставКомандЭДО);
...
Процедура ПриОпределенииФункциональностиФормыНастройкиОтправкиДокументов(ДоступнаяФункциональность) Экспорт
	...
	ДоступнаяФункциональность.ИспользоватьДоговор = Ложь;
	ДоступнаяФункциональность.НастройкаРегламента = Ложь;
	ДоступнаяФункциональность.РасширенныйРежим = Ложь;
...
Процедура ЗаполнитьСоответствиеСтавокНДС(Соответствие) Экспорт
	...
	УчетНДСЛокализация.СоответствиеСтавокНДССтроковымЗначениям(Соответствие);
...
Процедура СоответствиеИсходящихТиповЭлектронныхДокументовДокументамИБ(СоответствиеТиповЭлектронныхДокументовДокументамИБ) Экспорт 
	...
	ОбменЭДОДокументооборот.СоответствиеИсходящихТиповЭлектронныхДокументовДокументамИБ(
		СоответствиеТиповЭлектронныхДокументовДокументамИБ);
...
Процедура СписокТиповДокументовПоТипуЭлектронногоДокумента(ТипДокумента, ОписанияОбъектовУчета) Экспорт
	...
	ОбменСКонтрагентамиДОСервер.СписокТиповДокументовПоТипуЭлектронногоДокумента(ТипДокумента, ОписанияОбъектовУчета);
...
Процедура ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента) Экспорт
	...
	ОбменЭДОДокументооборот.ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента);
...
Процедура ЗаполнитьДанныеУКД2020_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменЭДОДокументооборот.ПриФормированииИнформацииОтправителя(Основание, Отказ);
...
Процедура ЗаполнитьДанныеУКД2020_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	// ДО не может формировать данные ответного титула по документу учета, формируем только вручную
	Отказ = Истина;
...
Процедура ЗаполнитьДанныеАктОПриемкеВыполненныхРаботВСтроительстве_ИнформацияПодрядчика(СсылкаНаОбъект, КонструкторЭД,
	...
	ОбменЭДОДокументооборот.ПриФормированииИнформацииОтправителя(СсылкаНаОбъект, Отказ);
...
Процедура ЗаполнитьДанныеПоДокументуПредприятия(СсылкаНаОбъект, КонструкторЭД, Отказ) Экспорт
	...
	ОбменСКонтрагентамиДОСервер.ЗаполнитьДанныеПоДокументуПредприятия(СсылкаНаОбъект, КонструкторЭД, Отказ);
...
Процедура НайтиСоздатьДокументПредприятия(СсылкаНаОбъектУчета, КонструкторЭД, ПараметрыОбработки, ОписаниеОшибки, ДополнительныеДанные = Неопределено) Экспорт
	...
	ОбменСКонтрагентамиДОСервер.НайтиСоздатьДокументПредприятия(СсылкаНаОбъектУчета, КонструкторЭД, ПараметрыОбработки,
		ОписаниеОшибки, ДополнительныеДанные);
...
Процедура СпособыОтраженияВУчетеТипаЭлектронногоДокумента(ТипДокумента, СпособыОтраженияВУчете) Экспорт 
	...
	ОбменСКонтрагентамиДО.СпособыОтраженияВУчетеТипаЭлектронногоДокумента(ТипДокумента, СпособыОтраженияВУчете);
...
Процедура СписокВидовИсходящихДокументов(ТипДокумента, СписокСпособовОбработки) Экспорт 
	...
	ОбменЭДОДокументооборот.СписокВидовИсходящихДокументов(ТипДокумента, СписокСпособовОбработки);
...
Процедура ИмяОбъектаМетаданныхПоСпособуОтраженияВУчете(СпособОтраженияВУчете, ИмяДокумента) Экспорт 
	...
	ОбменЭДОДокументооборот.ИмяОбъектаМетаданныхПоСпособуОтраженияВУчете(СпособОтраженияВУчете, ИмяДокумента);
...
Процедура СоздатьКонтрагентаПоРеквизитам(Знач РеквизитыКонтрагента, Контрагент, Отказ = Ложь) Экспорт
	...
	ОбменСКонтрагентамиДОСлужебный.СоздатьКонтрагентаПоРеквизитам(РеквизитыКонтрагента, Контрагент, Отказ);
...
Процедура АдресЭлектроннойПочтыКонтрагента(Контрагент, АдресЭП) Экспорт
	...
	АдресЭП = УправлениеКонтактнойИнформациейДокументооборот.ПредставлениеКонтактнойИнформации(Контрагент,
...
Процедура СписокОперацийВсехТиповДокумента(СписокОпераций, СтандартнаяОбработка) Экспорт
	...
	СписокОпераций.Добавить("Документ", "Документ");
...
Процедура ПриПроверкиГотовностиЭлектронногоДокумента(Объект, ТолькоПросмотр) Экспорт
	...
	ОбменСКонтрагентамиДоСобытия.ЭлектронныйДокументВходящийЭДОПриНастройкеВидимостиДействий(Объект, ТолькоПросмотр);
