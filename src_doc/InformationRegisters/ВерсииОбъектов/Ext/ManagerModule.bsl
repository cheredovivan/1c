...
//  Булево - Булево - Истина, если были найдены устаревшие данные, в противном случае Ложь.
Функция УдалитьПорциюУстаревшихДанных() Экспорт
	...
	ВерсионированиеОбъектов.ПодготовитьПараметрыЗапроса(Запрос, ШаблонЗапроса, ТекстыЗапросов);
