...
Функция ТаблицаПроектыДляСинхронизацииПоУмолчанию(Пользователь)
	...
	ДатаУстаревания = РегистрыСведений.МП_НастройкиПользователей.ДатаУстаревания(Пользователь);
...
Процедура СинхронизироватьПроектПриНеобходимости(Пользователь, Проект, ПроектПоУмолчанию = Ложь) Экспорт
	...
	Если ПроектПоУмолчанию Тогда
		...
		РегистрыСведений.МП_ИзмененныеНастройкиСинхронизации.ДобавитьЗапись(Пользователь,
			Перечисления.МП_ТипыНастроекПользователей.ПроектПоУмолчанию);
