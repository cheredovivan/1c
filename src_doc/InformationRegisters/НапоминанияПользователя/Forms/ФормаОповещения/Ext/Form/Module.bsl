...
Процедура ОбновитьТаблицуНапоминаний() 
	...
	ТаблицаНапоминаний = ПолучитьТекущиеОповещения();
	...
	Интервал = 60; // Обновление таблицы не реже чем 1 раз в 60 сек.
...
Функция ПолучитьТекущиеОповещения() 
	
	Возврат НапоминанияПользователяДокументооборот.ТекущиеНапоминания();
...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.Напоминания.ИспользованиеТекущейСтроки = ИспользованиеТекущейСтрокиТаблицы.Авто;
	Элементы.Напоминания.АвтоМаксимальнаяВысота = Ложь;
	Элементы.Напоминания.РастягиватьПоВертикали = Истина;
	Элементы.Напоминания.ВариантУправленияВысотой = ВариантУправленияВысотойТаблицы.ВСтрокахФормы;
	Элементы.Напоминания.АвтоМаксимальнаяВысотаВСтрокахТаблицы = Ложь;
	...
	МК.ПреобразоватьКнопкуВАкцентную(ЭтотОбъект,
		...
		Элементы.ГруппаОтложитьВсеНаМК);
	...
	Элементы.СрокПовторногоОповещения.ГоризонтальноеПоложение =
