...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСКонтрагентамиДОСобытия.УчетнаяЗаписьЭДОПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка);
...
&НаКлиенте
Процедура Подключаемый_ДокументооборотНажатие(Элемент, СтандартнаяОбработка)
	
	ОбменСКонтрагентамиДОСобытияКлиент.УчетнаяЗаписьЭДОНажатие(ЭтотОбъект, Элемент, СтандартнаяОбработка);
