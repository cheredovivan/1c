...
Асинх Процедура ОбновитьСписокСертификатов(СвойстваСертификатовНаКлиенте)
	...
	Для Каждого СвойствоСертификата Из СвойстваСертификатовНаКлиенте Цикл
		...
		ДвочиныеДанныеСертификата = Ждать СвойствоСертификата.ВыгрузитьАсинх();
		
		ДополнительныеСвойстваСертификата =
			КриптографияБЭДКлиентСервер.ДополнительныеСвойстваСертификата(
				СвойствоСертификата, ДвочиныеДанныеСертификата, Новый Соответствие());
...
Процедура СохранитьНастройкуОблачногоЭДО()
	РегистрыСведений.НастройкиОблачногоЭДО.Записать(ИдентификаторЭДО, УчетнаяЗаписьОблачногоЭДО);
КонецПроцедуры
...
Процедура ВключитьАвтоматическоеПолучениеЭДО(ОповещениеОЗавершении)
	...
	Если Не ИспользоватьКлючДоступаКСервисуЭДО
