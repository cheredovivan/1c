...
Функция ОтметкаВремениУстарела(МобильноеПриложение, Пользователь, Период, НомерДобавления) Экспорт
	...
	Запрос.Текст = 
		"ВЫБРАТЬ ПЕРВЫЕ 1
		|	МП_СведенияОПользователя.ОтметкаВремениСборкиДанных КАК ОтметкаВремениСборкиДанных
		|ПОМЕСТИТЬ ПоследняяОтметкаСборкиДанных
		|ИЗ
		|	РегистрСведений.МП_СведенияОПользователя КАК МП_СведенияОПользователя
		|ГДЕ
		|	МП_СведенияОПользователя.ПользовательМобильногоПриложения = &МобильноеПриложение
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ ПЕРВЫЕ 1
