...
//     Наименование
//
Функция СтруктураНастроекСвязей() Экспорт
	...
	ПараметрыНастроекСвязей.Вставить("ВидКорреспонденцииДокументИз");
	ПараметрыНастроекСвязей.Вставить("ВидКорреспонденцииДокументНа");
	ПараметрыНастроекСвязей.Вставить("Важная", Истина);
