...
Процедура ДобавитьПолномочияНаСервере(Владелец, Полномочия)
	...
	РегистрыСведений.ПолномочияСотрудников.ДобавитьПолномочия(Владелец, Полномочия);
...
Процедура УдалитьПолномочияНаСервере(Владелец, Полномочия)
	...
	РегистрыСведений.ПолномочияСотрудников.УдалитьПолномочия(Владелец, Полномочия);
