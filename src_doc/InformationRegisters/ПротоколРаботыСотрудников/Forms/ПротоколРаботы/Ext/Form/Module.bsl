...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого ТипСобытия Из Перечисления.ТипыСобытийПротоколаРаботыСотрудников Цикл
...
Процедура УстановитьПараметрыИОтборСписка()
	...
	Для Каждого Сотрудник Из СписокСотрудники Цикл
		СотрудникиМассив.Добавить(Сотрудник.Значение);
	КонецЦикла;
	Если СотрудникиМассив.Количество() <> 0 Тогда
		ПараметрыОтбора.Вставить("Сотрудники", СотрудникиМассив);
	КонецЕсли;	
...
Процедура УстановитьОтборСписка(ПараметрыОтбора)
	...
	// Сотрудники 
	СотрудникиМассив = ПараметрыОтбора.Получить("Сотрудники");
	Если СотрудникиМассив <> Неопределено И СотрудникиМассив.Количество() > 0 Тогда 
