...
Процедура ОбновитьДанныеРегистра(ЕстьИзменения = Неопределено) Экспорт
	...
	ЗаписатьИзменения(ЗапросИзменений(Ложь), ЕстьИзменения);
	ЗаписатьИзменения(ЗапросИзменений(Истина), ЕстьИзменения);
...
Процедура ЗаписатьИзменения(Запрос, ЕстьИзменения)
