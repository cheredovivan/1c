...
// Возвращает ключ правил отражения документов ЭДО в 1С:Документооборот
// 
// Параметры:
...
//  Структура - Ключ правил отражения В ДО:
//    * ВидДокументаЭДО - СправочникСсылка.ВидыДокументовЭДО - Вид документа ЭДО
//    * Организация - СправочникСсылка.Организации - Организация
//    * Контрагент - СправочникСсылка.Контрагенты - Контрагент
Функция КлючПравилОтраженияВДО(ВидДокументаЭДО, Организация, Контрагент) Экспорт
	
	КлючПравил = Новый Структура;
	КлючПравил.Вставить("ВидДокументаЭДО", ВидДокументаЭДО);
	КлючПравил.Вставить("Организация", Организация);
	КлючПравил.Вставить("Контрагент", Контрагент);
...
//
// Парамтеры:
//  КлючПравил - Структура - Ключ правил отражения, см. РегистрыСведений.ПравилаУчетаВидовЭДДО.КлючПравилОтраженияВДО()
// 
Функция ПараметрыДокументаПоВидуЭДО(КлючПравил) Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("ВидДокументаЭДО", КлючПравил.ВидДокументаЭДО);
	Запрос.УстановитьПараметр("Контрагент", КлючПравил.Контрагент);
	Запрос.УстановитьПараметр("Организация", КлючПравил.Организация);
	...
	ТекстЗапроса = 
		...
		|	ПравилаУчетаВидовЭДДО.РольФайла КАК РольФайла,
		...
		|	ПравилаУчетаВидовЭДДО.СоздаватьАвтоматически КАК СоздаватьАвтоматически
		|ИЗ
		|	РегистрСведений.ПравилаУчетаВидовЭДДО КАК ПравилаУчетаВидовЭДДО
		|ГДЕ
	...
	ПараметрыДокументаПоВидуЭДО.Вставить("ТематикаДокумента");
	...
	ПараметрыДокументаПоВидуЭДО.Вставить("РольФайла");
	...
	ПараметрыДокументаПоВидуЭДО.Вставить("СоздаватьАвтоматически");
...
Функция НастройкиПриемаПоУмолчанию()
	...
	ВходящиеДокументы.Колонки.Добавить("СоздаватьАвтоматически" , ОписаниеТипаБулево);
	ВходящиеДокументы.Колонки.Добавить("ВидДокумента"           , Новый ОписаниеТипов("СправочникСсылка.ВидыДокументов"));
	ВходящиеДокументы.Колонки.Добавить("ТематикаДокумента"      , Новый ОписаниеТипов("СправочникСсылка.ТематикиДокументов"));
	ВходящиеДокументы.Колонки.Добавить("ВопросДеятельности"     , Новый ОписаниеТипов("СправочникСсылка.ВопросыДеятельности"));
	ВходящиеДокументы.Колонки.Добавить("РольФайла"              , Новый ОписаниеТипов("СправочникСсылка.РолиФайлов"));
	ВходящиеДокументы.Колонки.Добавить("Ответственный"          , Новый ОписаниеТипов("СправочникСсылка.Сотрудники"));
	ВходящиеДокументы.Колонки.Добавить("Папка"                  , Новый ОписаниеТипов("СправочникСсылка.ПапкиДокументов"));
	ВходящиеДокументы.Колонки.Добавить("ГрифДоступа"            , Новый ОписаниеТипов("СправочникСсылка.ГрифыДоступа"));
	ВходящиеДокументы.Колонки.Добавить("Шаблон"                 , Новый ОписаниеТипов("СправочникСсылка.ШаблоныДокументов"));
