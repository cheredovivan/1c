...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(Параметры.Источник) = Тип("ЗадачаСсылка.ЗадачаИсполнителя") Тогда 
		...
		Если ЗначениеЗаполнено(ИсполнительЗадачи) Тогда 
			...
			Если СотрудникиПользователя.Найти(ИсполнительЗадачи) = Неопределено Тогда
		...
		Иначе
			...
			ИсполнителиРоли = РегистрыСведений.ИсполнителиРолей.ИсполнителиРоли(Параметры.Источник.РольИсполнителя);
			
			Для Каждого СотрудникПользователя Из Сотрудники.СотрудникиПользователя() Цикл
				Если ИсполнителиРоли.Найти(СотрудникПользователя) <> Неопределено Тогда
