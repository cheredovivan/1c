...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("Сотрудники", 
		Сотрудники.СотрудникиПользователя(Параметры.Пользователь));
...
Процедура СписокВыборЗначения(Элемент, СтандартнаяОбработка, Значение)
	...
	Параметр.Вставить("Начало", ТекущиеДанные.Начало);
	Параметр.Вставить("Окончание", ТекущиеДанные.Окончание);
...
Процедура УстановитьОтборПоПериоду()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("НастройкиПодбораРабот", "ВариантПериодаВыборки", ПериодВыборки.Вариант);
...
Процедура МК_НастроитьЭлементыФормы()
	...
	МК.ВыровнятьЭлементФормы(Элементы.НаправлениеСортировки);
