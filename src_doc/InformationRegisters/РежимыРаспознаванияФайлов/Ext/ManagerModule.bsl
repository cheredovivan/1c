...
// Возвращает массив типов владельцев справочника "Файлы", которые не подохдят для автоматического распознавания.
//
// Возвращаемое значение:
//  Массив Из Строка
//
Функция НеподходящиеТипыДляАвтораспознавания() Экспорт
	
	МассивТипов = Новый Массив;
	МассивТипов.Добавить("Документ.ВходящееПисьмо");
	МассивТипов.Добавить("Документ.ИсходящееПисьмо");
	МассивТипов.Добавить("Справочник.ШаблоныЗадач");
	МассивТипов.Добавить("Документ.ТранспортныйКонтейнерЭДО");
	МассивТипов.Добавить("Документ.ВыгрузкаВССТУ");
	МассивТипов.Добавить("Справочник.СообщениеЭДОПрисоединенныеФайлы");
	МассивТипов.Добавить("Справочник.ШаблоныДокументов");
	МассивТипов.Добавить("Справочник.ШаблоныПисем");
	МассивТипов.Добавить("Справочник.Должности");
	МассивТипов.Добавить("Справочник.ШаблоныТекстов");
	
	Возврат МассивТипов;
	
КонецФункции

// Обновляет режимы распознавания для заданных владельцев файлов.
//
// Параметры:
//  Режимы - Соответствие Из КлючИЗначение:
//   *Ключ - СправочникСсылка.ИдентификаторыОбъектовМетаданных
//   *Значение - ПеречислениеСсылка.ВариантыРежимовРаспознаванияФайлов
//  ВключатьБизнесЛогику - Булево
//
Процедура ОбновитьРежимыРаспознаванияФайловПоВладельцам(Режимы, ВключатьБизнесЛогику) Экспорт
	...
	Для Каждого РежимДляВладельца Из Режимы Цикл
		...
		Набор = СоздатьНаборЗаписей();
		Набор.Отбор.Владелец.Установить(РежимДляВладельца.Ключ);
		Набор.Прочитать();
		
		Если Набор.Количество() Тогда
			
			Набор[0].Режим = РежимДляВладельца.Значение;
			Если ВключатьБизнесЛогику Тогда
				Набор.Записать();
			Иначе
