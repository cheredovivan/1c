...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.Наименование) Тогда
		Элементы.ДекорацияЗаголовок.Заголовок = СтрШаблон(
			НСтр("ru = 'Выберите тип расположения информационной базы %1:'"),
...
Процедура АдресВебСервисаОткрытие(Элемент, СтандартнаяОбработка)
	...
	РаботаСИнтегрированнымиСистемамиКлиентСервер.ОбработатьАдресВебСервисаИнтегрированнойСистемы(АдресВебСервиса);
	Элементы.АдресВебСервиса.ОбновитьТекстРедактирования();
