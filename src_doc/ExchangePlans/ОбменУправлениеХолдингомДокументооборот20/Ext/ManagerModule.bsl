...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.Отборы.Вставить("ЗаявкиНаОплату", 
		Новый Структура("ВидДокумента, ТипОперации"));
	
	ОписаниеВарианта.Отборы.Вставить("ОграничиватьВыгрузкуОрганизациями");
	ОписаниеВарианта.Отборы.Вставить("Организации", Новый Структура("Организация"));
...
Функция ОписаниеОграниченийПередачиДанных(Отборы, ВерсияКорреспондента, ИдентификаторНастройки) Экспорт
	...
	// Организации.
	Если Отборы.ОграничиватьВыгрузкуОрганизациями Тогда
		ТекстОписания = ТекстОписания + Символы.ПС + НСтр("ru = 'Выгружаются только данные по организациям:'");
		ВыгружаемыеОрганизации = Отборы.Организации.Организация;
