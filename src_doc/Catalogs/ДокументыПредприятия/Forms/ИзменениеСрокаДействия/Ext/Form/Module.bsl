...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(Параметры.Документ) <> Тип("СправочникСсылка.ДокументыПредприятия") Тогда
	...
	Если Параметры.Свойство("ЗаполнитьРеквизиты") И Параметры.ЗаполнитьРеквизиты = Истина Тогда
		Если Не Справочники.ДокументыПредприятия.ИмеетСрокДействия(Параметры.Документ) Тогда
