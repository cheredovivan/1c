...
Процедура ОбновитьКэширующиеДанные(Выборка) Экспорт
	...
	РеквизитыФайла = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
		Выборка.КлючВлияющихДанных,
		"Наименование, ВладелецФайла, ТекущаяВерсия");
	
	РеквизитыВерсииФайла = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
		РеквизитыФайла.ТекущаяВерсия,
		"ТипХраненияФайла");
	
	РаботаСФайламиВызовСервера.ПереименоватьОдинФайлПоШаблону(
		Выборка.КлючВлияющихДанных,
		РеквизитыФайла.ВладелецФайла,
		ОригинальноеИмя,
		РеквизитыФайла.Наименование,
		РеквизитыВерсииФайла.ТипХраненияФайла);
