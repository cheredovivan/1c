...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбластьПрименения = Перечисления.ОбластиПримененияШаблоновТекстов.Почта Тогда 
		Заголовок = НСтр("ru = 'Выбор шаблона текста письма'");
	ИначеЕсли ОбластьПрименения = Перечисления.ОбластиПримененияШаблоновТекстов.Резолюции Тогда
		Заголовок = НСтр("ru = 'Выбор шаблона резолюции'");
		КоличествоЭлементов = КоличествоЭлементовСправочника(ТекущийПользователь);
	ИначеЕсли ОбластьПрименения = Перечисления.ОбластиПримененияШаблоновТекстов.ПроектыРезолюций Тогда
		Заголовок = НСтр("ru = 'Выбор проекта резолюции'");
		КоличествоЭлементов = КоличествоЭлементовСправочника(ТекущийПользователь, ОбластьПрименения);
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция КоличествоЭлементовСправочника(ТекущийПользователь, ОбластьПрименения = Неопределено)
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	СправочникШаблоныТекстов.ОбластьПрименения = &ОбластьПрименения
	...
	Если ОбластьПрименения = Неопределено Тогда
		ОбластьПрименения = Перечисления.ОбластиПримененияШаблоновТекстов.Резолюции;
	КонецЕсли;
	Запрос.Параметры.Вставить("ОбластьПрименения", ОбластьПрименения);
