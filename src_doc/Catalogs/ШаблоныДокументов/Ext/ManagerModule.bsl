...
// Возвращает структуру полей Шаблона документов предприятия
//
...
// Создает и записывает в БД шаблон документов предприятия
//
// Параметры:
...
Процедура ЗаполнитьДескрипторыОбъекта(ОбъектДоступа, ТаблицаДескрипторов, ПротоколРасчетаПрав = Неопределено) Экспорт
	...
	Если ПротоколРасчетаПрав <> Неопределено Тогда
		Если ДоступЗаполнен Тогда
			ЗаписьПротокола = Новый Структура("Элемент, Описание",
				ОбъектДоступа.Ссылка, НСтр("ru = 'Пользователи из таблицы ""Доступ""'"));
...
Процедура ЗаполнитьОсновнойДескриптор(ОбъектДоступа, ДескрипторДоступа) Экспорт
	...
	Для Каждого КлючИЗначение Из ЗначенияГруппыДоступа Цикл
		...
		Если ЗначениеЗаполнено(ГруппаДоступа) И ДобавленныеГруппы[ГруппаДоступа] = Неопределено Тогда
			Строка = ДескрипторДоступа.Контрагенты.Добавить();
			Строка.ГруппаДоступа = ГруппаДоступа;
			ДобавленныеГруппы[ГруппаДоступа] = Истина;
		КонецЕсли;
	КонецЦикла;
