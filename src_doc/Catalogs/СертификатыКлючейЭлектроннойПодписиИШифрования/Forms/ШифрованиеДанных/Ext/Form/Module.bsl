...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаШифрованиеДанныхПриСозданииНаСервере(ЭтотОбъект);
...
Асинх Процедура ЗаполнитьПрограммуШифрованияПослеЦикла(Контекст)
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ФормаШифрованияПослеИзмененияПрограммыШифрования(ЭтотОбъект);
