...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаСертификатаПриСозданииНаСервере(ЭтотОбъект);
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаСертификатаПриЧтенииНаСервере(ЭтотОбъект);
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаСертификатаПослеЗаписиНаСервере(
...
Процедура ПриСозданииНаСервереПриЧтенииНаСервере()
	...
	Иначе
		...
		Элементы.ФормаПроверитьСертификат.Доступность = (ЗначениеЗаполнено(ДвоичныеДанныеСертификата) И ДвоичныеДанныеСертификата.Размер() > 0);
		...
		Если ЗначениеЗаполнено(ДвоичныеДанныеСертификата) И ДвоичныеДанныеСертификата.Размер() > 0 Тогда
