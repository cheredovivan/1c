...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаРасшифровкиДанныхПриСозданииНаСервере(ЭтотОбъект);
...
Процедура ПриОткрытии(Отказ)
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ФормаРасшифровкиПриОткрытии(ЭтотОбъект, Отказ);
