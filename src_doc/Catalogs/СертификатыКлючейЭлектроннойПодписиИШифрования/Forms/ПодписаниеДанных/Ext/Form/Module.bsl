...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлектроннаяПодписьДокументооборотСобытия.ФормаПодписаниеДанныхПриСозданииНаСервере(ЭтотОбъект);
...
Процедура ПриОткрытии(Отказ)
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ФормаПодписанияПриОткрытии(ЭтотОбъект, Отказ);
...
Процедура ПодписатьДанныеПослеПредупрежденияПодписьНеверна(Результат, ДополнительныеПараметры) Экспорт
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ПриЗаполненииОписанияДанныхПриПодписании(
		ЭтотОбъект, ОписаниеДанных);
...
Процедура ПодписатьДанныеПослеОбработкиПередВыполнением(Результат, Контекст) Экспорт
	...
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ПриЗаполненииПараметровВыполненияПодписанияДанных(
...
#Область ПодключаемыеОбработчики_ДО

&НаКлиенте
Процедура Подключаемый_ОбработкаКомандыДО(Команда)
	
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьПодключаемуюКоманду(ЭтотОбъект, Команда);
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ПередНачаломДобавленияДО(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьСобытиеПередНачаломДобавления(
		ЭтотОбъект, Элемент, Отказ, Копирование, Родитель, Группа, Параметр);
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ПередНачаломИзмененияДО(Элемент, Отказ)
	
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьСобытиеПередНачаломИзменения(ЭтотОбъект, Элемент, Отказ);
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ПередУдалениемДО(Элемент, Отказ)
	
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьСобытиеПередУдалением(ЭтотОбъект, Элемент, Отказ);
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ПриАктивизацииСтрокиДО(Элемент, Отказ)
	
	ПараметрыОбработчика =
		ЭлектроннаяПодписьДокументооборотСобытияКлиент.НовыеПараметрыПолдключенияОбработчикаОжидания();
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьСобытиеПриАктивизацииСтроки(
		ЭтотОбъект, Элемент, ПараметрыОбработчика);
	
	Если ПараметрыОбработчика.ПодключитьОбработчик Тогда
		ПодключитьОбработчикОжидания("Подключаемый_ОбработчикОжиданияДО",
			ПараметрыОбработчика.Интервал, ПараметрыОбработчика.Однократно);
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ОбработчикОжиданияДО()
	
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьОбработчикОжидания(ЭтотОбъект, ВнутренниеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_НажатиеДО(Элемент)
	
	ЭлектроннаяПодписьДокументооборотСобытияКлиент.ОбработатьСобытиеНажатие(ЭтотОбъект, Элемент);
