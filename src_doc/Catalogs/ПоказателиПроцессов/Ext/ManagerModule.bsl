...
//                   СправочникСсылка.ВидыДокументов - Отбор по виду предмета.
...
//   * ЭтапОбработкиПредмета - ПеречислениеСсылка.ЭтапыОбработкиПредметов - Отбор по этапу обработки.
//
Функция ВариантОтбора() Экспорт
	...
	ВариантОтбора.ЭтапОбработкиПредмета =
		Перечисления.ЭтапыОбработкиПредметов.ПустаяСсылка();
...
Функция ВариантыОтбораБиблиотечныхПоказателей(Основание) Экспорт
	...
	Пока ЗначениеЗаполнено(ИмяТипаОснования) Цикл
		...
		Если ЗначениеЗаполнено(ИмяЭтапОбработкиПредмета) Тогда
			ВариантОтбора.ЭтапОбработкиПредмета =
				Перечисления.ЭтапыОбработкиПредметов[ИмяЭтапОбработкиПредмета];
		КонецЕсли;
...
Функция ТипПредметаПоВидуПредмета(ВидПредмета)
	...
	Если ТипВидаПредмета = Тип("СправочникСсылка.ВидыДокументов") Тогда
		ТипПредмета = Перечисления.ТипыПредметовПоказателейПроцессов.ДокументыПредприятия;
	ИначеЕсли ТипВидаПредмета = Тип("СправочникСсылка.ВидыМероприятий") Тогда
...
// Проверяет, является ли переданное значение ссылкой на вид предмета.
//
// Параметры:
...
Функция ЭтоВидПредмета(Значение)
	...
	Возврат ТипЗначения = Тип("СправочникСсылка.ВидыДокументов")
