...
Процедура НастроитьФормуДляМобильногоПриНеобходимости()
	...
	Элементы.ГруппаКоманднаяПанельМК.Видимость = Истина;
	
	Элементы.ТерриторииГруппаКолонокМК.Видимость = Истина;
	Элементы.Переместить(Элементы.ТерриторииНаименование, Элементы.ГруппаНаименованиеОтветственный);
	Элементы.Переместить(Элементы.ТерриторииОтветственный, Элементы.ГруппаНаименованиеОтветственный);
	Элементы.Переместить(Элементы.ТерриторииВместимость, Элементы.ГруппаВместимость);
	
	Элементы.ТерриторииОтветственный.Шрифт = ШрифтыСтиля.МелкийШрифтТекста;
	Элементы.ТерриторииОтветственный.ЦветТекста = WebЦвета.ТемноСерый;
	
	Элементы.Территории.Шапка = Ложь;
	Элементы.ТерриторииОписание.Видимость = Ложь;
	Элементы.ТерриторииВместимость.Видимость = Ложь;
	Элементы.ТерриторииДоступнаСхема.Видимость = Ложь;
	Элементы.Территории.ПоложениеКоманднойПанели = ПоложениеКоманднойПанелиЭлементаФормы.Нет;
