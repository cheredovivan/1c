...
&НаКлиенте
Процедура ОтветственныйХозяйственноеОбеспечениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	СотрудникиКлиент.ВыбратьСотрудникаИзАдреснойКниги(Элемент, Объект.ОтветственныйХозяйственноеОбеспечение);
...
&НаКлиенте
Процедура ОтветственныйТехническоеОбеспечениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	СотрудникиКлиент.ВыбратьСотрудникаИзАдреснойКниги(Элемент, Объект.ОтветственныйТехническоеОбеспечение);
...
Процедура РодительТекстПриИзменении(Элемент)
	...
	Если Не ЗначениеЗаполнено(РодительТекст) Тогда 
		...
		ОтветственныйТехническоеОбеспечениеПоИерархии = ПредопределенноеЗначение("Справочник.Сотрудники.ПустаяСсылка");
		ОтветственныйХозяйственноеОбеспечениеПоИерархии = ПредопределенноеЗначение("Справочник.Сотрудники.ПустаяСсылка");
		УстановитьВидимостьЭлементов();
	КонецЕсли;	
...
&НаКлиенте
Процедура ОтветственныйХозяйственноеОбеспечениеОбработкаВыбора(
	Элемент, ВыбранноеЗначение, ДополнительныеДанные, СтандартнаяОбработка)
	
	СотрудникиКлиент.СотрудникОбработкаВыбора(
		Объект, "ОтветственныйХозяйственноеОбеспечение", ВыбранноеЗначение, СтандартнаяОбработка);
	
КонецПроцедуры

&НаКлиенте
Процедура ОтветственныйТехническоеОбеспечениеОбработкаВыбора(
	Элемент, ВыбранноеЗначение, ДополнительныеДанные, СтандартнаяОбработка)
	
	СотрудникиКлиент.СотрудникОбработкаВыбора(
		Объект, "ОтветственныйТехническоеОбеспечение", ВыбранноеЗначение, СтандартнаяОбработка);
