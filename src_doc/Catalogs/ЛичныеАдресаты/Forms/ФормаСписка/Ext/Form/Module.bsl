...
Процедура ЗаполнитьАдресатов()
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	ЕСТЬNULL(СправочникГруппыЛичныхАдресатов.Сотрудник, ЛичныеАдресаты.Сотрудник) В (&СотрудникиПользователя)
		|	И ЕСТЬNULL(ЛичныеАдресаты.Сотрудник, СправочникГруппыЛичныхАдресатов.Сотрудник) В (&СотрудникиПользователя)
