...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УменьшитьШиринуПолейКонтактнойИнформации();
...
&НаСервере
Процедура УменьшитьШиринуПолейКонтактнойИнформации()

	ЭлементыКИ = Элементы.ГруппаКонтактнаяИнформация.ПодчиненныеЭлементы;
	
	Для Каждого Элемент Из ЭлементыКИ Цикл
