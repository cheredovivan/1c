...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НастроитьЭлементыФормыДляМобильногоУстройстваПриНеобходимости();
...
&НаСервере
Процедура НастроитьЭлементыФормыДляМобильногоУстройстваПриНеобходимости()
	...
	// Включим отображение количества писем в папках.
