...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ТекстВыражения) Тогда
		...
		Элементы.ГруппаКомПанельСкрипта.Доступность = Истина;
	Иначе
		...
		Элементы.ГруппаКомПанельСкрипта.Доступность = Ложь;
	КонецЕсли;
...
Процедура Выбрать(Команда)
	...
	Если НРег(Команда.Имя) = "ок" Тогда
		...
		Иначе
			...
			ТекстВыражения = СокрЛП(ТекстВыражения);
...
Процедура ДобавитьАлгоритмЗавершение(Результат, Параметры) Экспорт 
	...
	Если Результат <> Неопределено Тогда
		...
		ТекстВставки = СтрШаблон(
			...
			КлючДляВызова);	
		ТекстВыражения = ТекстВыражения + Символы.ВК + ТекстВставки;
