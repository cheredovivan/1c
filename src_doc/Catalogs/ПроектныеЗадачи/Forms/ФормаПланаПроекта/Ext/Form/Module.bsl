...
Процедура ДиаграммаГантаВыбор(Элемент, Значения, СтандартнаяОбработка, Дата)
	...
	Если ЗначениеЗаполнено(ЗадачаСсылка) Тогда
		...
		РаботаСПроектамиКлиент.ОткрытьПроектнуюЗадачу(ПараметрыФормы, ЭтотОбъект);
	КонецЕсли;
...
Процедура ПоИсполнителюНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	РаботаСАдреснойКнигойКлиент.ОткрытьАдреснуюКнигу(ПараметрыФормы, Элементы.ПоИсполнителю);
...
Процедура ДеревоЗадачПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	ЗаписатьПроектнуюЗадачуИзСтрокиДереваНаКлиенте(Элементы.ДеревоЗадач.ТекущаяСтрока);
...
Процедура ИсполнителиСтрНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Иначе
		...
		РаботаСАдреснойКнигойКлиент.ОткрытьАдреснуюКнигу(ПараметрыФормы, Элементы.ИсполнителиСтр);
...
Процедура ЗаполнитьДеревоЗадач()
	...
	Если ЗначениеЗаполнено(Проект) Тогда 
		...
		|	И ЗадачаИсполнителяПредметы.Ссылка.СостояниеБизнесПроцесса <> ЗНАЧЕНИЕ(Перечисление.СостоянияБизнесПроцессов.Прерван)
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	Предмет,
		|	Выполнена,
...
&НаКлиенте
Процедура ЗаписатьПроектнуюЗадачуИзСтрокиДереваНаКлиенте(ИндексСтроки)
	...
	ЗаписатьПроектнуюЗадачуИзСтрокиДерева(ИндексСтроки);
