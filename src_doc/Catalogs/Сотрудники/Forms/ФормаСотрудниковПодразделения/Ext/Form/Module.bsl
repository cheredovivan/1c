...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("УникальныйИдентификаторФормыПодразделения") Тогда	
		УникальныйИдентификаторФормыПодразделения = Параметры.УникальныйИдентификаторФормыПодразделения;
	КонецЕсли;	
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, ЭтоГруппа, Параметр)
	...
	ПараметрыОткрытия = Новый Структура("УникальныйИдентификаторФормыПодразделения, Подразделение", 
		УникальныйИдентификаторФормыПодразделения, Подразделение);
...
Процедура НастроитьФормуДляМобильногоПриНеобходимости()
	...
	Элементы.СписокГруппаКолонок.Группировка = ГруппировкаКолонок.Вертикальная;
