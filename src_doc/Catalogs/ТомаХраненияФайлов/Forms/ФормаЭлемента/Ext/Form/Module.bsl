...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.МаксимальныйРазмер = 0 Тогда
		Элементы.ГруппаТекущий.Видимость = Ложь;
	КонецЕсли;	       
...
&НаКлиенте
Процедура МаксимальныйРазмерПриИзменении(Элемент)
	
	Элементы.ГруппаТекущий.Видимость = (Объект.МаксимальныйРазмер <> 0);
