...
Процедура ПередЗаписью(Отказ)
	...
	Если МиграцияДанныхИзВнешнихСистемСервер.ЭтоОбъектИзДругойСистемы(ЭтотОбъект.ИсточникДанных) Тогда
		ВызватьИсключение НСтр("ru = 'Нельзя изменять объект, загруженный из ДО 2.1'");
	КонецЕсли;	
	

	Если Не ЗначениеЗаполнено(ДатаСоздания) И Не ЭтоГруппа Тогда
