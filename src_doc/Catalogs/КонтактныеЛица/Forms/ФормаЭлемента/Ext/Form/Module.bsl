...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Адрес") Тогда
		...
		// EmailАдресата
		Если ЗначениеЗаполнено(Параметры.Адрес) И СтрНайти(Параметры.Адрес, "@") <> 0 Тогда
	...
	Если ЗначениеЗаполнено(Параметры.ЛичныйАдресат) Тогда
		...
		Если ЗначениеЗаполнено(Объект.Должность) Тогда
			// Пытаемся найти должность по наименованию, если не нашли, не создаем, т.к. контактное лицо может
			// не будет записано:
			Объект.Должность = Справочники.ДолжностиКонтактныхЛиц.НайтиСоздатьДолжность(ЛичныйАдресат.Должность, Истина);
		КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	УстановитьВидимостьГруппыНеДействует();
...
Процедура НеДействует(Команда)
	...
	Объект.НеДействует = Не Объект.НеДействует;
	УстановитьВидимостьГруппыНеДействует();
...
&НаКлиенте
Процедура УстановитьВидимостьГруппыНеДействует()

	Элементы.ГруппаНеДействует.Видимость = Объект.НеДействует;
