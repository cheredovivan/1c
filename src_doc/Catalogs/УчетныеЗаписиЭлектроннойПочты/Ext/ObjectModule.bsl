...
Процедура ПередЗаписью(Отказ)
	...
	Если ДополнительныеСвойства.Свойство("УзелОбработки") И ЗначениеЗаполнено(ДополнительныеСвойства.УзелОбработки) Тогда
		УзелОбработки = ДополнительныеСвойства.УзелОбработки.УникальныйИдентификатор();
	КонецЕсли;	
...
Процедура ПриЗаписи(Отказ)
	...
	// удаление записей в рег ОчередьВнутреннейПриемкиПисем
...
Процедура УдалитьЗаписиПисемВПроцессеОтправки()
	...
	|ГДЕ
	|	ОчередьВнутреннейПриемкиПисем.Адресат.Адрес = &Адрес";
