...
// Возвращает учетные записи пользователя, за обработку писем которых он отвечает.
//
// Параметры:
//  Пользователь - СправочникСсылка.Пользователи - Пользователь.
// 
// Возвращаемое значение:
//  Массив - Учетные записи пользователя, за обработку писем которых он отвечает.
//
Функция УчетныеЗаписиПользователя(Пользователь) Экспорт
	...
	Запрос = Новый Запрос(
		...
		|ГДЕ
		|	УчетныеЗаписиЭлектроннойПочтыОтветственныеЗаОбработкуПисем.Сотрудник В(&ПользовательИСотрудники)
		|	И УчетныеЗаписиЭлектроннойПочты.ПометкаУдаления = ЛОЖЬ");
	
	Запрос.УстановитьПараметр("ПользовательИСотрудники",
		Сотрудники.ПользовательИСотрудники(Пользователь));
...
Процедура ЗаполнитьДескрипторыОбъекта(ОбъектДоступа, ТаблицаДескрипторов, ПротоколРасчетаПрав = Неопределено) Экспорт
	...
	Для Каждого СтрОтветственного Из ТаблицаОтветственных Цикл
		ДокументооборотПраваДоступа.ДобавитьИндивидуальныйДескриптор(
			ОбъектДоступа, ТаблицаДескрипторов, СтрОтветственного.Сотрудник, Истина);
	КонецЦикла;
