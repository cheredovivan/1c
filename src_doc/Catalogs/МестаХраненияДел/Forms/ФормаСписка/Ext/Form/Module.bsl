...
#Если МобильныйКлиент Тогда
	Элементы.ГруппаСписокТерриторийМК.Скрыть();
#КонецЕсли
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Если ИспользоватьСхемыПомещений Тогда
		...
		Если Элементы.СписокТерриторий.ТекущиеДанные.ПометкаУдаления Тогда
			ПоказатьПредупреждение(, НСтр("ru = 'Текущая территория помечена на удаление.'"));
			Возврат;
		КонецЕсли;
	КонецЕсли;
...
&НаКлиенте
Процедура СписокДелОбработкаЗапросаОбновления()
...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.ОтборОрганизация.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.ОтборОрганизация.ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.ОтборОрганизация.ПодсказкаВвода = "";
	Элементы.Переместить(Элементы.ОтборОрганизация, Элементы.ГруппаОтборыМК, Элементы.ГруппаСписокТерриторийМК);
	
	Элементы.ОтборПодразделение.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.ОтборПодразделение.ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.ОтборПодразделение.ПодсказкаВвода = "";
	Элементы.Переместить(Элементы.ОтборПодразделение, Элементы.ГруппаОтборыМК, Элементы.ГруппаСписокТерриторийМК);
	
	Элементы.СписокТерриторий.Шапка = Ложь;
	Элементы.СписокТерриторий.ИспользованиеТекущейСтроки = ИспользованиеТекущейСтрокиТаблицы.ОтображениеВыделения;
	
	Элементы.Список.Шапка = Ложь;
	Элементы.ГруппаСписокКолонкиМК.Видимость = Истина;
	Элементы.Переместить(Элементы.ЗапрещеноРазмещатьНовыеДела, Элементы.ГруппаСписокКолонкиМК);
	Элементы.Переместить(Элементы.Наименование, Элементы.ГруппаСписокКолонкиМК);
	Элементы.Список.ИспользованиеТекущейСтроки = ИспользованиеТекущейСтрокиТаблицы.ОтображениеВыделенияИВыбор;
	
	Элементы.СписокДел.Шапка = Ложь;
	Элементы.ГруппаСписокДелКолонкиМК.Видимость = Истина;
	Элементы.Переместить(Элементы.СписокДелДелоЗакрыто, Элементы.ГруппаСписокДелКолонкиМК);
	Элементы.Переместить(Элементы.СписокДелНаименование, Элементы.ГруппаСписокДелКолонкиМК);
...
Процедура НастроитьФормуВПортретномРежимеДляМобильного()
	...
	Элементы.Переместить(Элементы.СписокТерриторий, Элементы.ГруппаСписокТерриторийМК);

	Элементы.ГруппаСписокДелМК.Видимость = Истина;
	Элементы.Переместить(Элементы.СписокДел, Элементы.ГруппаСписокДелМК);
...
Процедура НастроитьФормуВАльбомномРежимеДляМобильного()
	...
	Элементы.Данные.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
	Элементы.СписокТерриторий.Ширина = 30;
	Элементы.ГруппаОтборыМК.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
