...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.ТекущаяСтрока) И ДокументооборотПраваДоступа.ПраваПользователяПоОбъекту(Параметры.ТекущаяСтрока).Чтение Тогда 	
	...
	Если РольДоступна("КонтрольПроектов") 
		Или РаботаСПроектами.НетСвоихПроектов(Сотрудники.СотрудникиПользователя()) Тогда
