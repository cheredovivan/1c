...
//  Структура
//   * Наименование - Строка
//   * Группа - СправочникСсылка.СкриптыУсловийСхемДляКомплексныхПроцессов
//   * Выражение - Строка
//   * Комментарий - Строка
//
Функция СтруктураДанныхДляЗаполнения() Экспорт
	...
	СтруктураДляЗаполнения.Вставить("Группа",
		Справочники.СкриптыУсловийСхемДляКомплексныхПроцессов.ПустаяСсылка());
...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоГруппа Тогда
		ХешВыражения = РаботаСКомплекснымиБизнесПроцессамиСервер.ХешВыржаенияНаВстроенномЯзыке(Выражение);
