...
//  Структура
//   * Наименование - Строка
//   * Группа - СправочникСсылка.СкриптыСхемДляКомплексныхПроцессов
//   * Выражение - Строка
//   * Комментарий - Строка
//
Функция СтруктураДанныхДляЗаполнения() Экспорт
	...
	СтруктураДляЗаполнения.Вставить("Группа", Справочники.СкриптыСхемДляКомплексныхПроцессов.ПустаяСсылка());
