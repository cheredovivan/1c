...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокОтчета = "";
	ЗаполнитьСтандартныйСписокЗаголовков();
...
// Заполняет варианты стандартных заголовков печатной формы.
&НаСервере
Процедура ЗаполнитьСтандартныйСписокЗаголовков()
	
	СписокЗаголовков = Элементы.Заголовок.СписокВыбора;
	СписокЗаголовков.Добавить(НСтр("ru = 'Программа'"), НСтр("ru = 'Программа'"));
	СписокЗаголовков.Добавить(НСтр("ru = 'Повестка дня'"), НСтр("ru = 'Повестка дня'"));
	СписокЗаголовков.Добавить(НСтр("ru = 'Протокол'"), НСтр("ru = 'Протокол'"));
	СписокЗаголовков.Добавить(НСтр("ru = 'Список участников'"), НСтр("ru = 'Список участников'"));
