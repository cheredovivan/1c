...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		УстановилМероприятия = ТекущийСотрудник;
	...
	Если ЗначениеЗаполнено(Параметры.ВидМероприятия) Тогда
		ВидМероприятия = Параметры.ВидМероприятия;
	Иначе
		ВидМероприятия = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Мероприятие, "ВидМероприятия");
	КонецЕсли;
...
Процедура ПриИзмененииСостояния(ИмяСостояния)
	...
	ЭтаФорма["Установил" + ИмяСостояния] = ТекущийСотрудник;
