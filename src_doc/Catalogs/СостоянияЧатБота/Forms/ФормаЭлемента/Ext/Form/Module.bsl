...
Процедура ИмяПараметраПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.ИмяЗаполняемогоПараметра) Тогда 
		Попытка
		...
		Объект.ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Вопрос");
		ЭтоВопрос = Истина;
	...
	Иначе 
		...
		ЭтоВопрос = Ложь;
	КонецЕсли;
	Элементы.ГруппаДействие.Доступность = Не ЭтоВопрос;
	Элементы.ГруппаПараметры.Доступность = Не ЭтоВопрос;
	//Элементы.ДоступноИзЛюбогоСостояния.Доступность = Не ЭтоВопрос;
	//
	//Если Не ЭтоВопрос Тогда
	//	
	//	Объект.ДоступноИзЛюбогоСостояния = Ложь;
	//
	//КонецЕсли; 
	//
КонецПроцедуры
...
Процедура РасширеннаяНастройка(Команда)
	...
	ИначеЕсли ЗначениеЗаполнено(Объект.ИмяЗаполняемогоПараметра) Тогда  
		Объект.ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Вопрос");
	Иначе 
		Объект.ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Действие");
	КонецЕсли;
...
Процедура ОбновитьВидимостьЭлементовФормы(Форма, ПереключитьВкладку = Ложь)
	...
	Если Форма.Объект.ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Действие") 
		Или Форма.Объект.ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Вопрос") Тогда
		...
		ЭтоВопрос = Форма.Объект.ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Вопрос");
		Элементы.ГруппаДействие.Доступность = Не ЭтоВопрос;
		Элементы.ГруппаПараметры.Доступность = Не ЭтоВопрос;
