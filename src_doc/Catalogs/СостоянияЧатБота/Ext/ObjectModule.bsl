...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка) Экспорт 
	...
	Если ЗначениеЗаполнено(ДанныеЗаполнения) 
		...
		И ДанныеЗаполнения.Свойство("Действие") Тогда
		Действие = ДанныеЗаполнения.Действие;
		КлючевыеСлова = ДанныеЗаполнения.КлючевыеСлова;
		Высказывание = ДанныеЗаполнения.Высказывание;
		ИмяЗаполняемогоПараметра = ДанныеЗаполнения.ИмяЗаполняемогоПараметра;
		ПримерЗаполняемогоПараметра = ДанныеЗаполнения.ПримерЗаполняемогоПараметра;
		Используется = Истина;
		
		Для Каждого Параметр Из ДанныеЗаполнения.Параметры Цикл
		...
		Если ЗначениеЗаполнено(ИмяЗаполняемогоПараметра) 
			И ЗначениеЗаполнено(ПримерЗаполняемогоПараметра) Тогда
		
			ТипСостояния = Перечисления.ТипыСостоянийЧатБота.Вопрос;
			
		ИначеЕсли ЗначениеЗаполнено(Действие) Тогда
			
			ТипСостояния = Перечисления.ТипыСостоянийЧатБота.Действие;
			
		Иначе
			
			ТипСостояния = Перечисления.ТипыСостоянийЧатБота.Высказывание;
