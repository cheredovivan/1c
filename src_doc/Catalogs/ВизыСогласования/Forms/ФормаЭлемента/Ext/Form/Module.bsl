...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МиграцияДанныхИзВнешнихСистемСервер.ВывестиДекорациюЗагрузкиИзДругойСистемы(ЭтотОбъект, 
		НСтр("ru = 'Виза документа загружена'"));
...
Процедура ИсполнительНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СотрудникиКлиент.ВыбратьСотрудникаИзАдреснойКниги(Элемент, Исполнитель);
...
Процедура ИсполнительОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, СтандартнаяОбработка)
	...
	РаботаСБизнесПроцессамиКлиент.УчастникОкончаниеВводаТекста(
		Текст, ДанныеВыбора, СтандартнаяОбработка, ЭтаФорма, "Исполнитель");
...
Процедура ПодписатьЭП(Команда)
	...
	Если Не ТекущийПользовательПолноправный Тогда 
		...
		ТекущийПользовательИсполнитель = СотрудникиВызовСервера.ТекущийПользовательИсполнитель(Исполнитель);
...
&НаКлиенте
Процедура ВерсииСогласованныхФайлов(Команда)
	...
	ПараметрыОткрытия.Вставить("ВизаСогласования", Объект.Ссылка);
...
Процедура УстановитьДоступность()
	...
	Если ЗначениеЗаполнено(Объект.Источник) 
		И ДействияКлиентСервер.ЭтоДействиеСогласования(Объект.Источник) Тогда
		ИнформационнаяНадпись = НСтр("ru = 'Результат согласования будет установлен автоматически при выполнении действия ""Согласование""'");
		ЗапретитьИзменениеВизы();
		
	ИначеЕсли ЗначениеЗаполнено(Объект.Источник) И Не ЗначениеЗаполнено(Объект.РезультатСогласования) Тогда 
...
&НаСервере
Процедура ЗапретитьИзменениеВизы()
