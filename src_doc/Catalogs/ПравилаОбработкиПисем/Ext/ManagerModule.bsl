...
Функция ПолучитьОписаниеПравила(ПравилоСсылка, ДляРеквизита = Ложь) Экспорт
...
Функция ПолучитьПредставлениеСпискаЗначенийДляУсловия(ВидУсловия, СписокЗначений) Экспорт
