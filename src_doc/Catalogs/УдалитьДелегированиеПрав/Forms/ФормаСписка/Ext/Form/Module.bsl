...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Если ЗначениеЗаполнено(ОтКого) И Не Копирование Тогда 
		...
		ОткрытьФорму("Справочник.УдалитьДелегированиеПрав.ФормаОбъекта", ПараметрыОткрытия);
	КонецЕсли;
...
Процедура ОткрытьОбластиДелегированияПрав(Команда)
	...
	ОткрытьФорму("Справочник.УдалитьОбластиДелегированияПрав.ФормаСписка",,ЭтаФорма);
