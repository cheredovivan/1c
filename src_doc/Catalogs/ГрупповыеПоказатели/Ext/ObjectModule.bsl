...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не НаименованиеУникально() Тогда
		ОбщегоНазначенияКлиентСервер.ДобавитьОшибкуПользователю(
				Ошибки,
				"Объект.Наименование",
				НСтр("ru = 'Данное наименование уже указано для другого группового показателя.'"));
	КонецЕсли;
...
Функция НаименованиеУникально()
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	ГрупповыеПоказатели.Наименование = &Наименование
		|	И ГрупповыеПоказатели.Ссылка <> &Ссылка";
