...
Процедура ДеревоРазделовПриАктивизацииСтроки(Элемент)
	...
	Если ЭтоМобильныйКлиент Тогда
		Элементы.МК_Страницы.ТекущаяСтраница = Элементы.МК_Список;
		МК_ОбновитьКнопкуПереключенияРазделов(ЭтотОбъект);
	КонецЕсли;
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле = Элементы.Раздел Тогда
		ПоказатьЗначение(, ДанныеСтроки.Папка);
	Иначе
		РаботаСОбсуждениямиКлиент.ОткрытьТему(ДанныеСтроки.Ссылка);
	КонецЕсли;
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	Если КлючНазначенияИспользования = "ПросмотрРаздела"
		...
		ПараметрыФормы.Вставить("ТемаРаздел", ТекущийРаздел);
	КонецЕсли;
...
&НаКлиенте
Процедура МК_ПереключитьРазрез(Команда)
	
	Элементы.МК_Страницы.ТекущаяСтраница = Элементы.МК_ДеревоРазрезов;
...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.ФормаВсеСообщения.Видимость = Ложь;
	
	Элементы.МК_НижнийБлок.Видимость = Истина;
	
	Элементы.ФормаТолькоНепрочтенные.ПоложениеВКоманднойПанели = ПоложениеКнопкиВКоманднойПанели.ВКоманднойПанелиИВДополнительномПодменю;
	Элементы.ФормаТолькоНепрочтенные.Отображение = ОтображениеКнопки.Картинка;
	Элементы.ФормаТолькоНепрочтенные.Картинка = БиблиотекаКартинок.МК_ФильтрНеПрочтенные;
	
	Элементы.Переместить(Элементы.ФормаТолькоНепрочтенные, КоманднаяПанель, Элементы.ФормаГруппаОсновные);
	Элементы.Переместить(Элементы.ФормаВыбратьРаздел, КоманднаяПанель, Элементы.ФормаГруппаОсновные);
	Элементы.Переместить(Элементы.ФормаОтображатьУдаленные, КоманднаяПанель, Элементы.ФормаГруппаОсновные);
	
	Элементы.МК.Видимость = Истина;
	Элементы.Переместить(Элементы.ДеревоРазделов, Элементы.МК_ДеревоРазрезов);
	Элементы.Переместить(Элементы.Список, Элементы.МК_Список);
	
	Элементы.МК_Страницы.ТекущаяСтраница = Элементы.МК_Список;
	Элементы.МК_ВерхнийБлок.Видимость = Ложь;
	
	МК_КлиентСервер.ОформитьКнопкуФильтра(
		МК_ЭлементыСтиля, Элементы.МК_КнопкаПереключитьРазрез, Истина, Ложь);
		
	Элементы.ТемаАвторДатаСоздания.Видимость = Ложь;
	Элементы.ПоследнееСообщение.Видимость = Ложь;
	
	Элементы.Список.Шапка = Ложь;
	Элементы.МК_ГруппаКолонок.Видимость = Истина;
	Элементы.МК_Картинки.Видимость = Истина;
	Элементы.Список.ПутьКДаннымКартинкиСтроки = "";
		
	Элементы.Переместить(Элементы.Раздел, Элементы.МК_ПерваяКолонка);
	Элементы.Переместить(Элементы.Автор, Элементы.МК_ПерваяКолонка);
	
	Элементы.МК_ДатаСоздания.Видимость = Истина;
	Элементы.Переместить(Элементы.КоличествоСообщений, Элементы.МК_ВтораяКолонка);
	Элементы.Переместить(Элементы.МК_ДатаСоздания, Элементы.МК_ВтораяКолонка);
	
	Элементы.Раздел.Шрифт = ШрифтыСтиля.МелкийШрифтТекста;
...
Процедура МК_ОбновитьКнопкуПереключенияРазделов(Форма)
	
	МК_КлиентСервер.ОформитьКнопкуФильтра(
		Форма.МК_ЭлементыСтиля, Форма.Элементы.МК_КнопкаПереключитьРазрез, Истина, Истина);
		
	Форма.Элементы.МК_КнопкаПереключитьРазрез.Заголовок = Форма.Элементы.ДеревоРазделов.ТекущиеДанные.Наименование;
