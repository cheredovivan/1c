...
//	 Настройка - СправочникСсылка.НастройкиДействийРегистрации - ссылка на настройку действия. 
...
Процедура ДополнитьДеревоПредставлениемНастройки(ЭлементыДействия, ЗначенияЗаполнения) Экспорт
	...
	Для Каждого Участник Из Участники Цикл
		...
		Если Участник.ФункцияУчастника = ПредопределенноеЗначение(
			"Перечисление.ФункцииУчастниковРегистрации.ОбрабатывающийРезультат") Тогда
			Продолжить;
		КонецЕсли;
...
// 
// Параметры:
// 	НастройкаДействия - СправочникСсылка.НастройкиДействийРегистрации - ссылка на действие
// 	
...
Функция ВсеУчастники(НастройкаДействия) Экспорт
	...
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	НастройкиДействийРегистрации.Участник КАК Участник,
		|	НастройкиДействийРегистрации.ФункцияУчастника КАК Функция
		|ИЗ
		|	Справочник.НастройкиДействийРегистрации.Участники КАК НастройкиДействийРегистрации
		|ГДЕ
		|	НастройкиДействийРегистрации.Ссылка = &НастройкаДействия");
