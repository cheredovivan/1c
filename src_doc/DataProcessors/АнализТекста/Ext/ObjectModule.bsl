...
Функция Событие() Экспорт
	...
	Попытка
		...
		АгрегатныеАннотации = ВыполнитьАнализТекста(ИсходныйТекст, Истина, Ложь);
...
Функция НайтиДату() Экспорт
	...
	Попытка
		...
		АгрегатныеАннотации = ВыполнитьАнализТекста(ИсходныйТекст, Истина, Истина);
		Если АгрегатныеАннотации.Количество() = 0 Тогда
			Возврат Неопределено;
		КонецЕсли;
...
//  ВыбратьПростоДату - Булево - Выбрать просто дату, без события.
// 
// Возвращаемое значение:
//  Массив - Агрегатные аннотации.
//
Функция ВыполнитьАнализТекста(Знач Текст, ВыбратьПервую, ВыбратьПростоДату)
	...
	Для Счетчик = 0 По Предложения.Количество() -1 Цикл
		...
		АгрегатнаяАннотация = СоздатьАгрегатнуюАннотацию(Предложение, Текст, ВыбратьПростоДату);
...
//
Функция СоздатьАгрегатнуюАннотацию(Предложение, Текст, ВыбратьПростоДату)
	...
	ИначеЕсли ВыбратьПростоДату И АннотацииДаты.Количество() <> 0 И АннотацииВремени.Количество() <> 0 Тогда
		АннотацияСловарь.Вставить("Время", АннотацииВремени);
		АннотацияСловарь.Вставить("Дата", АннотацииДаты);
		АннотацияИмя = "Дата";
		
	ИначеЕсли ВыбратьПростоДату И АннотацииДаты.Количество() <> 0 Тогда
		АннотацияСловарь.Вставить("Дата", АннотацииДаты);
		АннотацияИмя = "Дата";
		
	ИначеЕсли ВыбратьПростоДату И АннотацииВремени.Количество() <> 0 Тогда
		АннотацияСловарь.Вставить("Время", АннотацииВремени);
		АннотацияИмя = "Дата";
