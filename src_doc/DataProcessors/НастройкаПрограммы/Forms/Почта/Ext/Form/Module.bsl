...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаЧислоПотоковВнутр.Доступность = НаборКонстант.ИспользоватьВнутреннююМаршрутизацию;
...
&НаКлиенте
Процедура ИспользоватьВнутреннююМаршрутизациюПриИзменении(Элемент)
