...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользоватьКонтрольныеТочки = НаборКонстант.ИспользоватьКонтрольныеТочки;
	ИспользоватьКонтрольныеТочкиПредыдущееЗначение = ИспользоватьКонтрольныеТочки;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.ИспользоватьКонтрольныеТочки = ИспользоватьКонтрольныеТочки;
...
Процедура ИспользоватьКонтрольныеТочкиПриИзменении(Элемент)
	...
	СохранитьКонстантуИспользоватьКонтрольныеТочки(ИспользоватьКонтрольныеТочки);
	ОбновитьИнтерфейс();
	
	Элементы.УровниКонтроля.Доступность = ИспользоватьКонтрольныеТочки;
...
Процедура Отмена(Команда)
	...
	Если ИспользоватьКонтрольныеТочки <> ИспользоватьКонтрольныеТочкиПредыдущееЗначение Тогда
		СохранитьКонстантуИспользоватьКонтрольныеТочки(ИспользоватьКонтрольныеТочкиПредыдущееЗначение);
	КонецЕсли;
...
Процедура СохранитьКонстантуИспользоватьКонтрольныеТочки(ИспользоватьКонтрольныеТочки)
