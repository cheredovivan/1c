...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступенВопросВПоддержку = ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.СообщенияВСлужбуТехническойПоддержки");
	Элементы.ВопросВПоддержку.Видимость				 = ДоступенВопросВПоддержку;
	Элементы.ДекорацияОбратитесьВПоддержку.Видимость = Не ДоступенВопросВПоддержку;
...
Процедура ВыгрузитьТехническуюИнформацию(ВыгрузитьАрхив)
	...
	Если ВыгрузитьАрхив Тогда
		...
		Элементы.ДекорацияКартинкаФормируетсяТехническаяИнформация.Видимость = Истина;
	КонецЕсли;
	...
	Если ВыгрузитьАрхив Тогда
		ЭлектроннаяПодписьСлужебныйКлиент.СформироватьТехническуюИнформацию(
			СтрСоединить(Сведения, Символы.ПС), Неопределено, Новый ОписаниеОповещения("ПослеВыгрузкиТехническойИнформации", ЭтотОбъект), ОписаниеФайлов);
	Иначе
...
Процедура ПослеВыгрузкиТехническойИнформации(Результат, Контекст) Экспорт
	...
	Элементы.ДекорацияКартинкаФормируетсяТехническаяИнформация.Видимость = Ложь;
