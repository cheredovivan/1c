...
// Удаляет непроверяемые реквизиты в обработке заполнения.
// 
// Параметры:
//  МассивРеквизитов - Массив из Строка
//  МассивНепроверяемыхРеквизитов - Массив из Строка
//
Процедура УдалитьНепроверяемыеРеквизиты(МассивРеквизитов, МассивНепроверяемыхРеквизитов)

	Для Каждого Реквизит Из МассивНепроверяемыхРеквизитов Цикл

		ПорядковыйНомер = МассивРеквизитов.Найти(Реквизит);
...
// Список непроверяемых реквизитов.
// 
// Возвращаемое значение:
//  Массив из Строка
//
Функция НепроверяемыеРеквизиты()
	
	Массив = Новый Массив;
	Массив.Добавить("ИнформацияДокумента.Контрагент");
